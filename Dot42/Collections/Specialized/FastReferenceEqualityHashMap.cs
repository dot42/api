...
namespace Dot42.Collections.Specialized
{
    ...
    /// </summary>
    public class FastReferenceEqualityHashMap<K, V> : FastHashMapBase<K, V>
    {
        public FastReferenceEqualityHashMap(int size, float fillFactor = DefaultFillFactor)
                : base(size, fillFactor)
        {
        }

        private FastReferenceEqualityHashMap(FastReferenceEqualityHashMap<K, V> other, int newSize)
            : base(other, newSize)
        {
        }
        ...
        {
            return new FastReferenceEqualityHashMap<K, V>(this, newSize);
        }
    }
