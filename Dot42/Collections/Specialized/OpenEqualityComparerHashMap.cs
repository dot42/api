...
namespace Dot42.Collections.Specialized
{
    ...
    internal class OpenEqualityComparerHashMap<K, V> : OpenHashMapBase<K, V> 
    {
        ...
        public OpenEqualityComparerHashMap(IEqualityComparer<K> comparer, int size = DefaultSize)
        ...
        public OpenEqualityComparerHashMap(IEqualityComparer<K> comparer, int size, float fillFactor)
            : base(size, fillFactor, 0, fillFactor)
        {
            _comparer = comparer;
        }

        internal OpenEqualityComparerHashMap(IEqualityComparer<K> comparer, int size, float fillFactor, int fillFactorThreshhold, float fillFactor2)
        ...
        {
            return ReferenceEquals(key1, key2) || _comparer.Equals((K) key1, (K) key2);
        }
