 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Checks if this duration object is strictly shorter than another  <code>Duration</code> object.</para> <para> <para>#isLongerThan(Duration duration) </para> <para>#compare(Duration duration) </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Set time as one unit, including optional milliseconds.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// setTime
				/// </java-name>
				[Dot42.DexImport("setTime", "(IIILjava/math/BigDecimal;)V", AccessFlags = 1)]
				public virtual void SetTime(int hour, int minute, int second, global::Java.Math.BigDecimal millisecond) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void SetTime(int hour, int minute, int second, int millisecond) /* MethodBuilder.Create */ 
				{
				}
    ...
    "Ljava/util/GregorianCalendar;", AccessFlags = 1025)]
				...
				/// <summary>
				///  <para>Return high order component for XML Schema 1.0 dateTime datatype field for  <code>year</code>.  <code>null</code> if this optional part of the year field is not defined.</para> <para>Value constraints for this value are summarized in .</para> <para> <para>getYear() </para> <para>getEonAndYear() </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Return low order component for XML Schema 1.0 dateTime datatype field for  <code>year</code> or DatatypeConstants#FIELD_UNDEFINED.</para> <para>Value constraints for this value are summarized in .</para> <para> <para>getEon() </para> <para>getEonAndYear() </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Return XML Schema 1.0 dateTime datatype field for  <code>year</code>.</para> <para>Value constraints for this value are summarized in .</para> <para> <para>getEon() </para> <para>getYear() </para></para>        
				/// </summary>
				/// <returns>
