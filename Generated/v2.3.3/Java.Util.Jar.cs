...
namespace Java.Util.Jar
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Stores the value <c>value </c> associated with the key <c>name </c> in this  <c>Attributes </c> .</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>the value being stored. </para>
				/// </returns>
				...
				public virtual string PutValue(string name, string value) /* MethodBuilder.Create */ 
				{
						return default(string);
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>Represents a single file in a JAR archive together with the manifest attributes and digital signatures associated with it.</para> <para> <para>JarFile </para> <para>JarInputStream </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para> <c>JarFile </c> is used to read jar entries and their associated data from jar files.</para> <para> <para>JarInputStream </para> <para>JarEntry </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Reads up to <c>byteCount </c> bytes of decompressed data and stores it in  <c>buffer </c> starting at <c>byteOffset </c> . Returns the number of uncompressed bytes read.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// read
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Writes this <c>Manifest </c> 's name/attributes pairs to the given <c>OutputStream </c> . The <c>MANIFEST_VERSION </c> or <c>SIGNATURE_VERSION </c> attribute must be set before calling this method, or no attributes will be written.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// write
				/// </java-name>
