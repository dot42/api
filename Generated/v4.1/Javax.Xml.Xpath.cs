...
namespace Javax.Xml.Xpath
{
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para> <code>XPathFunction</code> provides access to XPath functions.</para> <para>Functions are identified by QName and arity in XPath.</para> <para> <para> </para> <para> </para> <para></para> <title>Revision</title> <para>446598 </para>,  <title>Date</title> <para>2006-09-15 05:55:40 -0700 (Fri, 15 Sep 2006) </para> <para>1.5 </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>XPath constants.</para> <para> <para> </para> <para> </para> <para></para> <title>Revision</title> <para>446598 </para>,  <title>Date</title> <para>2006-09-15 05:55:40 -0700 (Fri, 15 Sep 2006) </para> <para> </para> <para>1.5 </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para> <code>XPathException</code> represents a generic XPath exception.</para> <para> <para> </para> <para> </para> <para></para> <title>Revision</title> <para>446598 </para>,  <title>Date</title> <para>2006-09-15 05:55:40 -0700 (Fri, 15 Sep 2006) </para> <para>1.5 </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para> <code>XPathExpressionException</code> represents an error in an XPath expression.</para> <para> <para> </para> <para> </para> <para></para> <title>Revision</title> <para>446598 </para>,  <title>Date</title> <para>2006-09-15 05:55:40 -0700 (Fri, 15 Sep 2006) </para> <para>1.5 </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>An  <code>XPathFactory</code> instance can be used to create javax.xml.xpath.XPath objects.</para> <para>See newInstance(String uri) for lookup mechanism.</para> <para> <para> </para> <para> </para> <para></para> <title>Revision</title> <para>888889 </para>,  <title>Date</title> <para>2009-12-09 09:43:18 -0800 (Wed, 09 Dec 2009) </para> <para>1.5 </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "thFactory;", AccessFlags = 9)]
		...
		/// <summary>
		///  <para> <code>XPathFactoryConfigurationException</code> represents a configuration error in a  <code>XPathFactory</code> environment.</para> <para> <para> </para> <para> </para> <para></para> <title>Revision</title> <para>446598 </para>,  <title>Date</title> <para>2006-09-15 05:55:40 -0700 (Fri, 15 Sep 2006) </para> <para>1.5 </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para> <code>XPathFunctionException</code> represents an error with an XPath function.</para> <para> <para> </para> <para> </para> <para></para> <title>Revision</title> <para>446598 </para>,  <title>Date</title> <para>2006-09-15 05:55:40 -0700 (Fri, 15 Sep 2006) </para> <para>1.5 </para></para>    
		/// </summary>
		/// <java-name>
