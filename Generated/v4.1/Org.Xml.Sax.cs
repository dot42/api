...
namespace Org.Xml.Sax
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Receive a Locator object for document events.</para> <para>By default, do nothing. Application writers may override this method in a subclass if they wish to store the locator for use with other document events.</para> <para> <para>org.xml.sax.DocumentHandler::setDocumentLocator </para> <para>org.xml.sax.Locator </para></para>        
				/// </summary>
				/// <java-name>
				/// setDocumentLocator
				/// </java-name>
				...
				/// <summary>
				///  <para>Report a fatal XML parsing error.</para> <para>The default implementation throws a SAXParseException. Application writers may override this method in a subclass if they need to take specific actions for each fatal error (such as collecting all of the errors into a single report): in any case, the application must stop all regular processing when this method is invoked, since the document is no longer reliable, and the parser may no longer report parsing events.</para> <para> <para>org.xml.sax.ErrorHandler::fatalError </para> <para>org.xml.sax.SAXParseException </para></para>        
				/// </summary>
				/// <java-name>
				/// fatalError
				/// </java-name>
		...
		///   [...]
		/// }
		/// </pre></para> <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>This interface has been replaced by the SAX2 Attributes interface, which includes Namespace support.  <para>SAX 1.0 </para> <para>David Megginson </para> <para>2.0.1 (sax2r2) </para> <para>org.xml.sax.DocumentHandler::startElement startElement </para> <para>org.xml.sax.helpers.AttributeListImpl AttributeListImpl </para></para></xrefdescription></xrefsect></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Return the value of an attribute in the list (by position).</para> <para>If the attribute value is a list of tokens (IDREFS, ENTITIES, or NMTOKENS), the tokens will be concatenated into a single string separated by whitespace.</para> <para> <para>getLength </para> <para>getValue(java.lang.String) </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>End the scope of a prefix-URI mapping.</para> <para>See startPrefixMapping for details. These events will always occur immediately after the corresponding endElement event, but the order of endPrefixMapping events is not otherwise guaranteed.</para> <para> <para>startPrefixMapping </para> <para>endElement </para></para>        
				/// </summary>
				/// <java-name>
				/// endPrefixMapping
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Receive notification of an unparsed entity declaration event.</para> <para>Note that the notation name corresponds to a notation reported by the notationDecl event. It is up to the application to record the entity for later reference, if necessary; unparsed entities may appear as attribute values. </para> <para>If the system identifier is a URL, the parser must resolve it fully before passing it to the application.</para> <para> <para>notationDecl </para> <para>org.xml.sax.Attributes </para></para>        
				/// </summary>
				/// <java-name>
				/// unparsedEntityDecl
				/// </java-name>
		...
		/// import org.xml.sax.InputSource;</pre></para> <para> <pre>public class MyResolver implements EntityResolver {
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>Zero-argument default constructor.</para> <para> <para>setPublicId </para> <para>setSystemId </para> <para>setByteStream </para> <para>setCharacterStream </para> <para>setEncoding </para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
				...
				/// <summary>
				///  <para>Get the system identifier for this input source.</para> <para>The getEncoding method will return the character encoding of the object pointed to, or null if unknown.</para> <para>If the system ID is a URL, it will be fully resolved.</para> <para> <para>setSystemId </para> <para>getEncoding </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Get the byte stream for this input source.</para> <para>The getEncoding method will return the character encoding for this byte stream, or null if unknown.</para> <para> <para>getEncoding </para> <para>setByteStream </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Get the character encoding for a byte stream or URI. This value will be ignored when the application provides a character stream.</para> <para> <para>setByteStream </para> <para>getSystemId </para> <para>getByteStream </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// getParent
				/// </java-name>
				global::Org.Xml.Sax.IXMLReader Parent
				{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// getEntityResolver
				/// </java-name>
				global::Org.Xml.Sax.IEntityResolver EntityResolver
				{
				...
				/// getDTDHandler
				/// </java-name>
				global::Org.Xml.Sax.IDTDHandler DTDHandler
				{
				...
				/// getContentHandler
				/// </java-name>
				global::Org.Xml.Sax.IContentHandler ContentHandler
				{
				...
				/// getErrorHandler
				/// </java-name>
				global::Org.Xml.Sax.IErrorHandler ErrorHandler
				{
