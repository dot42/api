 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Sets the value of the specified parameter in the <c>RowSet </c> command to a supplied <c>java.sql.Time </c> , converting it to an SQL <c>TIME </c> value using the system default <c>Calendar </c> .</para> <para> <para>java.util.Calendar </para> <para>java.sql.Time </para></para>        
				/// </summary>
				/// <java-name>
				/// setTime
				/// </java-name>
				...
				/// <summary>
				///  <para>Sets the value of the specified parameter in the <c>RowSet </c> command to a supplied <c>java.sql.Time </c> , converting it to an SQL <c>TIME </c> value using a supplied <c>Calendar </c> .</para> <para> <para>java.util.Calendar </para> <para>java.sql.Time </para></para>        
				/// </summary>
				/// <java-name>
				/// setTime
				/// </java-name>
				...
				/// <summary>
				///  <para>Sets the value of the specified parameter in the <c>RowSet </c> command to a supplied <c>java.sql.Timestamp </c> , converting it to an SQL <c>TIMESTAMP </c> value using the system default <c>Calendar </c> .</para> <para> <para>java.util.Calendar </para> <para>java.sql.Timestamp </para></para>        
				/// </summary>
				/// <java-name>
				/// setTimestamp
				/// </java-name>
				...
				/// <summary>
				///  <para>Sets the value of the specified parameter in the <c>RowSet </c> command to a supplied <c>java.sql.Timestamp </c> , converting it to an SQL <c>TIMESTAMP </c> value using a supplied <c>Calendar </c> .</para> <para> <para>java.util.Calendar </para> <para>java.sql.Timestamp </para></para>        
				/// </summary>
				/// <java-name>
				/// setTimestamp
				/// </java-name>
