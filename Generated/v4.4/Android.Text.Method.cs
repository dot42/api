 ...
 /* scope: __dot42__ */ 
		{
				...
				public static int GetMetaState(global::Java.Lang.ICharSequence charSequence, global::Android.Views.KeyEvent keyEvent) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// <summary>
				///  <para>Gets the state of a particular meta key to use with a particular key event.</para> <para>If the key event has been created by a device that does not support toggled key modifiers, like a virtual keyboard for example, only the meta state in the key event is considered.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>0 if inactive, 1 if active, 2 if locked. </para>
				/// </returns>
				/// <java-name>
				/// getMetaState
				/// </java-name>
				[Dot42.DexImport("getMetaState", "(Ljava/lang/CharSequence;ILandroid/view/KeyEvent;)I", AccessFlags = 25)]
				public static int GetMetaState(global::Java.Lang.ICharSequence text, int meta, global::Android.Views.KeyEvent @event) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
