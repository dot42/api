 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Called when the implicit parent dependency changes.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// onParentChanged
				/// </java-name>
				[Dot42.DexImport("onParentChanged", "(Landroid/preference/Preference;Z)V", AccessFlags = 1)]
				public virtual void OnParentChanged(global::Android.Preferences.Preference parent, bool disableChild) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Subclasses should override this method and verify that the given fragment is a valid type to be attached to this activity. The default implementation returns  <code>true</code> for apps built for  <code>android:targetSdkVersion</code> older than android.os.Build.VERSION_CODES#KITKAT. For later versions, it will throw an exception. </para>        
				/// </summary>
				/// <returns>
				///  <para>true if the fragment class name is valid for this Activity and false otherwise. </para>
				/// </returns>
				/// <java-name>
				/// isValidFragment
				/// </java-name>
				[Dot42.DexImport("isValidFragment", "(Ljava/lang/String;)Z", AccessFlags = 4)]
				protected internal virtual bool IsValidFragment(string fragmentName) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </java-name>
				[Dot42.DexImport("notifyDependencyChange", "(Z)V", AccessFlags = 1)]
				public override void NotifyDependencyChange(bool disableDependents) /* MethodBuilder.Create */ 
				{
				}
