...
namespace Android.Util
{
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>ArrayMap is a generic key-&gt;value mapping data structure that is designed to be more memory efficient than a traditional java.util.HashMap. It keeps its mappings in an array data structure  an integer array of hash codes for each item, and an Object array of the key/value pairs. This allows it to avoid having to create an extra object for every entry put in to the map, and it also tries to control the growth of the size of these arrays more aggressively (since growing them only requires copying the entries in the array, not rebuilding a hash map).</para> <para>Note that this implementation is not intended to be appropriate for data structures that may contain large numbers of items. It is generally slower than a traditional HashMap, since lookups require a binary search and adds and removes require inserting and deleting entries in the array. For containers holding up to hundreds of items, the performance difference is not significant, less than 50%.</para> <para>Because this container is intended to better balance memory use, unlike most other standard Java containers it will shrink its array as items are removed from it. Currently you have no control over this shrinking  if you set a capacity and then remove an item, it may reduce the capacity to better match the current size. In the future an explicit call to set the capacity should turn off this aggressive shrinking behavior.</para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>Create a new empty ArrayMap. The default capacity of an array map is 0, and will grow once items are added to it. </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
				...
				/// <summary>
				///  <para>Create a new ArrayMap with a given initial capacity. </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(I)V", AccessFlags = 1)]
				public ArrayMap(int capacity) /* MethodBuilder.Create */ 
				{
				}
				...
				public ArrayMap(global::Android.Util.ArrayMap<object, object> capacity) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Make the array map empty. All storage is released. </para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
				...
				/// <summary>
				///  <para>Ensure the array map can hold at least  <b>minimumCapacity</b> items. </para>        
				/// </summary>
				/// <java-name>
				/// ensureCapacity
				/// </java-name>
				[Dot42.DexImport("ensureCapacity", "(I)V", AccessFlags = 1)]
				public void EnsureCapacity(int minimumCapacity) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Check whether a key exists in the array.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>Returns true if the key exists, else false. </para>
				/// </returns>
				/// <java-name>
				/// containsKey
				/// </java-name>
				[Dot42.DexImport("containsKey", "(Ljava/lang/Object;)Z", AccessFlags = 1)]
				public bool ContainsKey(object key) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				///  <para>Check whether a value exists in the array. This requires a linear search through the entire array.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>Returns true if the value exists, else false. </para>
				/// </returns>
				/// <java-name>
				/// containsValue
				/// </java-name>
				[Dot42.DexImport("containsValue", "(Ljava/lang/Object;)Z", AccessFlags = 1)]
				public bool ContainsValue(object value) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				///  <para>Retrieve a value from the array. </para>        
				/// </summary>
				/// <returns>
				///  <para>Returns the value associated with the given key, or null if there is no such key. </para>
				/// </returns>
				/// <java-name>
				/// get
				/// </java-name>
				[Dot42.DexImport("get", "(Ljava/lang/Object;)Ljava/lang/Object;", AccessFlags = 1, Signature = "(Ljava/lang/Object;)TV;")]
				public V Get(object key) /* MethodBuilder.Create */ 
				{
						return default(V);
				}

				/// <summary>
				///  <para>Return the key at the given index in the array. </para>        
				/// </summary>
				/// <returns>
				///  <para>Returns the key stored at the given index. </para>
				/// </returns>
				/// <java-name>
				/// keyAt
				/// </java-name>
				[Dot42.DexImport("keyAt", "(I)Ljava/lang/Object;", AccessFlags = 1, Signature = "(I)TK;")]
				public K KeyAt(int index) /* MethodBuilder.Create */ 
				{
						return default(K);
				}

				/// <summary>
				///  <para>Return the value at the given index in the array. </para>        
				/// </summary>
				/// <returns>
				///  <para>Returns the value stored at the given index. </para>
				/// </returns>
				/// <java-name>
				/// valueAt
				/// </java-name>
				[Dot42.DexImport("valueAt", "(I)Ljava/lang/Object;", AccessFlags = 1, Signature = "(I)TV;")]
				public V ValueAt(int index) /* MethodBuilder.Create */ 
				{
						return default(V);
				}

				/// <summary>
				///  <para>Set the value at a given index in the array. </para>        
				/// </summary>
				/// <returns>
				///  <para>Returns the previous value at the given index. </para>
				/// </returns>
				/// <java-name>
				/// setValueAt
				/// </java-name>
				[Dot42.DexImport("setValueAt", "(ILjava/lang/Object;)Ljava/lang/Object;", AccessFlags = 1, Signature = "(ITV;)TV;")]
				public V SetValueAt(int index, V value) /* MethodBuilder.Create */ 
				{
						return default(V);
				}

				/// <summary>
				///  <para>Add a new value to the array map. </para>        
				/// </summary>
				/// <returns>
				///  <para>Returns the old value that was stored for the given key, or null if there was no such key. </para>
				/// </returns>
				/// <java-name>
				/// put
				/// </java-name>
				...
				/// <summary>
				///  <para>Perform a put(Object, Object) of all key/value pairs in  <b>array</b> </para>        
				/// </summary>
				/// <java-name>
				/// putAll
				/// </java-name>
				[Dot42.DexImport("putAll", "(Landroid/util/ArrayMap;)V", AccessFlags = 1, Signature = "(Landroid/util/ArrayMap<+TK;+TV;>;)V")]
				public void PutAll(global::Android.Util.ArrayMap<K, V> array) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Remove an existing key from the array map. </para>        
				/// </summary>
				/// <returns>
				///  <para>Returns the value that was stored under the key, or null if there was no such key. </para>
				/// </returns>
				/// <java-name>
				/// remove
				/// </java-name>
				[Dot42.DexImport("remove", "(Ljava/lang/Object;)Ljava/lang/Object;", AccessFlags = 1, Signature = "(Ljava/lang/Object;)TV;")]
				public V Remove(object key) /* MethodBuilder.Create */ 
				{
						return default(V);
				}

				/// <summary>
				///  <para>Remove the key/value mapping at the given index. </para>        
				/// </summary>
				/// <returns>
				///  <para>Returns the value that was stored at this index. </para>
				/// </returns>
				/// <java-name>
				/// removeAt
				/// </java-name>
				[Dot42.DexImport("removeAt", "(I)Ljava/lang/Object;", AccessFlags = 1, Signature = "(I)TV;")]
				public V RemoveAt(int index) /* MethodBuilder.Create */ 
				{
						return default(V);
				}

				/// <summary>
				///  <para>Return the number of items in this array map. </para>        
				/// </summary>
				/// <java-name>
				/// size
				/// </java-name>
				...
				/// <summary>
				///  <para> <para>Compares the argument to the receiver, and returns <c>true </c> if the specified object is a <c>Map </c> and both <c>Map </c> s contain the same mappings.</para> <para> <para>hashCode() </para> <para>entrySet()</para></para></para> <para>This implementation returns false if the object is not a map, or if the maps have different sizes. Otherwise, for each key in this map, values of both maps are compared. If the values for any key are not equal, the method returns false, otherwise it returns true. </para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para> <para>Returns an integer hash code for the receiver. <c>Object </c> s which are equal return the same value for this method.</para> <para> <para>equals(Object)</para></para> </para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>This implementation composes a string by iterating over its mappings. If this map contains itself as a key or a value, the string "(this Map)" will appear in its place. </para>        
				/// </summary>
				/// <java-name>
				/// toString
				/// </java-name>
				...
				/// <summary>
				///  <para>Determine if the array map contains all of the keys in the given collection. </para>        
				/// </summary>
				/// <returns>
				///  <para>Returns true if this array map contains a key for every entry in  <b>collection</b>, else returns false. </para>
				/// </returns>
				/// <java-name>
				/// containsAll
				/// </java-name>
				...
				public void PutAll(global::Java.Util.IMap<K, V> array) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Remove all keys in the array map that exist in the given collection. </para>        
				/// </summary>
				/// <returns>
				///  <para>Returns true if any keys were removed from the array map, else false. </para>
				/// </returns>
				/// <java-name>
				/// removeAll
				/// </java-name>
				...
				/// <summary>
				///  <para>Remove all keys in the array map that do  <b>not</b> exist in the given collection. </para>        
				/// </summary>
				/// <returns>
				///  <para>Returns true if any keys were removed from the array map, else false. </para>
				/// </returns>
				...
				/// <summary>
				///  <para>Return a java.util.Set for iterating over and interacting with all mappings in the array map.</para> <para> <b>Note:</b> this is a very inefficient way to access the array contents, it requires generating a number of temporary objects.</para> <para> <b>Note:</b></para> <para>the semantics of this Set are subtly different than that of a java.util.HashMap: most important, the Map.Entry object returned by its iterator is a single object that exists for the entire iterator, so you can  <b>not</b> hold on to it after calling Iterator.next.</para>        
				/// </summary>
				/// <java-name>
				/// entrySet
				/// </java-name>
				...
				/// <summary>
				///  <para>Return a java.util.Set for iterating over and interacting with all keys in the array map.</para> <para> <b>Note:</b> this is a fairly inefficient way to access the array contents, it requires generating a number of temporary objects.</para>        
				/// </summary>
				/// <java-name>
				/// keySet
				/// </java-name>
				...
				/// <summary>
				///  <para>Return a java.util.Collection for iterating over and interacting with all values in the array map.</para> <para> <b>Note:</b> this is a fairly inefficient way to access the array contents, it requires generating a number of temporary objects.</para>        
				/// </summary>
				/// <java-name>
				/// values
				/// </java-name>
				...
				/// <summary>
				///  <para>Return true if the array map contains no items. </para>        
				/// </summary>
				/// <java-name>
				/// isEmpty
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				protected internal AtomicFile() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
				...
				/// getBaseFile
				/// </java-name>
				public virtual global::Java.IO.File BaseFile
				{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Intermediate density for screens that sit somewhere between DENSITY_XHIGH (320dpi) and DENSITY_XXHIGH (480 dpi). This is not a density that applications should target, instead relying on the system to scale their DENSITY_XXHIGH assets for them. </para>        
				/// </summary>
				/// <java-name>
				/// DENSITY_400
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>A class for defining layout directions. A layout direction can be left-to-right (LTR) or right-to-left (RTL). It can also be inherited (from a parent) or deduced from the default language script of a locale. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>Horizontal layout direction is from Left to Right. </para>        
				/// </summary>
				/// <java-name>
				/// LTR
				/// </java-name>
				...
				/// <summary>
				///  <para>Horizontal layout direction is from Right to Left. </para>        
				/// </summary>
				/// <java-name>
				/// RTL
				/// </java-name>
				...
				/// <summary>
				///  <para>Horizontal layout direction is inherited. </para>        
				/// </summary>
				/// <java-name>
				/// INHERIT
				/// </java-name>
				...
				/// <summary>
				///  <para>Horizontal layout direction is deduced from the default language script for the locale. </para>        
				/// </summary>
				/// <java-name>
				/// LOCALE
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Creates a new LongSparseArray containing no mappings that will not require any additional memory allocation to store the specified number of mappings. If you supply an initial capacity of 0, the sparse array will be initialized with a light-weight representation not requiring any additional array allocations. </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(I)V", AccessFlags = 1)]
				...
				/// <summary>
				///  <para>This implementation composes a string by iterating over its mappings. If this map contains itself as a value, the string "(this Map)" will appear in its place. </para>        
				/// </summary>
				/// <java-name>
				/// toString
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Remove a range of mappings as a batch.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// removeAtRange
				/// </java-name>
				[Dot42.DexImport("removeAtRange", "(II)V", AccessFlags = 1)]
				public virtual void RemoveAtRange(int index, int size) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>This implementation composes a string by iterating over its mappings. </para>        
				/// </summary>
				/// <java-name>
				/// toString
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Creates a new SparseLongArray containing no mappings that will not require any additional memory allocation to store the specified number of mappings. If you supply an initial capacity of 0, the sparse array will be initialized with a light-weight representation not requiring any additional array allocations. </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(I)V", AccessFlags = 1)]
				...
				/// <summary>
				///  <para>Given an index in the range  <code>0...size()-1</code>, returns the key from the  <code>index</code>th key-value mapping that this SparseLongArray stores.</para> <para>The keys corresponding to indices in ascending order are guaranteed to be in ascending order, e.g.,  <code>keyAt(0)</code> will return the smallest key and  <code>keyAt(size()-1)</code> will return the largest key.</para>        
				/// </summary>
				/// <java-name>
				/// keyAt
				/// </java-name>
				...
				/// <summary>
				///  <para>Given an index in the range  <code>0...size()-1</code>, returns the value from the  <code>index</code>th key-value mapping that this SparseLongArray stores.</para> <para>The values corresponding to indices in ascending order are guaranteed to be associated with keys in ascending order, e.g.,  <code>valueAt(0)</code> will return the value associated with the smallest key and  <code>valueAt(size()-1)</code> will return the value associated with the largest key.</para>        
				/// </summary>
				/// <java-name>
				/// valueAt
				/// </java-name>
