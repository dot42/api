...
namespace Android.Media.Audiofx
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>UUID for Loudness Enhancer </para>        
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>The maximum gain applied applied to the signal to process. It is expressed in millibels (100mB = 1dB) where 0mB corresponds to no amplification. </para>        
				/// </summary>
				/// <java-name>
				...
				public LoudnessEnhancer(int audioSession) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Set the target gain for the audio effect. The target gain is the maximum value by which a sample value will be amplified when the effect is enabled. </para>        
				/// </summary>
				/// <java-name>
				/// setTargetGain
				/// </java-name>
				[Dot42.DexImport("setTargetGain", "(I)V", AccessFlags = 1)]
				public virtual void SetTargetGain(int gainmB) /* MethodBuilder.Create */ 
				{
				}

				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				protected internal LoudnessEnhancer() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}

				/// <summary>
				///  <para>Return the target gain. </para>        
				/// </summary>
				/// <returns>
				///  <para>the effect target gain expressed in mB. </para>
				/// </returns>
				/// <java-name>
				/// getTargetGain
				/// </java-name>
				public virtual float TargetGain
				{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Defines a measurement mode in which no measurements are performed. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Defines a measurement mode which computes the peak and RMS value in mB, where 0mB is the maximum sample value, and -9600mB is the minimum value. Values for peak and RMS can be retrieved with getMeasurementPeakRms(MeasurementPeakRms). </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Sets the combination of measurement modes to be performed by this audio effect. </para>        
				/// </summary>
				/// <returns>
				///  <para>SUCCESS in case of success, ERROR_BAD_VALUE in case of failure. </para>
				/// </returns>
				...
				public virtual int SetMeasurementMode(int mode) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// <summary>
				///  <para>Retrieves the latest peak and RMS measurement. Sets the peak and RMS fields of the supplied Visualizer.MeasurementPeakRms to the latest measured values. </para>        
				/// </summary>
				/// <returns>
				///  <para>SUCCESS in case of success, ERROR_BAD_VALUE, ERROR_NO_MEMORY, ERROR_INVALID_OPERATION or ERROR_DEAD_OBJECT in case of failure. </para>
				/// </returns>
				/// <java-name>
				...
				public virtual int GetMeasurementPeakRms(global::Android.Media.Audiofx.Visualizer.MeasurementPeakRms measurement) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// <summary>
				///  <para>Returns the current measurement modes performed by this audio effect </para>        
				/// </summary>
				/// <returns>
				///  <para>the mask of the measurements, MEASUREMENT_MODE_NONE (when no measurements are performed) or MEASUREMENT_MODE_PEAK_RMS. </para>
				/// </returns>
				/// <java-name>
				/// getMeasurementMode
				/// </java-name>
				public virtual int MeasurementMode
				{
 ...
 /* scope: __dot42__ */ 
				...
				/// <summary>
				///  <para>A class to store peak and RMS values. Peak and RMS are expressed in mB, as described in the Visualizer#MEASUREMENT_MODE_PEAK_RMS measurement mode. </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						/// <summary>
						///  <para>The peak value in mB. </para>        
						/// </summary>
						/// <java-name>
						/// mPeak
						/// </java-name>
