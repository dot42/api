...
namespace Android.Database.Sqlite
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Releases a reference to the object, closing the object if the last reference was released.</para> <para>Calling this method is equivalent to calling releaseReference.</para> <para> <para>releaseReference() </para> <para>onAllReferencesReleased() </para></para>        
				/// </summary>
				/// <java-name>
				/// close
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "tring;I)I", AccessFlags = 1)]
				...
				///     db.enableWriteAheadLogging();
				/// </pre></code> </para> <para>See also  for more details about how write-ahead logging works. </para> <para> <para>ENABLE_WRITE_AHEAD_LOGGING </para> <para>disableWriteAheadLogging </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns true if write-ahead logging has been enabled for this database.</para> <para> <para>enableWriteAheadLogging </para> <para>ENABLE_WRITE_AHEAD_LOGGING </para></para>        
				/// </summary>
				/// <returns>
