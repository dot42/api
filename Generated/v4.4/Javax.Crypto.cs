...
{
		/// <summary>
		///  <para>Thrown by a Cipher that is using an Authenticated Encryption with Additional Data (AEAD) mode such as Galois/Counter Mode (GCM) and the tag failed verification.</para> <para> <para>1.7 </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>Constructs an instance of <c>AEADBadTagException </c> . </para>        
				/// </summary>
				...
				/// <summary>
				///  <para>Constructs an instance of <c>AEADBadTagException </c> with the given  <c>message </c> . </para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public AEADBadTagException(string message) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
    ...
    "om;)V", AccessFlags = 17)]
				...
				/// <summary>
				///  <para>Continues a multi-part transformation (encryption or decryption) with Authenticated Additional Data (AAD). AAD may only be added after the  <c>Cipher </c> is initialized and before any data is passed to the instance. </para> <para>This is only usable with cipher modes that support Authenticated Encryption with Additional Data (AEAD) such as Galois/Counter Mode (GCM).</para> <para> <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// updateAAD
				/// </java-name>
				...
				public void UpdateAAD(global::Java.Nio.ByteBuffer input) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
    ...
    "om;)V", AccessFlags = 1028)]
				...
				/// <summary>
				///  <para>Continues a multi-part transformation (encryption or decryption). The  <c>input.remaining() </c> bytes starting at <c>input.position() </c> are used for the Additional Authenticated Data (AAD). AAD may only be added after the <c>Cipher </c> is initialized and before any data is passed to the instance. </para> <para>This is only usable with cipher modes that support Authenticated Encryption with Additional Data (AEAD) such as Galois/Counter Mode (GCM).</para> <para> <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// engineUpdateAAD
				/// </java-name>
				[Dot42.DexImport("engineUpdateAAD", "(Ljava/nio/ByteBuffer;)V", AccessFlags = 4)]
				protected internal virtual void EngineUpdateAAD(global::Java.Nio.ByteBuffer input) /* MethodBuilder.Create */ 
				{
				}
