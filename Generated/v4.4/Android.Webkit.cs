...
namespace Android.Webkit
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// hasCookies
				/// </java-name>
				public virtual bool HasCookies
				{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </java-name>
				public virtual bool MediaPlaybackRequiresUserGesture
				{
				...
				/// </java-name>
				public abstract bool AllowUniversalAccessFromFileURLs
				{
				...
				/// </java-name>
				public abstract bool AllowFileAccessFromFileURLs
				{
 ...
 /* scope: __dot42__ */ 
    ...
    "ng/String;)V", AccessFlags = 1)]
				...
				/// <summary>
				///  <para>Asynchronously evaluates JavaScript in the context of the currently displayed page. If non-null, |resultCallback| will be invoked with any result returned from that execution. This method must be called on the UI thread and the callback will be made on the UI thread.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// evaluateJavascript
				/// </java-name>
				...
				public virtual void EvaluateJavascript(string script, global::Android.Webkit.IValueCallback<string> resultCallback) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				///  <para>Creates a PrintDocumentAdapter that provides the content of this Webview for printing. Only supported for API levels android.os.Build.VERSION_CODES#KITKAT and above.</para> <para>The adapter works by converting the Webview contents to a PDF stream. The Webview cannot be drawn during the conversion process - any such draws are undefined. It is recommended to use a dedicated off screen Webview for the printing. If necessary, an application may temporarily hide a visible WebView by using a custom PrintDocumentAdapter instance wrapped around the object returned and observing the onStart and onFinish methods. See android.print.PrintDocumentAdapter for more information. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Enables debugging of web contents (HTML / CSS / JavaScript) loaded into any WebViews of this application. This flag can be enabled in order to facilitate debugging of web layouts and JavaScript code running inside WebViews. Please refer to WebView documentation for the debugging guide.</para> <para>The default is false.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// setWebContentsDebuggingEnabled
				/// </java-name>
				[Dot42.DexImport("setWebContentsDebuggingEnabled", "(Z)V", AccessFlags = 9)]
				public static void SetWebContentsDebuggingEnabled(bool enabled) /* MethodBuilder.Create */ 
				{
				}
    ...
    "", AccessFlags = 1)]
				...
				public override global::Android.Views.Accessibility.AccessibilityNodeProvider AccessibilityNodeProvider
				{
						...
						get{ return default(global::Android.Views.Accessibility.AccessibilityNodeProvider); }
				}
