...
namespace Android.Views.Accessibility
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Change type for TYPE_WINDOW_CONTENT_CHANGED event: The type of change is not defined. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Change type for TYPE_WINDOW_CONTENT_CHANGED event: A node in the subtree rooted at the source node was added or removed. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Change type for TYPE_WINDOW_CONTENT_CHANGED event: The node's text changed. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Change type for TYPE_WINDOW_CONTENT_CHANGED event: The node's content description changed. </para>        
				/// </summary>
				/// <java-name>
    ...
    "ssibilityEvent;", AccessFlags = 9)]
				...
				/// <summary>
				///  <para>Gets the bit mask of change types signaled by an TYPE_WINDOW_CONTENT_CHANGED event. A single event may represent multiple change types.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>The bit mask of change types. One or more of:  <ul> <li> <para>AccessibilityEvent#CONTENT_CHANGE_TYPE_CONTENT_DESCRIPTION </para></li> <li> <para>AccessibilityEvent#CONTENT_CHANGE_TYPE_SUBTREE </para></li> <li> <para>AccessibilityEvent#CONTENT_CHANGE_TYPE_TEXT </para></li> <li> <para>AccessibilityEvent#CONTENT_CHANGE_TYPE_UNDEFINED </para></li></ul></para>
				/// </returns>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "r;)Z", AccessFlags = 1)]
				...
				/// <summary>
				///  <para>Registers a TouchExplorationStateChangeListener for changes in the global touch exploration state of the system.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>True if successfully registered. </para>
				/// </returns>
    ...
    "ener;)Z", AccessFlags = 1)]
				public bool AddTouchExplorationStateChangeListener(global::Android.Views.Accessibility.AccessibilityManager.ITouchExplorationStateChangeListener listener) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				///  <para>Unregisters a TouchExplorationStateChangeListener.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>True if successfully unregistered. </para>
				/// </returns>
    ...
    "ener;)Z", AccessFlags = 1)]
				public bool RemoveTouchExplorationStateChangeListener(global::Android.Views.Accessibility.AccessibilityManager.ITouchExplorationStateChangeListener listener) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// <summary>
				///  <para>Listener for the system touch exploration state. To listen for changes to the touch exploration state on the device, implement this interface and register it with the system by calling addTouchExplorationStateChangeListener. </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						/// <summary>
						///  <para>Called when the touch exploration enabled state changes.</para> <para></para>        
						/// </summary>
						/// <java-name>
						/// onTouchExplorationStateChanged
						/// </java-name>
						[Dot42.DexImport("onTouchExplorationStateChanged", "(Z)V", AccessFlags = 1025)]
						void OnTouchExplorationStateChanged(bool enabled) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </pre></code></para> <para> <code> </code></para> <para> <code></code></para> <para> <code> <para>ACTION_ARGUMENT_SELECTION_START_INT </para> <para>ACTION_ARGUMENT_SELECTION_END_INT </para></code></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Action to expand an expandable node. </para>        
				/// </summary>
				/// <java-name>
				/// ACTION_EXPAND
				/// </java-name>
				...
				/// <summary>
				///  <para>Action to collapse an expandable node. </para>        
				/// </summary>
				/// <java-name>
				/// ACTION_COLLAPSE
				/// </java-name>
				...
				/// <summary>
				///  <para>Action to dismiss a dismissable node. </para>        
				/// </summary>
				/// <java-name>
				/// ACTION_DISMISS
				/// </java-name>
				...
				/// <summary>
				///  <para>Argument for whether when moving at granularity to extend the selection or to move it otherwise. </para> <para> <b>Type:</b> boolean <br></br>  <b>Actions:</b> ACTION_NEXT_AT_MOVEMENT_GRANULARITY, ACTION_PREVIOUS_AT_MOVEMENT_GRANULARITY </para> <para> <para>ACTION_NEXT_AT_MOVEMENT_GRANULARITY </para> <para>ACTION_PREVIOUS_AT_MOVEMENT_GRANULARITY </para></para>        
				/// </summary>
				/// <java-name>
    ...
    "Info;>;")]
				public virtual global::Java.Util.IList<global::Android.Views.Accessibility.AccessibilityNodeInfo> FindAccessibilityNodeInfosByViewId(string viewId) /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.IList<global::Android.Views.Accessibility.AccessibilityNodeInfo>);
				}
				...
				/// <summary>
				///  <para>Gets the collection info if the node is a collection. A collection child is always a collection item.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>The collection info. </para>
				/// </returns>
				/// <java-name>
				/// getCollectionInfo
				/// </java-name>
				[Dot42.DexImport("getCollectionInfo", "()Landroid/view/accessibility/AccessibilityNodeInfo$CollectionInfo;", AccessFlags = 1)]
				public virtual global::Android.Views.Accessibility.AccessibilityNodeInfo.CollectionInfo GetCollectionInfo() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Views.Accessibility.AccessibilityNodeInfo.CollectionInfo);
				}

				/// <summary>
				///  <para>Sets the collection info if the node is a collection. A collection child is always a collection item. </para> <para> <b>Note:</b> Cannot be called from an android.accessibilityservice.AccessibilityService. This class is made immutable before being delivered to an AccessibilityService. </para> <para></para>        
				/// </summary>
				/// <java-name>
				/// setCollectionInfo
				/// </java-name>
				[Dot42.DexImport("setCollectionInfo", "(Landroid/view/accessibility/AccessibilityNodeInfo$CollectionInfo;)V", AccessFlags = 1)]
				public virtual void SetCollectionInfo(global::Android.Views.Accessibility.AccessibilityNodeInfo.CollectionInfo collectionInfo) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Gets the collection item info if the node is a collection item. A collection item is always a child of a collection.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>The collection item info. </para>
				/// </returns>
				/// <java-name>
				...
				public virtual global::Android.Views.Accessibility.AccessibilityNodeInfo.CollectionItemInfo GetCollectionItemInfo() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Views.Accessibility.AccessibilityNodeInfo.CollectionItemInfo);
				}

				/// <summary>
				///  <para>Sets the collection item info if the node is a collection item. A collection item is always a child of a collection. </para> <para> <b>Note:</b> Cannot be called from an android.accessibilityservice.AccessibilityService. This class is made immutable before being delivered to an AccessibilityService. </para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>collectionItem True if the node is an item. </para>
				/// </returns>
				/// <java-name>
				...
				public virtual void SetCollectionItemInfo(global::Android.Views.Accessibility.AccessibilityNodeInfo.CollectionItemInfo collectionItemInfo) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Gets the range info if this node is a range.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>The range. </para>
				/// </returns>
				...
				public virtual global::Android.Views.Accessibility.AccessibilityNodeInfo.RangeInfo GetRangeInfo() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Views.Accessibility.AccessibilityNodeInfo.RangeInfo);
				}

				/// <summary>
				///  <para>Sets the range info if this node is a range. </para> <para> <b>Note:</b> Cannot be called from an android.accessibilityservice.AccessibilityService. This class is made immutable before being delivered to an AccessibilityService. </para> <para></para>        
				/// </summary>
				/// <java-name>
				/// setRangeInfo
				/// </java-name>
				[Dot42.DexImport("setRangeInfo", "(Landroid/view/accessibility/AccessibilityNodeInfo$RangeInfo;)V", AccessFlags = 1)]
				public virtual void SetRangeInfo(global::Android.Views.Accessibility.AccessibilityNodeInfo.RangeInfo rangeInfo) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Sets if this node opens a popup or a dialog. </para> <para> <b>Note:</b> Cannot be called from an android.accessibilityservice.AccessibilityService. This class is made immutable before being delivered to an AccessibilityService. </para> <para></para>        
				/// </summary>
				/// <java-name>
				/// setCanOpenPopup
				/// </java-name>
				[Dot42.DexImport("setCanOpenPopup", "(Z)V", AccessFlags = 1)]
				public virtual void SetCanOpenPopup(bool opensPopup) /* MethodBuilder.Create */ 
				{
				}
    ...
    "ccessibilityNodeInfo;", AccessFlags = 9)]
				...
				/// <summary>
				///  <para>Gets if the content of this node is invalid. For example, a date is not well-formed.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>If the node content is invalid. </para>
				/// </returns>
				/// <java-name>
				/// isContentInvalid
				/// </java-name>
				public virtual bool IsContentInvalid
				{
				...
				/// <summary>
				///  <para>Gets the node's live region mode. </para> <para>A live region is a node that contains information that is important for the user and when it changes the user should be notified. For example, in a login screen with a TextView that displays an "incorrect password" notification, that view should be marked as a live region with mode View#ACCESSIBILITY_LIVE_REGION_POLITE. </para> <para>It is the responsibility of the accessibility service to monitor AccessibilityEvent#TYPE_WINDOW_CONTENT_CHANGED events indicating changes to live region nodes and their children.</para> <para> <para>android.view.View::getAccessibilityLiveRegion() </para></para>        
				/// </summary>
				/// <returns>
				///  <para>The live region mode, or View#ACCESSIBILITY_LIVE_REGION_NONE if the view is not a live region. </para>
				/// </returns>
				/// <java-name>
				/// getLiveRegion
				/// </java-name>
				public virtual int LiveRegion
				{
				...
				/// <summary>
				///  <para>Gets if the node is a multi line editable text.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>True if the node is multi line. </para>
				/// </returns>
				/// <java-name>
				/// isMultiLine
				/// </java-name>
				...
				/// <summary>
				///  <para>Gets if this node opens a popup or a dialog.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>If the the node opens a popup. </para>
				/// </returns>
				/// <java-name>
				/// canOpenPopup
				/// </java-name>
				...
				/// <summary>
				///  <para>Gets if the node can be dismissed.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>If the node can be dismissed. </para>
				/// </returns>
				/// <java-name>
				/// isDismissable
				/// </java-name>
				...
				/// </java-name>
				public virtual string ViewIdResourceName
				{
				...
				/// <summary>
				///  <para>Gets the input type of the source as defined by InputType.</para> <para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Gets an optional bundle with extra data. The bundle is lazily created and never  <code>null</code>. </para> <para> <b>Note:</b> It is recommended to use the package name of your application as a prefix for the keys to avoid collisions which may confuse an accessibility service if the same key has different meaning when emitted from different applications. </para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>The bundle. </para>
				/// </returns>
				/// <java-name>
				/// getExtras
				/// </java-name>
				...
				/// <summary>
				///  <para>Class with information if a node is a collection item. Use CollectionItemInfo#obtain(int, int, int, int, boolean) to get an instance. </para> <para>A collection item is contained in a collection, it starts at a given row and column in the collection, and spans one or more rows and columns. For example, a header of two related table columns starts at the first row and the first column, spans one row and two columns. </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>Obtains a pooled instance.</para> <para></para>        
						/// </summary>
						/// <java-name>
						/// obtain
						/// </java-name>
						[Dot42.DexImport("obtain", "(IIIIZ)Landroid/view/accessibility/AccessibilityNodeInfo$CollectionItemInfo;", AccessFlags = 9)]
						public static CollectionItemInfo Obtain(int rowIndex, int rowSpan, int columnIndex, int columnSpan, bool heading) /* MethodBuilder.Create */ 
						{
								return default(CollectionItemInfo);
						}

						/// <summary>
						///  <para>Gets the column index at which the item is located.</para> <para></para>        
						/// </summary>
						/// <returns>
						...
						/// <summary>
						///  <para>Gets the row index at which the item is located.</para> <para></para>        
						/// </summary>
						/// <returns>
						...
						/// <summary>
						///  <para>Gets the number of columns the item spans.</para> <para></para>        
						/// </summary>
						/// <returns>
						///  <para>The column span. </para>
						/// </returns>
						/// <java-name>
						/// getColumnSpan
						/// </java-name>
						...
						/// <summary>
						///  <para>Gets the number of rows the item spans.</para> <para></para>        
						/// </summary>
						/// <returns>
						///  <para>The row span. </para>
						/// </returns>
						/// <java-name>
						/// getRowSpan
						/// </java-name>
						...
						/// <summary>
						///  <para>Gets if the collection item is a heading. For example, section heading, table header, etc.</para> <para></para>        
						/// </summary>
						/// <returns>
						///  <para>If the item is a heading. </para>
						/// </returns>
						/// <java-name>
						/// isHeading
						/// </java-name>
				...
				/// <summary>
				///  <para>Class with information if a node is a collection. Use CollectionInfo#obtain(int, int, boolean) to get an instance. </para> <para>A collection of items has rows and columns and may be hierarchical. For example, a horizontal list is a collection with one column, as many rows as the list items, and is not hierarchical; A table is a collection with several rows, several columns, and is not hierarchical; A vertical tree is a hierarchical collection with one column and as many rows as the first level children. </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						...
						public static CollectionInfo Obtain(int rowCount, int columnCount, bool hierarchical) /* MethodBuilder.Create */ 
						{
								return default(CollectionInfo);
						}

						/// <summary>
						///  <para>Gets the number of rows.</para> <para></para>        
						/// </summary>
						/// <returns>
						///  <para>The row count. </para>
						/// </returns>
						/// <java-name>
						/// getRowCount
						/// </java-name>
						...
						/// <summary>
						///  <para>Gets the number of columns.</para> <para></para>        
						/// </summary>
						/// <returns>
						...
						/// <summary>
						///  <para>Gets if the collection is a hierarchically ordered.</para> <para></para>        
						/// </summary>
						/// <returns>
						///  <para>Whether the collection is hierarchical. </para>
						/// </returns>
						/// <java-name>
						/// isHierarchical
						/// </java-name>
				...
				/// <summary>
				///  <para>Class with information if a node is a range. Use RangeInfo#obtain(int, float, float, float) to get an instance. </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>Range type: percent with values from zero to one. </para>        
						/// </summary>
						/// <java-name>
						/// RANGE_TYPE_PERCENT
						/// </java-name>
						...
						public static RangeInfo Obtain(int type, float min, float max, float current) /* MethodBuilder.Create */ 
						{
								return default(RangeInfo);
						}

						/// <summary>
						///  <para>Gets the range type.</para> <para> <para>RANGE_TYPE_INT </para> <para>RANGE_TYPE_FLOAT </para> <para>RANGE_TYPE_PERCENT </para></para>        
						/// </summary>
						/// <returns>
						///  <para>The range type.</para>
						/// </returns>
						/// <java-name>
						/// getType
						/// </java-name>
						...
						/// <summary>
						///  <para>Gets the min value.</para> <para></para>        
						/// </summary>
						/// <returns>
						...
						/// <summary>
						///  <para>Gets the max value.</para> <para></para>        
						/// </summary>
						/// <returns>
 ...
 /* scope: __dot42__ */ 
    ...
    "eInfo;>;")]
				...
				/// <summary>
				///  <para>Find the virtual view, i.e. a descendant of the host View, that has the specified focus type.</para> <para> <para>AccessibilityNodeInfo::FOCUS_INPUT </para> <para>AccessibilityNodeInfo::FOCUS_ACCESSIBILITY </para></para>        
				/// </summary>
				/// <returns>
				///  <para>The node info of the focused view or null. </para>
				/// </returns>
 ...
 /* scope: __dot42__ */ 
    ...
    "essibilityRecord;", AccessFlags = 9)]
		...
		/// <summary>
		///  <para>Contains methods for accessing and monitoring preferred video captioning state and visual properties. </para> <para>To obtain a handle to the captioning manager, do the following: </para> <para> <code>  <pre>CaptioningManager captioningManager =
		///        (CaptioningManager) context.getSystemService(Context.CAPTIONING_SERVICE);</pre> </code> </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Adds a listener for changes in the user's preferred captioning enabled state and visual properties.</para> <para></para>        
				/// </summary>
				/// <java-name>
				...
				public virtual void AddCaptioningChangeListener(global::Android.Views.Accessibility.CaptioningManager.CaptioningChangeListener listener) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Removes a listener previously added using addCaptioningChangeListener.</para> <para></para>        
				/// </summary>
				/// <java-name>
				...
				public virtual void RemoveCaptioningChangeListener(global::Android.Views.Accessibility.CaptioningManager.CaptioningChangeListener listener) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </summary>
				/// <returns>
				///  <para>the user's preferred captioning enabled state </para>
				/// </returns>
				/// <java-name>
				/// isEnabled
				/// </java-name>
				...
				/// </summary>
				/// <returns>
				///  <para>the locale for the user's preferred captioning language, or null if not specified </para>
				/// </returns>
				/// <java-name>
				/// getLocale
				/// </java-name>
				...
				/// </summary>
				/// <returns>
				///  <para>the user's preferred font scaling factor for video captions, or 1 if not specified </para>
				/// </returns>
				/// <java-name>
				/// getFontScale
				/// </java-name>
				...
				/// </summary>
				/// <returns>
				///  <para>the user's preferred visual properties for captions as a CaptionStyle, or the default style if not specified </para>
				/// </returns>
				/// <java-name>
				/// getUserStyle
				/// </java-name>
				public virtual global::Android.Views.Accessibility.CaptioningManager.CaptionStyle UserStyle
				{
						[Dot42.DexImport("getUserStyle", "()Landroid/view/accessibility/CaptioningManager$CaptionStyle;", AccessFlags = 1)]
						get{ return default(global::Android.Views.Accessibility.CaptioningManager.CaptionStyle); }
				}

				/// <summary>
				///  <para>Listener for changes in captioning properties, including enabled state and user style preferences. </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>Called when the captioning enabled state changes.</para> <para></para>        
						/// </summary>
						/// <java-name>
						/// onEnabledChanged
						/// </java-name>
						[Dot42.DexImport("onEnabledChanged", "(Z)V", AccessFlags = 1)]
						public virtual void OnEnabledChanged(bool enabled) /* MethodBuilder.Create */ 
						{
						}

						/// <summary>
						///  <para>Called when the captioning user style changes.</para> <para> <para>CaptioningManager::getUserStyle() </para></para>        
						/// </summary>
						/// <java-name>
						/// onUserStyleChanged
						/// </java-name>
						[Dot42.DexImport("onUserStyleChanged", "(Landroid/view/accessibility/CaptioningManager$CaptionStyle;)V", AccessFlags = 1)]
						public virtual void OnUserStyleChanged(global::Android.Views.Accessibility.CaptioningManager.CaptionStyle userStyle) /* MethodBuilder.Create */ 
						{
						}

						/// <summary>
						///  <para>Called when the captioning locale changes.</para> <para> <para>CaptioningManager::getLocale() </para></para>        
						/// </summary>
						/// <java-name>
						/// onLocaleChanged
						/// </java-name>
						...
						/// <summary>
						///  <para>Called when the captioning font scaling factor changes.</para> <para> <para>CaptioningManager::getFontScale() </para></para>        
						/// </summary>
						/// <java-name>
						/// onFontScaleChanged
						/// </java-name>
						[Dot42.DexImport("onFontScaleChanged", "(F)V", AccessFlags = 1)]
						public virtual void OnFontScaleChanged(float fontScale) /* MethodBuilder.Create */ 
						{
						}
				...
				/// <summary>
				///  <para>Specifies visual properties for video captions, including foreground and background colors, edge properties, and typeface. </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						/// <summary>
						///  <para>Edge type value specifying no character edges. </para>        
						/// </summary>
						/// <java-name>
						/// EDGE_TYPE_NONE
						/// </java-name>
						...
						/// <summary>
						///  <para>Edge type value specifying uniformly outlined character edges. </para>        
						/// </summary>
						/// <java-name>
						/// EDGE_TYPE_OUTLINE
						/// </java-name>
						...
						/// <summary>
						///  <para>Edge type value specifying drop-shadowed character edges. </para>        
						/// </summary>
						/// <java-name>
						...
						/// <summary>
						///  <para>The preferred foreground color for video captions. </para>        
						/// </summary>
						/// <java-name>
						/// foregroundColor
						/// </java-name>
						...
						/// <summary>
						///  <para>The preferred background color for video captions. </para>        
						/// </summary>
						/// <java-name>
						/// backgroundColor
						/// </java-name>
						...
						/// <summary>
						///  <para>The preferred edge type for video captions, one of:  <ul> <li> <para>EDGE_TYPE_NONE </para></li> <li> <para>EDGE_TYPE_OUTLINE </para></li> <li> <para>EDGE_TYPE_DROP_SHADOW </para></li></ul></para>        
						/// </summary>
						/// <java-name>
						/// edgeType
						/// </java-name>
						...
						/// <summary>
						///  <para>The preferred edge color for video captions, if using an edge type other than EDGE_TYPE_NONE. </para>        
						/// </summary>
						/// <java-name>
						/// edgeColor
						/// </java-name>
						...
						/// </summary>
						/// <returns>
						///  <para>the preferred Typeface for video captions, or null if not specified </para>
						/// </returns>
						/// <java-name>
						/// getTypeface
						/// </java-name>
