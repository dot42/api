...
namespace Org.Json
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Creates a new <c>JSONArray </c> by copying all values from the given collection.</para> <para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/util/Collection;)V", AccessFlags = 1)]
				public JSONArray(global::Java.Util.ICollection<object> copyFrom) /* MethodBuilder.Create */ 
				{
				}
				...
				public JSONArray(global::Org.Json.JSONTokener copyFrom) /* MethodBuilder.Create */ 
				{
				}
				...
				public JSONArray(string copyFrom) /* MethodBuilder.Create */ 
				{
				}
				...
				public JSONArray(object copyFrom) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				///  <para>Removes and returns the value at <c>index </c> , or null if the array has no value at <c>index </c> . </para>        
				/// </summary>
				/// <java-name>
				/// remove
				/// </java-name>
				[Dot42.DexImport("remove", "(I)Ljava/lang/Object;", AccessFlags = 1)]
				public virtual object Remove(int index) /* MethodBuilder.Create */ 
				{
						return default(object);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Creates a new <c>JSONObject </c> by copying all name/value mappings from the given map.</para> <para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/util/Map;)V", AccessFlags = 1)]
				public JSONObject(global::Java.Util.IMap<object, object> copyFrom) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </summary>
				[Dot42.DexImport("<init>", "(Lorg/json/JSONTokener;)V", AccessFlags = 1)]
				public JSONObject(global::Org.Json.JSONTokener copyFrom) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public JSONObject(string copyFrom) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				///  <para>Wraps the given object if necessary.</para> <para>If the object is null or , returns NULL. If the object is a <c>JSONArray </c> or <c>JSONObject </c> , no wrapping is necessary. If the object is <c>NULL </c> , no wrapping is necessary. If the object is an array or <c>Collection </c> , returns an equivalent <c>JSONArray </c> . If the object is a <c>Map </c> , returns an equivalent <c>JSONObject </c> . If the object is a primitive wrapper type or <c>String </c> , returns the object. Otherwise if the object is from a <c>java </c> package, returns the result of <c>toString </c> . If wrapping fails, returns null. </para>        
				/// </summary>
				/// <java-name>
				/// wrap
				/// </java-name>
				[Dot42.DexImport("wrap", "(Ljava/lang/Object;)Ljava/lang/Object;", AccessFlags = 9)]
				public static object Wrap(object o) /* MethodBuilder.Create */ 
				{
						return default(object);
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>Parses a JSON () encoded string into the corresponding object. Most clients of this class will use only need the ructor and nextValue method. Example usage:  <pre>
		/// String json = "{"
		///         + "  \"query": "Pizza", "
		///         + "  "locations": [ 94043, 90210 ] "
		///         + "}";</pre></para> <para> <pre>JSONObject object = (JSONObject) new JSONTokener(json).nextValue();
