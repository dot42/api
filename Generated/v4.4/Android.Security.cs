 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns the key type (e.g., "RSA", "DSA", "EC") specified by this parameter. </para>        
				/// </summary>
				/// <java-name>
				/// getKeyType
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the key size specified by this parameter. For instance, for RSA this will return the modulus size and for EC it will return the field size. </para>        
				/// </summary>
				/// <java-name>
				/// getKeySize
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the AlgorithmParameterSpec that will be used for creation of the key pair. </para>        
				/// </summary>
				/// <java-name>
				...
				/// end.add(1, Calendar.YEAR);</pre></para> <para> <pre>KeyPairGeneratorSpec spec =
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>Sets the key type (e.g., RSA, DSA, EC) of the keypair to be created. </para>        
						/// </summary>
						/// <java-name>
						/// setKeyType
						/// </java-name>
						[Dot42.DexImport("setKeyType", "(Ljava/lang/String;)Landroid/security/KeyPairGeneratorSpec$Builder;", AccessFlags = 1)]
						public Builder SetKeyType(string keyType) /* MethodBuilder.Create */ 
						{
								return default(Builder);
						}

						/// <summary>
						///  <para>Sets the key size for the keypair to be created. For instance, for a key type of RSA this will set the modulus size and for a key type of EC it will select a curve with a matching field size. </para>        
						/// </summary>
						/// <java-name>
						/// setKeySize
						/// </java-name>
						[Dot42.DexImport("setKeySize", "(I)Landroid/security/KeyPairGeneratorSpec$Builder;", AccessFlags = 1)]
						public Builder SetKeySize(int keySize) /* MethodBuilder.Create */ 
						{
								return default(Builder);
						}

						/// <summary>
						///  <para>Sets the underlying key type's parameters. This is required for DSA where you must set this to an instance of java.security.spec.DSAParameterSpec. </para>        
						/// </summary>
						/// <java-name>
    ...
    "ec$Builder;", AccessFlags = 1)]
						public Builder SetAlgorithmParameterSpec(global::Java.Security.Spec.IAlgorithmParameterSpec spec) /* MethodBuilder.Create */ 
						{
								return default(Builder);
						}
