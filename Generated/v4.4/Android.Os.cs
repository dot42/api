...
namespace Android.OS
{
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>Android 4.4: KitKat, another tasty treat.</para> <para>Applications targeting this or a later release will get these new changes in behavior:</para> <para> <ul> <li> <para>The default result of {android.preference.PreferenceActivity::isValidFragment PreferenceActivity.isValueFragment} becomes false instead of true. </para></li> <li> <para>In android.webkit.WebView, apps targeting earlier versions will have JS URLs evaluated directly and any result of the evaluation will not replace the current page content. Apps targetting KITKAT or later that load a JS URL will have the result of that URL replace the content of the current page </para></li> <li> <para>AlarmManager.set becomes interpreted as an inexact value, to give the system more flexibility in scheduling alarms. </para></li> <li> <para>Context.getSharedPreferences no longer allows a null name. </para></li> <li> <para>android.widget.RelativeLayout changes to compute wrapped content margins correctly. </para></li> <li> <para>android.app.ActionBar's window content overlay is allowed to be drawn. </para></li> <li> <para>The android.Manifest.permission#READ_EXTERNAL_STORAGE permission is now always enforced. </para></li> <li> <para>Access to package-specific external storage directories belonging to the calling app no longer requires the android.Manifest.permission#READ_EXTERNAL_STORAGE or android.Manifest.permission#WRITE_EXTERNAL_STORAGE permissions. </para></li></ul></para>        
						/// </summary>
						/// <java-name>
						/// KITKAT
						/// </java-name>
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// </java-name>
						public virtual int TotalSwappablePss
						{
						...
						/// <summary>
						///  <para>Return total shared clean memory usage in kB. </para>        
						/// </summary>
						/// <java-name>
						/// getTotalPrivateClean
						/// </java-name>
						public virtual int TotalPrivateClean
						{
						...
						/// getTotalSharedClean
						/// </java-name>
						public virtual int TotalSharedClean
						{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Standard directory in which to place documents that have been created by the user. </para>        
				/// </summary>
				/// <java-name>
				/// DIRECTORY_DOCUMENTS
				/// </java-name>
				...
				/// <summary>
				///  <para>Unknown storage state, such as when a path isn't backed by known storage media.</para> <para> <para>getStorageState(File) </para></para>        
				/// </summary>
				/// <java-name>
				/// MEDIA_UNKNOWN
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the current state of the storage device that provides the given path.</para> <para></para>        
				/// </summary>
				/// <returns>
				...
				public static string GetStorageState(global::Java.IO.File path) /* MethodBuilder.Create */ 
				{
						return default(string);
				}
 ...
 /* scope: __dot42__ */ 
    ...
    "ner;)Landroid/os/ParcelFileDescriptor;", AccessFlags = 9)]
				public static global::Android.OS.ParcelFileDescriptor Open(global::Java.IO.File file, int mode, global::Android.OS.Handler handler, global::Android.OS.ParcelFileDescriptor.IOnCloseListener listener) /* MethodBuilder.Create */ 
				{
						return default(global::Android.OS.ParcelFileDescriptor);
				}
				...
				/// <summary>
				///  <para>Create two ParcelFileDescriptors structured as a data pipe. The first ParcelFileDescriptor in the returned array is the read side; the second is the write side. </para> <para>The write end has the ability to deliver an error message through closeWithError(String) which can be handled by the read end calling checkError(), usually after detecting an EOF. This can also be used to detect remote crashes. </para>        
				/// </summary>
				/// <java-name>
				/// createReliablePipe
				/// </java-name>
				...
				/// <summary>
				///  <para>Create two ParcelFileDescriptors structured as a pair of sockets connected to each other. The two sockets are indistinguishable. </para>        
				/// </summary>
				/// <java-name>
				/// createSocketPair
				/// </java-name>
				...
				/// <summary>
				///  <para>Create two ParcelFileDescriptors structured as a pair of sockets connected to each other. The two sockets are indistinguishable. </para> <para>Both ends have the ability to deliver an error message through closeWithError(String) which can be detected by the other end calling checkError(), usually after detecting an EOF. This can also be used to detect remote crashes. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Converts a string representing a file mode, such as "rw", into a bitmask suitable for use with open. </para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>A bitmask representing the given file mode. </para>
				/// </returns>
				/// <java-name>
				/// parseMode
				/// </java-name>
				[Dot42.DexImport("parseMode", "(Ljava/lang/String;)I", AccessFlags = 9)]
				public static int ParseMode(string mode) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// <summary>
				///  <para>Close the ParcelFileDescriptor, informing any peer that an error occurred while processing. If the creator of this descriptor is not observing errors, it will close normally.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// closeWithError
				/// </java-name>
				[Dot42.DexImport("closeWithError", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public virtual void CloseWithError(string msg) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Detect and throw if the other end of a pipe or socket pair encountered an error or crashed. This allows a reader to distinguish between a valid EOF and an error/crash. </para> <para>If this ParcelFileDescriptor is unable to detect remote errors, it will return silently.</para> <para> <para>canDetectErrors() </para></para>        
				/// </summary>
				/// <java-name>
				/// checkError
				/// </java-name>
				...
				/// <summary>
				///  <para>Indicates if this ParcelFileDescriptor can communicate and detect remote errors/crashes.</para> <para> <para>checkError() </para></para>        
				/// </summary>
				/// <java-name>
				/// canDetectErrors
				/// </java-name>
				public virtual bool CanDetectErrors
				{
				...
				/// <summary>
				///  <para>Exception that indicates that the file descriptor was detached. </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				...
				/// <summary>
				///  <para>Callback indicating that a ParcelFileDescriptor has been closed. </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						/// <summary>
						///  <para>Event indicating the ParcelFileDescriptor to which this listener was attached has been closed.</para> <para></para>        
						/// </summary>
						/// <java-name>
						/// onClose
						/// </java-name>
						[Dot42.DexImport("onClose", "(Ljava/io/IOException;)V", AccessFlags = 1025)]
						void OnClose(global::System.IO.IOException e) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </java-name>
				public virtual int RegisteredCallbackCount
				{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// getBlockSizeLong
				/// </java-name>
				public virtual long BlockSizeLong
				{
				...
				/// getBlockCountLong
				/// </java-name>
				public virtual long BlockCountLong
				{
				...
				/// getFreeBlocksLong
				/// </java-name>
				public virtual long FreeBlocksLong
				{
				...
				/// </java-name>
				public virtual long AvailableBlocksLong
				{
				...
				/// getAvailableBytes
				/// </java-name>
				public virtual long AvailableBytes
				{
 ...
 /* scope: __dot42__ */ 
		{
				...
				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				protected internal UserHandle() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>Key for user restrictions. Specifies if a user is disallowed from adding and removing accounts. The default value is  <code>false</code>. </para> <para>Type: Boolean  <para>setUserRestrictions(Bundle) </para> <para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Key for user restrictions. Specifies if a user is disallowed from changing Wi-Fi access points. The default value is  <code>false</code>. </para> <para>Type: Boolean  <para>setUserRestrictions(Bundle) </para> <para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Key for user restrictions. Specifies if a user is disallowed from installing applications. The default value is  <code>false</code>. </para> <para>Type: Boolean  <para>setUserRestrictions(Bundle) </para> <para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Key for user restrictions. Specifies if a user is disallowed from uninstalling applications. The default value is  <code>false</code>. </para> <para>Type: Boolean  <para>setUserRestrictions(Bundle) </para> <para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Key for user restrictions. Specifies if a user is disallowed from toggling location sharing. The default value is  <code>false</code>. </para> <para>Type: Boolean  <para>setUserRestrictions(Bundle) </para> <para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Key for user restrictions. Specifies if a user is disallowed from enabling the "Unknown Sources" setting, that allows installation of apps from unknown sources. The default value is  <code>false</code>. </para> <para>Type: Boolean  <para>setUserRestrictions(Bundle) </para> <para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Key for user restrictions. Specifies if a user is disallowed from configuring bluetooth. The default value is  <code>false</code>. </para> <para>Type: Boolean  <para>setUserRestrictions(Bundle) </para> <para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Key for user restrictions. Specifies if a user is disallowed from transferring files over USB. The default value is  <code>false</code>. </para> <para>Type: Boolean  <para>setUserRestrictions(Bundle) </para> <para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Key for user restrictions. Specifies if a user is disallowed from configuring user credentials. The default value is  <code>false</code>. </para> <para>Type: Boolean  <para>setUserRestrictions(Bundle) </para> <para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Key for user restrictions. Specifies if a user is disallowed from removing users. The default value is  <code>false</code>. </para> <para>Type: Boolean  <para>setUserRestrictions(Bundle) </para> <para>getUserRestrictions() </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Sets a new challenge PIN for restrictions. This is only for use by pre-installed apps and requires the MANAGE_USERS permission. </para>        
				/// </summary>
				/// <returns>
				///  <para>Returns true if the challenge PIN was set successfully. </para>
				/// </returns>
				/// <java-name>
				/// setRestrictionsChallenge
				/// </java-name>
				[Dot42.DexImport("setRestrictionsChallenge", "(Ljava/lang/String;)Z", AccessFlags = 1)]
				public virtual bool SetRestrictionsChallenge(string newPin) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// isUserAGoat
				/// </java-name>
				public virtual bool IsUserAGoat
				{
				...
				/// getUserRestrictions
				/// </java-name>
				public virtual global::Android.OS.Bundle UserRestrictions
				{
