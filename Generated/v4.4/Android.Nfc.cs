...
namespace Android.Nfc
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Flag for use with enableReaderMode(Activity, ReaderCallback, int, Bundle). </para> <para>Setting this flag enables polling for Nfc-A technology. </para>        
				/// </summary>
				/// <java-name>
				/// FLAG_READER_NFC_A
				/// </java-name>
				...
				/// <summary>
				///  <para>Flag for use with enableReaderMode(Activity, ReaderCallback, int, Bundle). </para> <para>Setting this flag enables polling for Nfc-B technology. </para>        
				/// </summary>
				/// <java-name>
				/// FLAG_READER_NFC_B
				/// </java-name>
				...
				/// <summary>
				///  <para>Flag for use with enableReaderMode(Activity, ReaderCallback, int, Bundle). </para> <para>Setting this flag enables polling for Nfc-F technology. </para>        
				/// </summary>
				/// <java-name>
				/// FLAG_READER_NFC_F
				/// </java-name>
				...
				/// <summary>
				///  <para>Flag for use with enableReaderMode(Activity, ReaderCallback, int, Bundle). </para> <para>Setting this flag enables polling for Nfc-V (ISO15693) technology. </para>        
				/// </summary>
				/// <java-name>
				/// FLAG_READER_NFC_V
				/// </java-name>
				...
				/// <summary>
				///  <para>Flag for use with enableReaderMode(Activity, ReaderCallback, int, Bundle). </para> <para>Setting this flag enables polling for NfcBarcode technology. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Flag for use with enableReaderMode(Activity, ReaderCallback, int, Bundle). </para> <para>Setting this flag allows the caller to prevent the platform from performing an NDEF check on the tags it finds. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Flag for use with enableReaderMode(Activity, ReaderCallback, int, Bundle). </para> <para>Setting this flag allows the caller to prevent the platform from playing sounds when it discovers a tag. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Int Extra for use with enableReaderMode(Activity, ReaderCallback, int, Bundle). </para> <para>Setting this integer extra allows the calling application to specify the delay that the platform will use for performing presence checks on any discovered tag. </para>        
				/// </summary>
				/// <java-name>
    ...
    "[[Ljava/lang/String;)V", AccessFlags = 1)]
				...
				/// <summary>
				///  <para>Limit the NFC controller to reader mode while this Activity is in the foreground.</para> <para>In this mode the NFC controller will only act as an NFC tag reader/writer, thus disabling any peer-to-peer (Android Beam) and card-emulation modes of the NFC adapter on this device.</para> <para>Use FLAG_READER_SKIP_NDEF_CHECK to prevent the platform from performing any NDEF checks in reader mode. Note that this will prevent the Ndef tag technology from being enumerated on the tag, and that NDEF-based tag dispatch will not be functional.</para> <para>For interacting with tags that are emulated on another Android device using Android's host-based card-emulation, the recommended flags are FLAG_READER_NFC_A and FLAG_READER_SKIP_NDEF_CHECK.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// enableReaderMode
				/// </java-name>
    ...
    ";)V", AccessFlags = 1)]
				public void EnableReaderMode(global::Android.App.Activity activity, global::Android.Nfc.NfcAdapter.IReaderCallback callback, int flags, global::Android.OS.Bundle extras) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Restore the NFC adapter to normal mode of operation: supporting peer-to-peer (Android Beam), card emulation, and polling for all supported tag technologies.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// disableReaderMode
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
				...
				/// <summary>
				///  <para>A callback to be invoked when the system finds a tag while the foreground activity is operating in reader mode. </para> <para>Register your <c>ReaderCallback </c> implementation with NfcAdapter#enableReaderMode and disable it with NfcAdapter#disableReaderMode.  <para>NfcAdapter::enableReaderMode </para></para>    
				/// </summary>
				/// <java-name>
