...
namespace Android.Content.Res
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				public AssetFileDescriptor(global::Android.OS.ParcelFileDescriptor fd, long startOffset, long length, global::Android.OS.Bundle extras) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				///  <para>Returns any additional details that can be used to interpret the underlying file descriptor. May be null. </para>        
				/// </summary>
				/// <java-name>
				/// getExtras
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				public int Mnc;
				/// <summary>
				///  <para>Constant used to to represent MNC (Mobile Network Code) zero. 0 cannot be used, since it is used to represent an undefined MNC. </para>        
				/// </summary>
				/// <java-name>
				/// MNC_ZERO
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "res/Configuration;)V", AccessFlags = 1)]
				...
				public virtual global::Android.Graphics.Drawables.Drawable GetDrawableForDensity(int id, int density) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Graphics.Drawables.Drawable);
				}
