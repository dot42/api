 ...
 /* scope: __dot42__ */ 
		{
				...
				/// getPhase2Method
				/// </java-name>
				public virtual int Phase2Method
				{
				...
				/// </java-name>
				public virtual string AnonymousIdentity
				{
				...
				/// getCaCertificate
				/// </java-name>
				public virtual global::Java.Security.Cert.X509Certificate CaCertificate
				{
				...
				/// </java-name>
				public virtual global::Java.Security.Cert.X509Certificate ClientCertificate
				{
				...
				/// getSubjectMatch
				/// </java-name>
				public virtual string SubjectMatch
				{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Enable/Disable TDLS on a specific local route.</para> <para>TDLS enables two wireless endpoints to talk to each other directly without going through the access point that is managing the local network. It saves bandwidth and improves quality of the link. </para> <para>This API enables/disables the option of using TDLS. If enabled, the underlying hardware is free to use TDLS or a hop through the access point. If disabled, existing TDLS session is torn down and hardware is restricted to use access point for transferring wireless packets. Default value for all routes is 'disabled', meaning restricted to use access point for transferring packets. </para> <para></para>        
				/// </summary>
				/// <java-name>
				/// setTdlsEnabled
				/// </java-name>
				[Dot42.DexImport("setTdlsEnabled", "(Ljava/net/InetAddress;Z)V", AccessFlags = 1)]
				public virtual void SetTdlsEnabled(global::Java.Net.InetAddress remoteIPAddress, bool enable) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Similar to setTdlsEnabled(InetAddress, boolean), except this version allows you to specify remote endpoint with a MAC address. </para>        
				/// </summary>
				/// <java-name>
				/// setTdlsEnabledWithMacAddress
				/// </java-name>
				[Dot42.DexImport("setTdlsEnabledWithMacAddress", "(Ljava/lang/String;Z)V", AccessFlags = 1)]
				public virtual void SetTdlsEnabledWithMacAddress(string remoteMacAddress, bool enable) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				public virtual bool IsScanAlwaysAvailable
				{
