 ...
 /* scope: __dot42__ */ 
		{
				...
				public global::Android.Telephony.CellIdentityWcdma CellIdentity
				{
						...
						get{ return default(global::Android.Telephony.CellIdentityWcdma); }
				}
				...
				public global::Android.Telephony.CellSignalStrengthWcdma CellSignalStrength
				{
						...
						get{ return default(global::Android.Telephony.CellSignalStrengthWcdma); }
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>The Phone app sends this intent when a user opts to respond-via-message during an incoming call. By default, the device's default SMS app consumes this message and sends a text message to the caller. A third party app can also provide this functionality by consuming this Intent with a android.app.Service and sending the message using its own messaging system. </para> <para>The intent contains a URI (available from android.content.Intent#getData) describing the recipient, using either the <c>sms: </c> , <c>smsto: </c> , <c>mms: </c> , or <c>mmsto: </c> URI schema. Each of these URI schema carry the recipient information the same way: the path part of the URI contains the recipient's phone number or a comma-separated set of phone numbers if there are multiple recipients. For example, <c>smsto:2065551234 </c> .</para> <para>The intent may also contain extras for the message text (in android.content.Intent#EXTRA_TEXT) and a message subject (in android.content.Intent#EXTRA_SUBJECT).</para> <para> <b>Note:</b> The intent-filter that consumes this Intent needs to be in a android.app.Service that requires the permission android.Manifest.permission#SEND_RESPOND_VIA_MESSAGE.</para> <para>For example, the service that receives this intent can be declared in the manifest file with an intent filter like this:</para> <para> <pre>
				...
				///   &lt;/intent-filter&gt;
				/// &lt;/service&gt;</pre> </para> <para>Output: nothing. </para>        
				/// </summary>
				/// <java-name>
				...
				/// getGroupIdLevel1
				/// </java-name>
				public virtual string GroupIdLevel1
				{
				...
				/// <summary>
				///  <para>Returns the MMS user agent. </para>        
				/// </summary>
				/// <java-name>
				/// getMmsUserAgent
				/// </java-name>
				public virtual string MmsUserAgent
				{
				...
				/// <summary>
				///  <para>Returns the MMS user agent profile URL. </para>        
				/// </summary>
				/// <java-name>
				/// getMmsUAProfUrl
				/// </java-name>
				public virtual string MmsUAProfUrl
				{
