 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Return the logo resource identifier to use for this component. If the component defines a logo, that is used; else, the application logo is used.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>The logo associated with this component. </para>
				/// </returns>
				/// <java-name>
				/// getLogoResource
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Feature for getSystemAvailableFeatures and hasSystemFeature: The device is capable of communicating with consumer IR devices. </para>        
				/// </summary>
				/// <java-name>
				/// FEATURE_CONSUMER_IR
				/// </java-name>
				...
				/// <summary>
				///  <para>Feature for getSystemAvailableFeatures and hasSystemFeature: The device supports host- based NFC card emulation. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Feature for getSystemAvailableFeatures and hasSystemFeature: The device includes a hardware step counter. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Feature for getSystemAvailableFeatures and hasSystemFeature: The device includes a hardware step detector. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Feature for getSystemAvailableFeatures and hasSystemFeature: The device supports device policy enforcement via device admins. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Return a List of all installed packages that are currently holding any of the given permissions.</para> <para> <para>GET_ACTIVITIES </para> <para>GET_GIDS </para> <para>GET_CONFIGURATIONS </para> <para>GET_INSTRUMENTATION </para> <para>GET_PERMISSIONS </para> <para>GET_PROVIDERS </para> <para>GET_RECEIVERS </para> <para>GET_SERVICES </para> <para>GET_SIGNATURES </para> <para>GET_UNINSTALLED_PACKAGES </para></para>        
				/// </summary>
				/// <returns>
    ...
    "I)Ljava/util/List<Landroid/content/pm/ResolveInfo;>;")]
				...
				/// <summary>
				///  <para>Retrieve all providers that can match the given intent.</para> <para> <para>GET_INTENT_FILTERS </para> <para>GET_RESOLVED_FILTER </para></para>        
				/// </summary>
				/// <returns>
				///  <para>A List&lt;ResolveInfo&gt; containing one entry for each matching ProviderInfo. These are ordered from best to worst match. If there are no matching providers, an empty list is returned. </para>
				/// </returns>
				/// <java-name>
				...
				public abstract global::Java.Util.IList<global::Android.Content.PM.ResolveInfo> QueryIntentContentProviders(global::Android.Content.Intent intent, int flags) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>The provider that corresponds to this resolution match, if this resolution is for a provider. Exactly one of activityInfo, serviceInfo, or providerInfo will be non-null. </para>        
				/// </summary>
				/// <java-name>
				/// providerInfo
				/// </java-name>
				...
				public ResolveInfo(global::Android.Content.PM.ResolveInfo source) /* MethodBuilder.Create */ 
				{
				}
