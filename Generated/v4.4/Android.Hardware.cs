...
namespace Android.Hardware
{
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>Sets the minimum and maximum preview fps. This controls the rate of preview frames received in PreviewCallback. The minimum and maximum preview fps must be one of the elements from getSupportedPreviewFpsRange.</para> <para> <para>setPreviewCallbackWithBuffer(Camera.PreviewCallback) </para> <para>getSupportedPreviewFpsRange() </para></para>        
						/// </summary>
						/// <java-name>
						/// setPreviewFpsRange
						/// </java-name>
						...
						/// <summary>
						///  <para>Returns the current minimum and maximum preview fps. The values are one of the elements returned by getSupportedPreviewFpsRange.</para> <para> <para>PREVIEW_FPS_MIN_INDEX </para> <para>PREVIEW_FPS_MAX_INDEX </para> <para>getSupportedPreviewFpsRange() </para></para>        
						/// </summary>
						/// <returns>
						...
						/// }
						/// </pre></para> <para> <para>android.view.OrientationEventListener </para> <para>getCameraInfo(int, CameraInfo) </para></para>        
						/// </summary>
						/// <java-name>
						/// setRotation
						/// </java-name>
						...
						/// <summary>
						///  <para>Returns the image format for preview frames got from PreviewCallback.</para> <para> <para>android.graphics.ImageFormat </para> <para>setPreviewFormat </para></para>        
						/// </summary>
						/// <returns>
						...
						/// <summary>
						///  <para>Gets the supported preview formats. android.graphics.ImageFormat#NV21 is always supported. android.graphics.ImageFormat#YV12 is always supported since API level 12.</para> <para> <para>android.graphics.ImageFormat </para> <para>setPreviewFormat </para></para>        
						/// </summary>
						/// <returns>
						...
						/// <summary>
						///  <para>Gets the current white balance setting.</para> <para> <para>WHITE_BALANCE_AUTO </para> <para>WHITE_BALANCE_INCANDESCENT </para> <para>WHITE_BALANCE_FLUORESCENT </para> <para>WHITE_BALANCE_WARM_FLUORESCENT </para> <para>WHITE_BALANCE_DAYLIGHT </para> <para>WHITE_BALANCE_CLOUDY_DAYLIGHT </para> <para>WHITE_BALANCE_TWILIGHT </para> <para>WHITE_BALANCE_SHADE </para></para>        
						/// </summary>
						/// <returns>
						...
						/// <summary>
						///  <para>Gets the current color effect setting.</para> <para> <para>EFFECT_NONE </para> <para>EFFECT_MONO </para> <para>EFFECT_NEGATIVE </para> <para>EFFECT_SOLARIZE </para> <para>EFFECT_SEPIA </para> <para>EFFECT_POSTERIZE </para> <para>EFFECT_WHITEBOARD </para> <para>EFFECT_BLACKBOARD </para> <para>EFFECT_AQUA </para></para>        
						/// </summary>
						/// <returns>
						...
						/// <summary>
						///  <para>Gets the current antibanding setting.</para> <para> <para>ANTIBANDING_AUTO </para> <para>ANTIBANDING_50HZ </para> <para>ANTIBANDING_60HZ </para> <para>ANTIBANDING_OFF </para></para>        
						/// </summary>
						/// <returns>
						...
						/// <summary>
						///  <para>Gets the current scene mode setting.</para> <para> <para>SCENE_MODE_AUTO </para> <para>SCENE_MODE_ACTION </para> <para>SCENE_MODE_PORTRAIT </para> <para>SCENE_MODE_LANDSCAPE </para> <para>SCENE_MODE_NIGHT </para> <para>SCENE_MODE_NIGHT_PORTRAIT </para> <para>SCENE_MODE_THEATRE </para> <para>SCENE_MODE_BEACH </para> <para>SCENE_MODE_SNOW </para> <para>SCENE_MODE_SUNSET </para> <para>SCENE_MODE_STEADYPHOTO </para> <para>SCENE_MODE_FIREWORKS </para> <para>SCENE_MODE_SPORTS </para> <para>SCENE_MODE_PARTY </para> <para>SCENE_MODE_CANDLELIGHT </para> <para>SCENE_MODE_BARCODE </para></para>        
						/// </summary>
						/// <returns>
						...
						/// <summary>
						///  <para>Gets the current flash mode setting.</para> <para> <para>FLASH_MODE_OFF </para> <para>FLASH_MODE_AUTO </para> <para>FLASH_MODE_ON </para> <para>FLASH_MODE_RED_EYE </para> <para>FLASH_MODE_TORCH </para></para>        
						/// </summary>
						/// <returns>
						...
						/// <summary>
						///  <para>Gets the current focus mode setting.</para> <para> <para>FOCUS_MODE_AUTO </para> <para>FOCUS_MODE_INFINITY </para> <para>FOCUS_MODE_MACRO </para> <para>FOCUS_MODE_FIXED </para> <para>FOCUS_MODE_EDOF </para> <para>FOCUS_MODE_CONTINUOUS_VIDEO </para></para>        
						/// </summary>
						/// <returns>
						...
						/// <summary>
						///  <para>Get the current state of video stabilization. See setVideoStabilization for details of video stabilization.</para> <para> <para>isVideoStabilizationSupported() </para> <para>setVideoStabilization(boolean) </para></para>        
						/// </summary>
						/// <returns>
						...
						/// <summary>
						///  <para>Returns true if video stabilization is supported. See setVideoStabilization for details of video stabilization.</para> <para> <para>setVideoStabilization(boolean) </para> <para>getVideoStabilization() </para></para>        
						/// </summary>
						/// <returns>
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>Weight of the area. The weight must range from 1 to 1000, and represents a weight for every pixel in the area. This means that a large metering area with the same weight as a smaller area will have more effect in the metering result. Metering areas can overlap and the driver will add the weights in the overlap region.</para> <para> <para>Parameters::getFocusAreas() </para> <para>Parameters::getMeteringAreas() </para></para>        
						/// </summary>
						/// <java-name>
						/// weight
						/// </java-name>
 ...
 /* scope: __dot42__ */ 
				{
						...
						public global::Android.Graphics.Rect Rect;
						/// <summary>
						///  <para>The confidence level for the detection of the face. The range is 1 to 100. 100 is the highest confidence.</para> <para>Depending on the device, even very low-confidence faces may be listed, so applications should filter out faces with low confidence, depending on the use case. For a typical point-and-shoot camera application that wishes to display rectangles around detected faces, filtering out faces with confidence less than 50 is recommended.</para> <para> <para>startFaceDetection() </para></para>        
						/// </summary>
						/// <java-name>
						/// score
						/// </java-name>
 ...
 /* scope: __dot42__ */ 
				...
				/// <summary>
				///  <para>Callback interface for zoom changes during a smooth zoom operation.</para> <para> <para>setZoomChangeListener(OnZoomChangeListener) </para> <para>startSmoothZoom(int) </para></para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						/// <summary>
						///  <para>Called when the camera auto focus completes. If the camera does not support auto-focus and autoFocus is called, onAutoFocus will be called immediately with a fake value of  <code>success</code> set to  <code>true</code>.</para> <para>The auto-focus routine does not lock auto-exposure and auto-white balance after it completes.</para> <para> <para>android.hardware.Camera.Parameters::setAutoExposureLock(boolean) </para> <para>android.hardware.Camera.Parameters::setAutoWhiteBalanceLock(boolean) </para></para>        
						/// </summary>
						/// <java-name>
						/// onAutoFocus
						/// </java-name>
				...
				/// <summary>
				///  <para>Callback interface used to deliver copies of preview frames as they are displayed.</para> <para> <para>setPreviewCallback(Camera.PreviewCallback) </para> <para>setOneShotPreviewCallback(Camera.PreviewCallback) </para> <para>setPreviewCallbackWithBuffer(Camera.PreviewCallback) </para> <para>startPreview() </para></para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						...
						public int Facing;
						/// <summary>
						///  <para>The orientation of the camera image. The value is the angle that the camera image needs to be rotated clockwise so it shows correctly on the display in its natural orientation. It should be 0, 90, 180, or 270.</para> <para>For example, suppose a device has a naturally tall screen. The back-facing camera sensor is mounted in landscape. You are looking at the screen. If the top side of the camera sensor is aligned with the right edge of the screen in natural orientation, the value should be 90. If the top side of a front-facing camera sensor is aligned with the right of the screen, the value should be 270.</para> <para> <para>setDisplayOrientation(int) </para> <para>Parameters::setRotation(int) </para> <para>Parameters::setPreviewSize(int, int) </para> <para>Parameters::setPictureSize(int, int) </para> <para>Parameters::setJpegThumbnailSize(int, int) </para></para>        
						/// </summary>
						/// <java-name>
						/// orientation
						/// </java-name>
		...
		/// <summary>
		///  <para>Class that operates consumer infrared on the device.</para> <para>To obtain an instance of the system infrared transmitter, call Context.getSystemService() with android.content.Context#CONSUMER_IR_SERVICE as the argument. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Tansmit and infrared pattern </para> <para>This method is synchronous; when it returns the pattern has been transmitted. Only patterns shorter than 2 seconds will be transmitted. </para> <para></para>        
				/// </summary>
				/// <java-name>
				/// transmit
				/// </java-name>
				[Dot42.DexImport("transmit", "(I[I)V", AccessFlags = 1)]
				public void Transmit(int carrierFrequency, int[] pattern) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Check whether the device has an infrared emitter.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>true if the device has an infrared emitter, else false. </para>
				/// </returns>
				/// <java-name>
				/// hasIrEmitter
				/// </java-name>
				...
				/// <summary>
				///  <para>Query the infrared transmitter's supported carrier frequencies</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>an array of android.hardware.ConsumerIrManager.CarrierFrequencyRange objects representing the ranges that the transmitter can support, or null if there was an error communicating with the Consumer IR Service. </para>
				/// </returns>
				/// <java-name>
				...
				public global::Android.Hardware.ConsumerIrManager.CarrierFrequencyRange[] CarrierFrequencies
				{
						...
						get{ return default(global::Android.Hardware.ConsumerIrManager.CarrierFrequencyRange[]); }
				}

				/// <summary>
				///  <para>Represents a range of carrier frequencies (inclusive) on which the infrared transmitter can transmit </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						...
						[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
						protected internal CarrierFrequencyRange() /* TypeBuilder.AddDefaultConstructor */ 
						{
						}

						/// <summary>
						///  <para>Get the minimum (inclusive) frequency in this range segment. </para>        
						/// </summary>
						/// <java-name>
						/// getMinFrequency
						/// </java-name>
						...
						/// <summary>
						///  <para>Get the maximum (inclusive) frequency in this range segment. </para>        
						/// </summary>
						/// <java-name>
						/// getMaxFrequency
						/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>Called after flush() is completed. This flush() could have been initiated by this application or some other application. All the events in the batch at the point when the flush was called have been delivered to the applications registered for those sensor events. </para> <para> <para>android.hardware.SensorManager::flush(SensorEventListener) </para></para>        
				/// </summary>
				/// <java-name>
				/// onFlushCompleted
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>Class representing a sensor. Use SensorManager#getSensorList to get the list of available Sensors.</para> <para> <para>SensorManager </para> <para>SensorEventListener </para> <para>SensorEvent </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>A constant describing a step detector sensor. </para> <para>A sensor of this type triggers an event each time a step is taken by the user. The only allowed value to return is 1.0 and an event is generated for each step. Like with any other event, the timestamp indicates when the event (here the step) occurred, this corresponds to when the foot hit the ground, generating a high variation in acceleration. </para> <para>See SensorEvent.values for more details. </para>        
				/// </summary>
				/// <java-name>
				/// TYPE_STEP_DETECTOR
				/// </java-name>
				...
				/// <summary>
				///  <para>A constant describing a step counter sensor. </para> <para>A sensor of this type returns the number of steps taken by the user since the last reboot while activated. The value is returned as a float (with the fractional part set to zero) and is reset to zero only on a system reboot. The timestamp of the event is set to the time when the first step for that event was taken. This sensor is implemented in hardware and is expected to be low power. </para> <para>See SensorEvent.values for more details. </para>        
				/// </summary>
				/// <java-name>
				/// TYPE_STEP_COUNTER
				/// </java-name>
				...
				/// <summary>
				///  <para>A constant describing the geo-magnetic rotation vector. </para> <para>Similar to TYPE_ROTATION_VECTOR, but using a magnetometer instead of using a gyroscope. This sensor uses lower power than the other rotation vectors, because it doesn't use the gyroscope. However, it is more noisy and will work best outdoors. </para> <para>See SensorEvent.values for more details. </para>        
				/// </summary>
				/// <java-name>
				...
				/// </summary>
				/// <returns>
				///  <para>Number of events reserved for this sensor in the batch mode FIFO. This gives a guarantee on the minimum number of events that can be batched. </para>
				/// </returns>
				/// <java-name>
				...
				/// </summary>
				/// <returns>
				///  <para>Maximum number of events of this sensor that could be batched. If this value is zero it indicates that batch mode is not supported for this sensor. If other applications registered to batched sensors, the actual number of events that can be batched might be smaller because the hardware FiFo will be partially used to batch the other sensors. </para>
				/// </returns>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				///     private float timestamp;</pre></para> <para> <pre>    public void onSensorChanged(SensorEvent event) {
				...
				///              float axisZ = event.values[2];</pre></para> <para> <pre>             // Calculate the angular speed of the sample
				///              float omegaMagnitude = sqrt(axisX*axisX + axisY*axisY + axisZ*axisZ);</pre></para> <para> <pre>             // Normalize the rotation vector if it's big enough to get the axis
				///              if (omegaMagnitude &gt; EPSILON) {
				///                  axisX /= omegaMagnitude;
				///                  axisY /= omegaMagnitude;
				///                  axisZ /= omegaMagnitude;
				///              }</pre></para> <para> <pre>             // Integrate around this axis with the angular speed by the timestep
		...
		///     private final Sensor mAccelerometer;</pre></para> <para> <pre>    public SensorActivity() {
		///         mSensorManager = (SensorManager)getSystemService(SENSOR_SERVICE);
		///         mAccelerometer = mSensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);
		///     }</pre></para> <para> <pre>    protected void onResume() {
		///         super.onResume();
		///         mSensorManager.registerListener(this, mAccelerometer, SensorManager.SENSOR_DELAY_NORMAL);
		///     }</pre></para> <para> <pre>    protected void onPause() {
		///         super.onPause();
		///         mSensorManager.unregisterListener(this);
		///     }</pre></para> <para> <pre>    public void onAccuracyChanged(Sensor sensor, int accuracy) {
		///     }</pre></para> <para> <pre>    public void onSensorChanged(SensorEvent event) {
		///     }
		/// }
		/// </pre></para> <para> <para>SensorEventListener </para> <para>SensorEvent </para> <para>Sensor </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Use this method to get the list of available sensors of a certain type. Make multiple calls to get sensors of different types or use Sensor.TYPE_ALL to get all the sensors.</para> <para> <para>getDefaultSensor(int) </para> <para>Sensor </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Use this method to get the default sensor for a given type. Note that the returned sensor could be a composite sensor, and its data could be averaged or filtered. If you need to access the raw sensors use getSensorList.</para> <para> <para>getSensorList(int) </para> <para>Sensor </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Enables batch mode for a sensor with the given rate and maxBatchReportLatency. If the underlying hardware does not support batch mode, this defaults to registerListener(SensorEventListener, Sensor, int) and other parameters are ignored. In non-batch mode, all sensor events must be reported as soon as they are detected. While in batch mode, sensor events do not need to be reported as soon as they are detected. They can be temporarily stored in batches and reported in batches, as long as no event is delayed by more than "maxBatchReportLatency" microseconds. That is, all events since the previous batch are recorded and returned all at once. This allows to reduce the amount of interrupts sent to the SoC, and allows the SoC to switch to a lower power state (Idle) while the sensor is capturing and batching data. </para> <para>Registering to a sensor in batch mode will not prevent the SoC from going to suspend mode. In this case, the sensor will continue to gather events and store it in a hardware FIFO. If the FIFO gets full before the AP wakes up again, some events will be lost, as the older events get overwritten by new events in the hardware FIFO. This can be avoided by holding a wake lock. If the application holds a wake lock, the SoC will not go to suspend mode, so no events will be lost, as the events will be reported before the FIFO gets full. </para> <para>Batching is always best effort. If a different application requests updates in continuous mode, this application will also get events in continuous mode. Batch mode updates can be unregistered by calling unregisterListener(SensorEventListener). </para> <para>Note: Don't use this method with a one shot trigger sensor such as Sensor#TYPE_SIGNIFICANT_MOTION. Use requestTriggerSensor(TriggerEventListener, Sensor) instead. </para> <para> <para>registerListener(SensorEventListener, Sensor, int) </para> <para>unregisterListener(SensorEventListener) </para> <para>flush(SensorEventListener) </para></para>        
				/// </summary>
				/// <returns>
				///  <para> <code>true</code> if batch mode is successfully enabled for this sensor,  <code>false</code> otherwise. </para>
				/// </returns>
				/// <java-name>
				/// registerListener
				/// </java-name>
				[Dot42.DexImport("registerListener", "(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;II)Z", AccessFlags = 1)]
				public virtual bool RegisterListener(global::Android.Hardware.ISensorEventListener listener, global::Android.Hardware.Sensor sensor, int rateUs, int maxBatchReportLatencyUs) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
    ...
    "ler;)Z", AccessFlags = 1)]
				public virtual bool RegisterListener(global::Android.Hardware.ISensorEventListener listener, global::Android.Hardware.Sensor sensor, int rateUs, global::Android.OS.Handler maxBatchReportLatencyUs) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				///  <para>Enables batch mode for a sensor with the given rate and maxBatchReportLatency.  <para>registerListener(SensorEventListener, Sensor, int, int) </para></para>        
				/// </summary>
				/// <returns>
				///  <para> <code>true</code> if batch mode is successfully enabled for this sensor,  <code>false</code> otherwise. </para>
				/// </returns>
    ...
    "dler;)Z", AccessFlags = 1)]
				public virtual bool RegisterListener(global::Android.Hardware.ISensorEventListener listener, global::Android.Hardware.Sensor sensor, int rateUs, int maxBatchReportLatencyUs, global::Android.OS.Handler handler) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				///  <para>Flushes the batch FIFO of all the sensors registered for this listener. If there are events in the FIFO of the sensor, they are returned as if the batch timeout in the FIFO of the sensors had expired. Events are returned in the usual way through the SensorEventListener. This call doesn't affect the batch timeout for this sensor. This call is asynchronous and returns immediately. onFlushCompleted is called after all the events in the batch at the time of calling this method have been delivered successfully. If the hardware doesn't support flush, it still returns true and a trivial flush complete event is sent after the current event for all the clients registered for this sensor.</para> <para> <para>registerListener(SensorEventListener, Sensor, int, int) </para></para>        
				/// </summary>
				/// <returns>
				///  <para> <code>true</code> if the flush is initiated successfully on all the sensors registered for this listener, false if no sensor is previously registered for this listener or flush on one of the sensors fails. </para>
				/// </returns>
				/// <java-name>
				/// flush
				/// </java-name>
				[Dot42.DexImport("flush", "(Landroid/hardware/SensorEventListener;)Z", AccessFlags = 1)]
				public virtual bool Flush(global::Android.Hardware.ISensorEventListener listener) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				///     |  M[ 3]   M[ 4]   M[ 5]  |
				///     \  M[ 6]   M[ 7]   M[ 8]  /
				/// *</pre></para> <para> <hruler></hruler> </para> <para>The inverse of each matrix can be computed easily by taking its transpose.</para> <para>The matrices returned by this function are meaningful only when the device is not free-falling and it is not close to the magnetic north. If the device is accelerating, or placed into a strong magnetic field, the returned matrices may be inaccurate.</para> <para></para> <para></para> <para></para> <para> <para>getInclination(float[]) </para> <para>getOrientation(float[], float[]) </para> <para>remapCoordinateSystem(float[], int, int, float[]) </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Computes the geomagnetic inclination angle in radians from the inclination matrix  <b>I</b> returned by getRotationMatrix.</para> <para> <para>getRotationMatrix(float[], float[], float[], float[]) </para> <para>getOrientation(float[], float[]) </para> <para>GeomagneticField </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		...
		///          // Do Work.</pre></para> <para> <pre>    // As it is a one shot sensor, it will be canceled automatically.
		...
		///     private final TriggerEventListener mListener = new TriggerEventListener();</pre></para> <para> <pre>    public SensorActivity() {
		///         mSensorManager = (SensorManager)getSystemService(SENSOR_SERVICE);
		...
		///     }</pre></para> <para> <pre>}
		/// </pre></para> <para> <para>TriggerEvent </para> <para>Sensor </para></para>    
		/// </summary>
		/// <java-name>
