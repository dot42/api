...
namespace Android.Animation
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Pauses a running animation. This method should only be called on the same thread on which the animation was started. If the animation has not yet been started or has since ended, then the call is ignored. Paused animations can be resumed by calling resume().</para> <para> <para>resume() </para> <para>isPaused() </para> <para>AnimatorPauseListener </para></para>        
				/// </summary>
				/// <java-name>
				/// pause
				/// </java-name>
				...
				/// <summary>
				///  <para>Resumes a paused animation, causing the animator to pick up where it left off when it was paused. This method should only be called on the same thread on which the animation was started. Calls to resume() on an animator that is not currently paused will be ignored.</para> <para> <para>pause() </para> <para>isPaused() </para> <para>AnimatorPauseListener </para></para>        
				/// </summary>
				/// <java-name>
				/// resume
				/// </java-name>
				...
				/// <summary>
				///  <para>Adds a pause listener to this animator.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// addPauseListener
				/// </java-name>
				[Dot42.DexImport("addPauseListener", "(Landroid/animation/Animator$AnimatorPauseListener;)V", AccessFlags = 1)]
				public virtual void AddPauseListener(global::Android.Animation.Animator.IAnimatorPauseListener listener) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Removes a pause listener from the set listening to this animation.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// removePauseListener
				/// </java-name>
				[Dot42.DexImport("removePauseListener", "(Landroid/animation/Animator$AnimatorPauseListener;)V", AccessFlags = 1)]
				public virtual void RemovePauseListener(global::Android.Animation.Animator.IAnimatorPauseListener listener) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Removes all listeners and pauseListeners from this object. </para>        
				/// </summary>
				/// <java-name>
				/// removeAllListeners
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns whether this animator is currently in a paused state.</para> <para> <para>pause() </para> <para>resume() </para></para>        
				/// </summary>
				/// <returns>
				///  <para>True if the animator is currently paused, false otherwise.</para>
				/// </returns>
				/// <java-name>
				/// isPaused
				/// </java-name>
				...
				/// <summary>
				///  <para>A pause listener receives notifications from an animation when the animation is paused or resumed.</para> <para> <para>addPauseListener(AnimatorPauseListener) </para></para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						/// <summary>
						///  <para>Notifies that the animation was paused.</para> <para> <para>pause() </para></para>        
						/// </summary>
						/// <java-name>
						/// onAnimationPause
						/// </java-name>
						[Dot42.DexImport("onAnimationPause", "(Landroid/animation/Animator;)V", AccessFlags = 1025)]
						void OnAnimationPause(global::Android.Animation.Animator animation) /* MethodBuilder.Create */ ;

						/// <summary>
						///  <para>Notifies that the animation was resumed, after being previously paused.</para> <para> <para>resume() </para></para>        
						/// </summary>
						/// <java-name>
						/// onAnimationResume
						/// </java-name>
						[Dot42.DexImport("onAnimationResume", "(Landroid/animation/Animator;)V", AccessFlags = 1025)]
						void OnAnimationResume(global::Android.Animation.Animator animation) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para> <para>Notifies that the animation was paused.</para> <para> <para>pause()</para></para> </para>        
				/// </summary>
				/// <java-name>
				/// onAnimationPause
				/// </java-name>
				[Dot42.DexImport("onAnimationPause", "(Landroid/animation/Animator;)V", AccessFlags = 1)]
				public virtual void OnAnimationPause(global::Android.Animation.Animator animation) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para> <para>Notifies that the animation was resumed, after being previously paused.</para> <para> <para>resume()</para></para> </para>        
				/// </summary>
				/// <java-name>
				/// onAnimationResume
				/// </java-name>
				[Dot42.DexImport("onAnimationResume", "(Landroid/animation/Animator;)V", AccessFlags = 1)]
				public virtual void OnAnimationResume(global::Android.Animation.Animator animation) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Note that canceling a  <code>AnimatorSet</code> also cancels all of the animations that it is responsible for.</para>        
				/// </summary>
				/// <java-name>
				/// cancel
				/// </java-name>
				...
				/// <summary>
				///  <para>Note that ending a  <code>AnimatorSet</code> also ends all of the animations that it is responsible for.</para>        
				/// </summary>
				/// <java-name>
				/// end
				/// </java-name>
				...
				/// <summary>
				///  <para>Starting this  <code>AnimatorSet</code> will, in turn, start the animations for which it is responsible. The details of when exactly those animations are started depends on the dependency relationships that have been set up between the animations. </para>        
				/// </summary>
				/// <java-name>
				/// start
				/// </java-name>
				...
				/// getInterpolator
				/// </java-name>
				public override global::Android.Animation.ITimeInterpolator Interpolator
				{
						[Dot42.DexImport("getInterpolator", "()Landroid/animation/TimeInterpolator;", AccessFlags = 1)]
						get{ return default(global::Android.Animation.ITimeInterpolator); }
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>Interface for use with the ValueAnimator#setEvaluator(TypeEvaluator) function. Evaluators allow developers to create animations on arbitrary property types, by allowing them to supply custom evaluators for types that are not automatically understood and used by the animation system.</para> <para> <para>ValueAnimator::setEvaluator(TypeEvaluator) </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				public virtual void AddChild(global::Android.Views.ViewGroup parent, global::Android.Views.View child) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void ShowChild(global::Android.Views.ViewGroup parent, global::Android.Views.View child) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void ShowChild(global::Android.Views.ViewGroup parent, global::Android.Views.View child, int oldVisibility) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void RemoveChild(global::Android.Views.ViewGroup parent, global::Android.Views.View child) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void HideChild(global::Android.Views.ViewGroup parent, global::Android.Views.View child) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void HideChild(global::Android.Views.ViewGroup parent, global::Android.Views.View child, int newVisibility) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
    ...
    ")V", AccessFlags = 1025)]
						void StartTransition(global::Android.Animation.LayoutTransition transition, global::Android.Views.ViewGroup container, global::Android.Views.View view, int transitionType) /* MethodBuilder.Create */ ;
    ...
    ")V", AccessFlags = 1025)]
						void EndTransition(global::Android.Animation.LayoutTransition transition, global::Android.Views.ViewGroup container, global::Android.Views.View view, int transitionType) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
    ...
    "bjectAnimator;", AccessFlags = 137)]
				...
				/// <summary>
				///  <para>Gets the name of the property that will be animated. This name will be used to derive a setter function that will be called to set animated values. For example, a property name of  <code>foo</code> will result in a call to the function  <code>setFoo()</code> on the target object. If either  <code>valueFrom</code> or  <code>valueTo</code> is null, then a getter function will also be derived and called.</para> <para>If this animator was created with a Property object instead of the string name of a property, then this method will return the name of that Property object instead. If this animator was created with one or more PropertyValuesHolder objects, then this method will return the name of that object (if there was just one) or a comma-separated list of all of the names (if there are more than one).</para>        
				/// </summary>
				/// <java-name>
				/// getPropertyName
				/// </java-name>
