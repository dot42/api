 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Use buffering for best compression.  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// NO_FLUSH
				/// </java-name>
				...
				/// <summary>
				///  <para>Flush buffers so recipients can immediately decode the data sent thus far. This mode may degrade compression.  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// SYNC_FLUSH
				/// </java-name>
				...
				/// <summary>
				///  <para>Flush buffers so recipients can immediately decode the data sent thus far. The compression state is also reset to permit random access and recovery for clients who have discarded or damaged their own copy. This mode may degrade compression.  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// FULL_FLUSH
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Reads up to <c>byteCount </c> bytes of compressed data into a byte buffer. The result will be bytes of compressed data corresponding to an uncompressed byte or bytes read from the underlying stream. Returns the number of bytes read or -1 if the end of the compressed input stream has been reached. </para>        
				/// </summary>
				/// <java-name>
				/// read
				/// </java-name>
				...
				/// <summary>
				///  <para>Note: if <c>n &gt; Integer.MAX_VALUE </c> , this stream will only attempt to skip <c>Integer.MAX_VALUE </c> bytes. </para>        
				/// </summary>
				/// <java-name>
				/// skip
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Constructs a new instance with the given <c>Deflater </c> , buffer size, and flushing behavior (see flush).  <para>1.7 </para></para>        
				/// </summary>
				...
				/// <summary>
				///  <para>Flushes the underlying stream. This flushes only the bytes that can be compressed at the highest level.</para> <para>For deflater output streams constructed with the <c>syncFlush </c> parameter set to true, this first flushes all outstanding data so that it may be immediately read by its recipient. Doing so may degrade compression but improve interactive behavior. </para>        
				/// </summary>
				/// <java-name>
				/// flush
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/io/OutputStream;Z)V", AccessFlags = 1)]
				public GZIPOutputStream(global::Java.IO.OutputStream os, bool bufferSize) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				///  <para>Constructs a new <c>GZIPOutputStream </c> to write data in GZIP format to the given stream with the given internal buffer size and flushing behavior (see DeflaterOutputStream#flush).  <para>1.7 </para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/io/OutputStream;IZ)V", AccessFlags = 1)]
				public GZIPOutputStream(global::Java.IO.OutputStream os, int bufferSize, bool syncFlush) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns this file's comment, or null if it doesn't have one. See ZipOutputStream#setComment.</para> <para> <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// getComment
				/// </java-name>
