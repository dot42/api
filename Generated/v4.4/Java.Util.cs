...
namespace Java.Util
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Removes all elements from this list, leaving it empty.</para> <para> <para>List::isEmpty </para> <para>List::size </para></para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the hash code of this list. The hash code is calculated by taking each element's hashcode into account.</para> <para> <para>equals </para> <para>List::hashCode() </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para> <para>Removes all elements from this <c>Map </c> , leaving it empty.</para> <para> <para>isEmpty() </para> <para>size()</para></para></para> <para>This implementation calls <c>entrySet().clear() </c> . </para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
				...
				/// <summary>
				///  <para> <para>Compares the argument to the receiver, and returns <c>true </c> if the specified object is a <c>Map </c> and both <c>Map </c> s contain the same mappings.</para> <para> <para>hashCode() </para> <para>entrySet()</para></para></para> <para>This implementation first checks the structure of <c>object </c> . If it is not a map or of a different size, this returns false. Otherwise it iterates its own entry set, looking up each entry's key in <c>object </c> . If any value does not equal the other map's value for the same key, this returns false. Otherwise it returns true. </para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>A key-value mapping with mutable values.</para> <para> <para>1.6 </para></para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>Sets the value of this entry to the specified value, replacing any existing value.</para> <para></para>        
						/// </summary>
						/// <returns>
						///  <para>object the replaced value of this entry. </para>
						/// </returns>
						/// <java-name>
						/// setValue
						/// </java-name>
						[Dot42.DexImport("setValue", "(Ljava/lang/Object;)Ljava/lang/Object;", AccessFlags = 1, Signature = "(TV;)TV;")]
						public virtual V SetValue(V @object) /* MethodBuilder.Create */ 
						{
								return default(V);
						}

						/// <summary>
						///  <para>Compares the specified object to this <c>Map.Entry </c> and returns if they are equal. To be equal, the object must be an instance of <c>Map.Entry </c> and have the same key and value.</para> <para> <para>hashCode() </para></para>        
						/// </summary>
						/// <returns>
						///  <para> <c>true </c> if the specified <c>Object </c> is equal to this  <c>Map.Entry </c> , <c>false </c> otherwise. </para>
						/// </returns>
						/// <java-name>
						/// equals
						/// </java-name>
						...
						/// <summary>
						///  <para>Returns an integer hash code for the receiver. <c>Object </c> which are equal return the same value for this method.</para> <para> <para>equals(Object) </para></para>        
						/// </summary>
						/// <returns>
						///  <para>the receiver's hash code. </para>
						/// </returns>
						/// <java-name>
						/// hashCode
						/// </java-name>
						...
						protected internal SimpleEntry() /* TypeBuilder.AddDefaultConstructor */ 
						{
						}

						/// <summary>
						///  <para>Returns the key.</para> <para></para>        
						/// </summary>
						/// <returns>
						///  <para>the key </para>
						/// </returns>
				...
				/// <summary>
				///  <para>An immutable key-value mapping. Despite the name, this class is non-final and its subclasses may be mutable.</para> <para> <para>1.6 </para></para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>This base implementation throws <c>UnsupportedOperationException </c> always. </para>        
						/// </summary>
						/// <java-name>
						/// setValue
						/// </java-name>
						...
						[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
						protected internal SimpleImmutableEntry() /* TypeBuilder.AddDefaultConstructor */ 
						{
						}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Removes all elements from this <c>ArrayList </c> , leaving it empty.</para> <para> <para>isEmpty </para> <para>#size </para></para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
				...
				/// </java-name>
				[Dot42.DexImport("removeRange", "(II)V", AccessFlags = 4)]
				protected internal override void RemoveRange(int fromIndex, int toIndex) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns the index of the first bit that is set on or before <c>index </c> , or -1 if no lower bits are set or <c>index == -1 </c> .  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// previousSetBit
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the index of the first bit that is clear on or before <c>index </c> , or -1 if no lower bits are clear or <c>index == -1 </c> .  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// previousClearBit
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns a <c>BitSet </c> corresponding to <c>longBuffer </c> , interpreted as a little-endian sequence of bits. This method does not alter the <c>LongBuffer </c> .  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// valueOf
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns a new <c>long[] </c> containing a little-endian representation of the bits of this <c>BitSet </c> , suitable for passing to <c>valueOf </c> to reconstruct this <c>BitSet </c> .  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// toLongArray
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns a new <c>byte[] </c> containing a little-endian representation the bits of this <c>BitSet </c> , suitable for passing to <c>valueOf </c> to reconstruct this <c>BitSet </c> .  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// toByteArray
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Field number for <c>get </c> and <c>set </c> indicating the era, e.g., AD or BC in the Julian calendar. This is a calendar-specific value; see subclass documentation.</para> <para> <para>GregorianCalendar::AD </para> <para>GregorianCalendar::BC </para></para>        
				/// </summary>
				/// <java-name>
				/// ERA
				/// </java-name>
				...
				/// <summary>
				///  <para>Field number for <c>get </c> and <c>set </c> indicating the month. This is a calendar-specific value. The first month of the year is  <c>JANUARY </c> ; the last depends on the number of months in a year.</para> <para> <para>JANUARY </para> <para>FEBRUARY </para> <para>MARCH </para> <para>APRIL </para> <para>MAY </para> <para>JUNE </para> <para>JULY </para> <para>AUGUST </para> <para>SEPTEMBER </para> <para>OCTOBER </para> <para>NOVEMBER </para> <para>DECEMBER </para> <para>UNDECIMBER </para></para>        
				/// </summary>
				/// <java-name>
				/// MONTH
				/// </java-name>
				...
				/// <summary>
				///  <para>Field number for <c>get </c> and <c>set </c> indicating whether the <c>HOUR </c> is before or after noon. E.g., at 10:04:15.250 PM the <c>AM_PM </c> is <c>PM </c> .</para> <para> <para>AM </para> <para>PM </para> <para>HOUR </para></para>        
				/// </summary>
				/// <java-name>
				/// AM_PM
				/// </java-name>
				...
				/// <summary>
				///  <para>Field number for <c>get </c> and <c>set </c> indicating the hour of the morning or afternoon. <c>HOUR </c> is used for the 12-hour clock. E.g., at 10:04:15.250 PM the <c>HOUR </c> is 10.</para> <para> <para>AM_PM </para> <para>HOUR_OF_DAY </para></para>        
				/// </summary>
				/// <java-name>
				/// HOUR
				/// </java-name>
				...
				/// <summary>
				///  <para>Clears the values of all the time fields, marking them all unset and assigning them all a value of zero. The actual field values will be determined the next time the fields are accessed. </para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
				...
				/// <summary>
				///  <para>Clears the value in the given time field, marking it unset and assigning it a value of zero. The actual field value will be determined the next time the field is accessed. </para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns a map of human-readable strings to corresponding values, for the given field, style, and locale. Returns null if no strings are available.</para> <para>For example, <c>getDisplayNames(MONTH, ALL_STYLES, Locale.US) </c> would contain mappings from "Jan" and "January" to JANUARY, and so on.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// getDisplayNames
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "T;")]
				...
				/// <summary>
				///  <para>Sorts the given list in ascending natural order. The algorithm is stable which means equal elements don't get reordered.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// sort
				/// </java-name>
				...
				/// <summary>
				///  <para>Sorts the given list using the given comparator. The algorithm is stable which means equal elements don't get reordered.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// sort
				/// </java-name>
    ...
    "til/SortedMap<TK;TV;>;")]
				...
				/// <summary>
				///  <para>Returns an enumeration containing no elements.  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// emptyEnumeration
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns an iterator containing no elements.  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// emptyIterator
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns a list iterator containing no elements.  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// emptyListIterator
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Constructs a new <c>ConcurrentModificationException </c> with the given detail message and cause.  <para>1.7 </para></para>        
				/// </summary>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns the localized name of this currency in the given <c>locale </c> . Returns the ISO 4217 currency code if no localized name is available.  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// getDisplayName
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns a set of all known currencies.  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				...
				public static global::Java.Util.ISet<global::Java.Util.Currency> AvailableCurrencies
				{
						...
						get{ return default(global::Java.Util.ISet<global::Java.Util.Currency>); }
				}
				...
				/// <summary>
				///  <para>Equivalent to <c>getDisplayName(Locale.getDefault()) </c> . See "&lt;a href="../util/Locale.html::default_locale"&gt;Be wary of the default locale&lt;/a&gt;".  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// getDisplayName
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Constructs a new <c>Date </c> initialized to midnight in the default <c>TimeZone </c> on the specified date.</para> <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Use GregorianCalendar#GregorianCalendar(int, int, int) instead. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				...
				/// <summary>
				///  <para>Constructs a new <c>Date </c> initialized to the specified date and time in the default <c>TimeZone </c> .</para> <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Use GregorianCalendar#GregorianCalendar(int, int, int, int, int) instead. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				...
				/// <summary>
				///  <para>Constructs a new <c>Date </c> initialized to the specified date and time in the default <c>TimeZone </c> .</para> <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Use GregorianCalendar#GregorianCalendar(int, int, int, int, int, int) instead. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				...
				/// <summary>
				///  <para>Returns the gregorian calendar day of the month for this <c>Date </c> object.</para> <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Use <c>Calendar.get(Calendar.DATE) </c> instead. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Sets the gregorian calendar day of the month for this <c>Date </c> object.</para> <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Use <c>Calendar.set(Calendar.DATE, day) </c> instead. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// setDate
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the string representation of this <c>Date </c> in GMT in the format  <c>"22 Jun 1999 13:02:00 GMT" </c> .</para> <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Use DateFormat instead. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// toGMTString
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the string representation of this <c>Date </c> for the default <c>Locale </c> .</para> <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Use DateFormat instead. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// toLocaleString
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the gregorian calendar day of the week for this <c>Date </c> object.</para> <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Use <c>Calendar.get(Calendar.DAY_OF_WEEK) </c> instead. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns the gregorian calendar hour of the day for this <c>Date </c> object.</para> <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Use <c>Calendar.get(Calendar.HOUR_OF_DAY) </c> instead. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns the gregorian calendar minute of the hour for this <c>Date </c> object.</para> <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Use <c>Calendar.get(Calendar.MINUTE) </c> instead. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns the gregorian calendar month for this <c>Date </c> object.</para> <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Use <c>Calendar.get(Calendar.MONTH) </c> instead. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				///  <para>the month.</para>
				/// </returns>
				...
				/// <summary>
				///  <para>Returns the gregorian calendar second of the minute for this <c>Date </c> object.</para> <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Use <c>Calendar.get(Calendar.SECOND) </c> instead. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns the timezone offset in minutes of the default <c>TimeZone </c> .</para> <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Use <c>(Calendar.get(Calendar.ZONE_OFFSET) + Calendar.get(Calendar.DST_OFFSET)) / 60000 </c> instead. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns the gregorian calendar year since 1900 for this <c>Date </c> object.</para> <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Use <c>Calendar.get(Calendar.YEAR) - 1900 </c> instead. </para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns an enumeration on the elements of this dictionary.</para> <para> <para>keys </para> <para>size </para> <para>Enumeration </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns an enumeration on the keys of this dictionary.</para> <para> <para>elements </para> <para>size </para> <para>Enumeration </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Associate <c>key </c> with <c>value </c> in this dictionary. If <c>key </c> exists in the dictionary before this call, the old value in the dictionary is replaced by <c>value </c> .</para> <para> <para>elements </para> <para>get </para> <para>keys </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Removes the key/value pair with the specified <c>key </c> from this dictionary.</para> <para> <para>get </para> <para>put </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns the number of key/value pairs in this dictionary.</para> <para> <para>elements </para> <para>keys </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>Constructs an <c>EnumMap </c> using the same key type as the given <c>EnumMap </c> and initially containing the same mappings.</para> <para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/lang/Class;)V", AccessFlags = 1, Signature = "(Ljava/lang/Class<TK;>;)V")]
				public EnumMap(global::System.Type map) /* MethodBuilder.Create */ 
				{
				}
				...
				public EnumMap(global::Java.Util.EnumMap<K, V> map) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				///  <para>Removes all elements from this <c>EnumMap </c> , leaving it empty.</para> <para> <para>isEmpty() </para> <para>size() </para></para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
				...
				/// <summary>
				///  <para>Compares the argument to the receiver, and returns <c>true </c> if the specified <c>Object </c> is an <c>EnumMap </c> and both <c>EnumMap </c> s contain the same mappings.</para> <para> <para>hashCode() </para> <para>entrySet() </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Creates an enum set. All the contained elements are of type Class&lt;E&gt;, and the contained elements are the same as those contained in <c>s </c> .</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>an enum set with all the elements from the specified enum set. </para>
				/// </returns>
				/// <java-name>
				/// copyOf
				/// </java-name>
				...
				public static global::Java.Util.EnumSet<JavaE> CopyOf<JavaE>(global::Java.Util.EnumSet<JavaE> s) /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.EnumSet<JavaE>);
				}
				...
				public static global::Java.Util.EnumSet<JavaE> CopyOf<JavaE>(global::Java.Util.ICollection<JavaE> s) /* MethodBuilder.Create */ 
				{
						return default(global::Java.Util.EnumSet<JavaE>);
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// 
		///  
		///    </pre></pre></para></entry> <entry> <para> <pre> <pre>Newline. (The value of System#lineSeparator.)
		...
		///    &lt;font color="red"&gt;Use java.text.SimpleDateFormat instead.&lt;/font&gt;
		///    
		///    
		///    </para></entry></row>
		///  <row>
		...
		/// 
		///  
		///    </para></entry> <entry> <para>2-digit 24-hour hour of day (00-23).
		...
		/// 
		///  
		///    </para></entry> <entry> <para>2-digit 12-hour hour of day (01-12).
		///    </para></entry> <entry> <para>format("%tI", cal); 
		/// 
		///  
		...
		///    </para></entry> <entry> <para>format("%tk", cal); 
		/// 
		///  
		///    </para></entry> <entry> <para>16 
		/// 
		...
		///    locale.
		///    </pre></pre></para> <para> <pre> <pre> <b>Number localization</b>. Some conversions use localized decimal digits rather than the
		///    usual ASCII digits. So formatting123 
		/// 
		///   with%d 
		/// 
		...
		///    conversions.
		///    </pre></pre></para> <para> <pre> <pre> <b>Thread safety</b>. Formatter is not thread-safe.</pre></pre></para> <para> <pre> <pre>    <para>1.5
		///    </para>
		///  <para>java.text.DateFormat
		///    </para>
		///  <para>Formattable
		///    </para>
		///  <para>java.text.SimpleDateFormat
		/// </para>
		/// </pre></pre></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		///                    + (calendar.get(Calendar.DST_OFFSET)/(60*60*1000)));</pre></para> <para> <pre>System.out.println("Current Time, with hour reset to 3");
		...
		/// </pre></para> <para></para></blockquote></para> <para> <para>Calendar </para> <para>TimeZone </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Removes all mappings from this hash map, leaving it empty.</para> <para> <para>isEmpty </para> <para>#size </para></para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Removes all elements from this <c>HashSet </c> , leaving it empty.</para> <para> <para>isEmpty </para> <para>size </para></para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns the number of key/value pairs in this <c>Hashtable </c> .</para> <para> <para>elements </para> <para>keys </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns true if this <c>Hashtable </c> contains the specified object as a key of one of the key/value pairs.</para> <para> <para>contains </para> <para>java.lang.Object::equals </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns true if this <c>Hashtable </c> contains the specified object as the value of at least one of the key/value pairs.</para> <para> <para>containsKey </para> <para>java.lang.Object::equals </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Associate the specified value with the specified key in this  <c>Hashtable </c> . If the key already exists, the old value is replaced. The key and value cannot be null.</para> <para> <para>elements </para> <para>get </para> <para>keys </para> <para>java.lang.Object::equals </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Removes the key/value pair with the specified key from this  <c>Hashtable </c> .</para> <para> <para>get </para> <para>put </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Removes all key/value pairs from this <c>Hashtable </c> , leaving the size zero and the capacity unchanged.</para> <para> <para>isEmpty </para> <para>#size </para></para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns an enumeration on the keys of this <c>Hashtable </c> instance. The results of the enumeration may be affected if the contents of this  <c>Hashtable </c> are modified.</para> <para> <para>elements </para> <para>#size </para> <para>Enumeration </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns an enumeration on the values of this <c>Hashtable </c> . The results of the Enumeration may be affected if the contents of this  <c>Hashtable </c> are modified.</para> <para> <para>keys </para> <para>#size </para> <para>Enumeration </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Removes all elements from this <c>Collection </c> , leaving it empty (optional).</para> <para> <para>isEmpty </para> <para>size </para></para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Removes all elements from this map, leaving it empty.</para> <para> <para>isEmpty() </para> <para>size() </para></para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>Removes all elements from this <c>Map </c> , leaving it empty.</para> <para> <para>isEmpty() </para> <para>size() </para></para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
				...
				/// <summary>
				///  <para>Compares the argument to the receiver, and returns <c>true </c> if the specified object is a <c>Map </c> and both <c>Map </c> s contain the same mappings.</para> <para> <para>hashCode() </para> <para>entrySet() </para></para>        
				/// </summary>
				/// <returns>
				///  <para>boolean <c>true </c> if the <c>Object </c> is the same as this <c>Object </c>  <c>false </c> if it is different from this <c>Object </c> . </para>
				/// </returns>
		...
		/// <summary>
		///  <para> <c>Map.Entry </c> is a key/value mapping contained in a <c>Map </c> . </para>    
		/// </summary>
		/// <java-name>
		/// java/util/Map$Entry
		/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				V SetValue(V @object) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns a key-value mapping associated with the least key in this map, or <c>null </c> if the map is empty. </para>        
				/// </summary>
				/// <java-name>
				/// firstEntry
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns a key-value mapping associated with the greatest key in this map, or <c>null </c> if the map is empty. </para>        
				/// </summary>
				/// <java-name>
				/// lastEntry
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para> <para>Returns a <c>SortedSet </c> of the specified portion of this  <c>SortedSet </c> which contains elements less than the end element. The returned <c>SortedSet </c> is backed by this <c>SortedSet </c> so changes to one set are reflected by the other.</para> <para></para></para> <para>Equivalent to <c>headSet(toElement, false) </c> .</para> <para></para>        
				/// </summary>
				/// <returns>
		...
		/// <summary>
		///  <para>An <c>InputMismatchException </c> is thrown by a scanner to indicate that the next token does not match or is out of range for the type specified in the pattern.</para> <para> <para>Scanner </para> <para>java.lang.RuntimeException </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Removes all elements from this set, leaving it empty.</para> <para> <para>isEmpty </para> <para>size </para></para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns the least key in this sorted map.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// firstKey
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the greatest key in this sorted map.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// lastKey
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Removes all elements from this <c>LinkedList </c> , leaving it empty.</para> <para> <para>List::isEmpty </para> <para>#size </para></para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns the system's installed locales. This array always includes <c>Locale.US </c> , and usually several others. Most locale-sensitive classes offer their own <c>getAvailableLocales </c> method, which should be preferred over this general purpose method.</para> <para> <para>java.text.BreakIterator::getAvailableLocales() </para> <para>java.text.Collator::getAvailableLocales() </para> <para>java.text.DateFormat::getAvailableLocales() </para> <para>java.text.DateFormatSymbols::getAvailableLocales() </para> <para>java.text.DecimalFormatSymbols::getAvailableLocales() </para> <para>java.text.NumberFormat::getAvailableLocales() </para> <para>java.util.Calendar::getAvailableLocales() </para></para>        
				/// </summary>
				/// <java-name>
				/// getAvailableLocales
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the three-letter ISO 3166 country code which corresponds to the country code for this <c>Locale </c> . </para>        
				/// </summary>
				/// <java-name>
				/// getISO3Country
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the three-letter ISO 639-2/T language code which corresponds to the language code for this <c>Locale </c> . </para>        
				/// </summary>
				/// <java-name>
				/// getISO3Language
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns an array of strings containing all the two-letter ISO 3166 country codes that can be used as the country code when constructing a <c>Locale </c> . </para>        
				/// </summary>
				/// <java-name>
				/// getISOCountries
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns an array of strings containing all the two-letter ISO 639-1 language codes that can be used as the language code when constructing a <c>Locale </c> . </para>        
				/// </summary>
				/// <java-name>
				/// getISOLanguages
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>A <c>MissingResourceException </c> is thrown by ResourceBundle when a resource bundle cannot be found or a resource is missing from a resource bundle.</para> <para> <para>ResourceBundle </para> <para>java.lang.RuntimeException </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>Utility methods for objects.  <para>1.7 </para></para>    
		/// </summary>
		/// <java-name>
		/// java/util/Objects
		/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns 0 if <c>a == b </c> , or <c>c.compare(a, b) </c> otherwise. That is, this makes <c>c </c> null-safe. </para>        
				/// </summary>
				/// <java-name>
				/// compare
				/// </java-name>
				...
				public static int Compare<T>(T a, T b, global::Java.Util.IComparator<T> c) /* MethodBuilder.Create */ 
				{
						return default(int);
				}

				/// <summary>
				///  <para>Returns true if both arguments are null, the result of Arrays#equals if both arguments are primitive arrays, the result of Arrays#deepEquals if both arguments are arrays of reference types, and the result of equals otherwise. </para>        
				/// </summary>
				/// <java-name>
				/// deepEquals
				/// </java-name>
				[Dot42.DexImport("deepEquals", "(Ljava/lang/Object;Ljava/lang/Object;)Z", AccessFlags = 9)]
				public static bool DeepEquals(object a, object b) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				///  <para>Null-safe equivalent of <c>a.equals(b) </c> . </para>        
				/// </summary>
				/// <java-name>
				/// equals
				/// </java-name>
				[Dot42.DexImport("equals", "(Ljava/lang/Object;Ljava/lang/Object;)Z", AccessFlags = 9)]
				public static bool Equals(object a, object b) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				///  <para>Convenience wrapper for Arrays#hashCode, adding varargs. This can be used to compute a hash code for an object's fields as follows:  <c>Objects.hash(a, b, c) </c> . </para>        
				/// </summary>
				/// <java-name>
				/// hash
				/// </java-name>
				[Dot42.DexImport("hash", "([Ljava/lang/Object;)I", AccessFlags = 137)]
				public static int Hash(params object[] values) /* MethodBuilder.Create */ 
				{
						return default(int);
				}

				/// <summary>
				///  <para>Returns 0 for null or <c>o.hashCode() </c> . </para>        
				/// </summary>
				/// <java-name>
				/// hashCode
				/// </java-name>
				[Dot42.DexImport("hashCode", "(Ljava/lang/Object;)I", AccessFlags = 9)]
				public static int GetHashCode(object o) /* MethodBuilder.Create */ 
				{
						return default(int);
				}

				/// <summary>
				///  <para>Returns <c>o </c> if non-null, or throws <c>NullPointerException </c> . </para>        
				/// </summary>
				/// <java-name>
				/// requireNonNull
				/// </java-name>
				[Dot42.DexImport("requireNonNull", "(Ljava/lang/Object;)Ljava/lang/Object;", AccessFlags = 9, Signature = "<T:Ljava/lang/Object;>(TT;)TT;")]
				public static T RequireNonNull<T>(T o) /* MethodBuilder.Create */ 
				{
						return default(T);
				}

				/// <summary>
				///  <para>Returns <c>o </c> if non-null, or throws <c>NullPointerException </c> with the given detail message. </para>        
				/// </summary>
				/// <java-name>
				/// requireNonNull
				/// </java-name>
				...
				public static T RequireNonNull<T>(T o, string message) /* MethodBuilder.Create */ 
				{
						return default(T);
				}

				/// <summary>
				///  <para>Returns "null" for null or <c>o.toString() </c> . </para>        
				/// </summary>
				/// <java-name>
				/// toString
				/// </java-name>
				[Dot42.DexImport("toString", "(Ljava/lang/Object;)Ljava/lang/String;", AccessFlags = 9)]
				public static string ToString(object o) /* MethodBuilder.Create */ 
				{
						return default(string);
				}

				/// <summary>
				///  <para>Returns <c>nullString </c> for null or <c>o.toString() </c> . </para>        
				/// </summary>
				/// <java-name>
				/// toString
				/// </java-name>
				[Dot42.DexImport("toString", "(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;", AccessFlags = 9)]
				public static string ToString(object o, string nullString) /* MethodBuilder.Create */ 
				{
						return default(string);
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para> <c>PropertyResourceBundle </c> loads resources from an <c>InputStream </c> . All resources are Strings. The resources must be of the form <c>key=value </c> , one resource per line (see Properties).</para> <para> <para>ResourceBundle </para> <para>Properties </para> <para>1.1 </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				public bool InvokeHasNext(string pattern) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// <summary>
				///  <para>Returns the last <c>IOException </c> that was raised while reading from the underlying input, or <c>null </c> if none was thrown. </para>        
				/// </summary>
				/// <java-name>
				/// ioException
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the <c>Locale </c> of this <c>Scanner </c> . </para>        
				/// </summary>
				/// <java-name>
				/// locale
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the next token. The token will be both prefixed and suffixed by the delimiter that is currently being used (or a string that matches the delimiter pattern). This method will block if input is being read.</para> <para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns the next token if it matches the specified pattern. The token will be both prefixed and suffixed by the delimiter that is currently being used (or a string that matches the delimiter pattern). This method will block if input is being read.</para> <para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns the next token as a <c>BigInteger </c> in the current radix. This method may block for more input.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// nextBigInteger
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the next token as a <c>byte </c> in the current radix. This method may block for more input.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// nextByte
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the next token as an <c>int </c> in the current radix. This method may block for more input.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// nextInt
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the next token as a <c>long </c> in the current radix. This method may block for more input.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// nextLong
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the next token as a <c>short </c> in the current radix. This method may block for more input.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// nextShort
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns true if there is a line terminator in the input. This method may block.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// hasNextLine
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				protected internal ServiceConfigurationError() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				public override int GetOffset(int era, int year, int month, int day, int dayOfWeek, int time) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				public override bool HasSameRules(global::Java.Util.TimeZone zone) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns the element at the top of the stack and removes it.</para> <para> <para>peek </para> <para>push </para></para>        
				/// </summary>
				/// <returns>
				///  <para>the element at the top of the stack. </para>
				/// </returns>
				...
				/// <summary>
				///  <para>Pushes the specified object onto the top of the stack.</para> <para> <para>peek </para> <para>pop </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>The <c>TimerTask </c> class represents a task to run at a specified time. The task may be run once or repeatedly.</para> <para> <para>Timer </para> <para>java.lang.Object::wait(long) </para></para>    
		/// </summary>
		/// <java-name>
		/// java/util/TimerTask
		/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Create a natural order tree map populated with the key/value pairs of  <c>copyFrom </c> . This map's keys must be mutually comparable and non-null.</para> <para>Even if <c>copyFrom </c> is a <c>SortedMap </c> , the constructed map  <b>will not</b> use <c>copyFrom </c> 's ordering. This constructor always creates a naturally-ordered map. Because the <c>TreeMap </c> constructor overloads are ambiguous, prefer to construct a map and populate it in two steps:  <pre>TreeMap&lt;String, Integer&gt; customOrderedMap
				/// 
				...
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/util/Map;)V", AccessFlags = 1, Signature = "(Ljava/util/Map<+TK;+TV;>;)V")]
				public TreeMap(global::Java.Util.IMap<K, V> copyFrom) /* MethodBuilder.Create */ 
				{
				}
				...
				public TreeMap(global::Java.Util.IComparator<K> copyFrom) /* MethodBuilder.Create */ 
				{
				}
				...
				public TreeMap(global::Java.Util.ISortedMap<K, V> copyFrom) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				[Dot42.DexImport("<init>", "(Ljava/util/Collection;)V", AccessFlags = 1, Signature = "(Ljava/util/Collection<+TE;>;)V")]
				public TreeSet(global::Java.Util.ICollection<E> map) /* MethodBuilder.Create */ 
				{
				}

				[Dot42.DexImport("<init>", "(Ljava/util/Comparator;)V", AccessFlags = 1, Signature = "(Ljava/util/Comparator<-TE;>;)V")]
				public TreeSet(global::Java.Util.IComparator<E> map) /* MethodBuilder.Create */ 
				{
				}

				[Dot42.DexImport("<init>", "(Ljava/util/SortedSet;)V", AccessFlags = 1, Signature = "(Ljava/util/SortedSet<TE;>;)V")]
				public TreeSet(global::Java.Util.ISortedSet<E> map) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				///  <para>Removes all elements from this <c>TreeSet </c> , leaving it empty.</para> <para> <para>isEmpty </para> <para>size </para></para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns the number of elements this vector can hold without growing.</para> <para> <para>ensureCapacity </para> <para>size </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Removes all elements from this vector, leaving it empty.</para> <para> <para>isEmpty </para> <para>size </para></para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
				...
				/// <summary>
				///  <para>Searches this vector for the specified object.</para> <para> <para>indexOf(Object) </para> <para>indexOf(Object, int) </para> <para>java.lang.Object::equals </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns an enumeration on the elements of this vector. The results of the enumeration may be affected if the contents of this vector is modified.</para> <para> <para>elementAt </para> <para>Enumeration </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns the first element in this vector.</para> <para> <para>elementAt </para> <para>lastElement </para> <para>size </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Searches in this vector for the index of the specified object. The search for the object starts at the beginning and moves towards the end of this vector.</para> <para> <para>contains </para> <para>lastIndexOf(Object) </para> <para>lastIndexOf(Object, int) </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Searches in this vector for the index of the specified object. The search for the object starts at the specified location and moves towards the end of this vector.</para> <para> <para>contains </para> <para>lastIndexOf(Object) </para> <para>lastIndexOf(Object, int) </para></para>        
				/// </summary>
				/// <returns>
				///  <para>the index in this vector of the specified element, -1 if the element isn't found. </para>
				/// </returns>
				...
				/// <summary>
				///  <para>Returns the last element in this vector.</para> <para> <para>elementAt </para> <para>firstElement </para> <para>size </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Searches in this vector for the index of the specified object. The search for the object starts at the end and moves towards the start of this vector.</para> <para> <para>contains </para> <para>indexOf(Object) </para> <para>indexOf(Object, int) </para></para>        
				/// </summary>
				/// <returns>
				///  <para>the index in this vector of the specified element, -1 if the element isn't found. </para>
				/// </returns>
				...
				/// <summary>
				///  <para>Searches in this vector for the index of the specified object. The search for the object starts at the specified location and moves towards the start of this vector.</para> <para> <para>contains </para> <para>indexOf(Object) </para> <para>indexOf(Object, int) </para></para>        
				/// </summary>
				/// <returns>
				///  <para>the index in this vector of the specified element, -1 if the element isn't found. </para>
				/// </returns>
				...
				/// <summary>
				///  <para>Removes all occurrences in this vector of each object in the specified Collection.</para> <para> <para>remove(Object) </para> <para>contains(Object) </para></para>        
				/// </summary>
				/// <returns>
				///  <para> <c>true </c> if this vector is modified, <c>false </c> otherwise. </para>
				/// </returns>
				...
				/// <summary>
				///  <para>Removes all elements from this vector, leaving the size zero and the capacity unchanged.</para> <para> <para>isEmpty </para> <para>size </para></para>        
				/// </summary>
				/// <java-name>
				/// removeAllElements
				/// </java-name>
				...
				/// <summary>
				///  <para>Removes the first occurrence, starting at the beginning and moving towards the end, of the specified object from this vector. All elements with an index bigger than the element that gets removed have their index decreased by 1.</para> <para> <para>removeAllElements </para> <para>removeElementAt </para> <para>size </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Removes the element found at index position <c>location </c> from this <c>Vector </c> . All elements with an index bigger than  <c>location </c> have their index decreased by 1.</para> <para> <para>removeElement </para> <para>removeAllElements </para> <para>size </para></para>        
				/// </summary>
				/// <java-name>
				/// removeElementAt
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the number of elements in this vector.</para> <para> <para>elementCount </para> <para>lastElement </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Sets the capacity of this vector to be the same as the size.</para> <para> <para>capacity </para> <para>ensureCapacity </para> <para>size </para></para>        
				/// </summary>
				/// <java-name>
				/// trimToSize
				/// </java-name>
		...
		/// <summary>
		///  <para>WeakHashMap is an implementation of Map with keys which are WeakReferences. A key/value mapping is removed when the key is no longer referenced. All optional operations (adding and removing) are supported. Keys and values can be any objects. Note that the garbage collector acts similar to a second thread on this collection, possibly removing keys.</para> <para> <para>1.2 </para> <para>HashMap </para> <para>WeakReference </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Removes all mappings from this map, leaving it empty.</para> <para> <para>isEmpty() </para> <para>size() </para></para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
