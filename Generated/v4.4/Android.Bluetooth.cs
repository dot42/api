 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Used as an int extra field in ACTION_PAIRING_REQUEST intents to indicate pairing method used. Possible values are: PAIRING_VARIANT_PIN, PAIRING_VARIANT_PASSKEY_CONFIRMATION, </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Used as an int extra field in ACTION_PAIRING_REQUEST intents as the value of passkey. </para>        
				/// </summary>
				/// <java-name>
				/// EXTRA_PAIRING_KEY
				/// </java-name>
				...
				/// <summary>
				///  <para>Broadcast Action: This intent is used to broadcast PAIRING REQUEST </para> <para>Requires android.Manifest.permission#BLUETOOTH_ADMIN to receive. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>The user will be prompted to enter a pin or an app will enter a pin for user. </para>        
				/// </summary>
				/// <java-name>
				/// PAIRING_VARIANT_PIN
				/// </java-name>
				...
				/// <summary>
				///  <para>The user will be prompted to confirm the passkey displayed on the screen or an app will confirm the passkey for the user. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Set the pin during pairing when the pairing method is PAIRING_VARIANT_PIN </para> <para>Requires android.Manifest.permission#BLUETOOTH_ADMIN.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>true pin has been set false for error </para>
				/// </returns>
				/// <java-name>
				/// setPin
				/// </java-name>
				...
				/// <summary>
				///  <para>Confirm passkey for PAIRING_VARIANT_PASSKEY_CONFIRMATION pairing. </para> <para>Requires android.Manifest.permission#BLUETOOTH_ADMIN.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>true confirmation has been sent out false for error </para>
				/// </returns>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>A vendor-specific command for unsolicited result code. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Sends a vendor-specific unsolicited result code to the headset.</para> <para>The actual string to be sent is  <code>command + ": " + arg</code>. For example, if <c>command </c> is VENDOR_RESULT_CODE_COMMAND_ANDROID and <c>arg </c> is <c>"0" </c> , the string  <code>"+ANDROID: 0"</code> will be sent.</para> <para>Currently only VENDOR_RESULT_CODE_COMMAND_ANDROID is allowed as <c>command </c> .</para> <para>Requires android.Manifest.permission#BLUETOOTH permission.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para> <c>false </c> if there is no headset connected, or if the command is not an allowed vendor-specific unsolicited result code, or on error. <c>true </c> otherwise. </para>
				/// </returns>
				/// <java-name>
				...
				public bool SendVendorSpecificResultCode(global::Android.Bluetooth.BluetoothDevice device, string command, string arg) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
