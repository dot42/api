 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Constructs a cookie from a string. The string should comply with set-cookie or set-cookie2 header format as specified in . Since set-cookies2 syntax allows more than one cookie definitions in one header, the returned object is a list.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>a list of constructed cookies </para>
				/// </returns>
				/// <java-name>
				/// parse
				/// </java-name>
				...
				public static global::Java.Util.IList<global::Java.Net.HttpCookie> Parse(string header) /* MethodBuilder.Create */ 
				{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>The byte count in the request body if it is both known and streamed; and -1 otherwise. Prefer this field over the <c>int </c> -valued <c>fixedContentLength </c> on platforms that support both. </para>        
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns the IPv6 loopback address <c>::1 </c> or the IPv4 loopback address <c>127.0.0.1 </c> .  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// getLoopbackAddress
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns the hostname if known, or the result of <c>InetAddress.getHostAddress </c> . Unlike getHostName, this method will never cause a DNS lookup.  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// getHostString
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns the NetworkInterface corresponding to the given interface index, or null if no interface has this index.</para> <para> <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// getByIndex
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the index for the network interface, or -1 if unknown.  <para>1.7 </para></para>        
				/// </summary>
				/// <java-name>
				/// getIndex
				/// </java-name>
