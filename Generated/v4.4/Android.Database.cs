 ...
 /* scope: __dot42__ */ 
		{
				...
				/// }</code></pre></para> <para> <pre> <code>// Implement the onChange(boolean, Uri) method to take advantage of the new Uri argument.
				/// { }
 ...
 /* scope: __dot42__ */ 
		{
				...
				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				protected internal CrossProcessCursorWrapper() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
				...
				[Dot42.DexImport("android/database/Cursor", "getBlob", "(I)[B", AccessFlags = 1025)]
				...
				public override global::Android.Net.Uri NotificationUri
				{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// getNotificationUri
				/// </java-name>
				global::Android.Net.Uri NotificationUri
				{
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>Offer value for possible inclusion if this cursor defines the given column. Columns not defined by the cursor are silently ignored.</para> <para></para>        
						/// </summary>
						/// <returns>
						///  <para>this builder to support chaining </para>
						/// </returns>
						...
						public virtual RowBuilder Add(string columnName, object value) /* MethodBuilder.Create */ 
						{
								return default(RowBuilder);
						}
