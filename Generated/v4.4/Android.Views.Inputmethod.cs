...
namespace Android.Views.Inputmethod
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				public virtual bool CommitCompletion(global::Android.Views.Inputmethod.CompletionInfo text) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
    ...
    "ctedText;", AccessFlags = 1)]
				public virtual global::Android.Views.Inputmethod.ExtractedText GetExtractedText(global::Android.Views.Inputmethod.ExtractedTextRequest request, int flags) /* MethodBuilder.Create */ 
				{
				...
				public virtual bool SendKeyEvent(global::Android.Views.KeyEvent @event) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>The content type of the text box, whose bits are defined by InputType.</para> <para> <para>InputType </para> <para>TYPE_MASK_CLASS </para> <para>TYPE_MASK_VARIATION </para> <para>TYPE_MASK_FLAGS </para></para>        
				/// </summary>
				/// <java-name>
				/// inputType
				/// </java-name>
				...
				/// <summary>
				///  <para>Bits of IME_MASK_ACTION: the action key performs a "search" operation, taking the user to the results of searching for the text they have typed (in whatever context is appropriate). </para>        
				/// </summary>
				/// <java-name>
				/// IME_ACTION_SEARCH
				/// </java-name>
				...
				/// <summary>
				///  <para>Bits of IME_MASK_ACTION: the action key performs a "send" operation, delivering the text to its target. This is typically used when composing a message in IM or SMS where sending is immediate. </para>        
				/// </summary>
				/// <java-name>
				/// IME_ACTION_SEND
				/// </java-name>
				...
				/// <summary>
				///  <para>Bits of IME_MASK_ACTION: the action key performs a "done" operation, typically meaning there is nothing more to input and the IME will be closed. </para>        
				/// </summary>
				/// <java-name>
				/// IME_ACTION_DONE
				/// </java-name>
				...
				/// <summary>
				///  <para>Flag of imeOptions: used in conjunction with one of the actions masked by IME_MASK_ACTION, this indicates that the action should not be available as an accessory button on the right of the extracted text when the input method is full-screen. Note that by setting this flag, there can be cases where the action is simply never available to the user. Setting this generally means that you think that in fullscreen mode, where there is little space to show the text, it's not worth taking some screen real estate to display the action and it should be used instead to show more text. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Flag of imeOptions: used in conjunction with one of the actions masked by IME_MASK_ACTION. If this flag is not set, IMEs will normally replace the "enter" key with the action supplied. This flag indicates that the action should not be available in-line as a replacement for the "enter" key. Typically this is because the action has such a significant impact or is not recoverable enough that accidentally hitting it should be avoided, such as sending a message. Note that android.widget.TextView will automatically set this flag for you on multi-line text views. </para>        
				/// </summary>
				/// <java-name>
				...
				public int ActionId;
				/// <summary>
				///  <para>The text offset of the start of the selection at the time editing began; -1 if not known. Keep in mind some IMEs may not be able to give their full feature set without knowing the cursor position; avoid passing -1 here if you can. </para>        
				/// </summary>
				/// <java-name>
				/// initialSelStart
				/// </java-name>
				...
				/// <summary>
				///  <para>The text offset of the end of the selection at the time editing began; -1 if not known. Keep in mind some IMEs may not be able to give their full feature set without knowing the cursor position; avoid passing -1 here if you can. </para>        
				/// </summary>
				/// <java-name>
				/// initialSelEnd
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "ctedText;", AccessFlags = 1025)]
				global::Android.Views.Inputmethod.ExtractedText GetExtractedText(global::Android.Views.Inputmethod.ExtractedTextRequest request, int flags) /* MethodBuilder.Create */ ;
				...
				bool CommitCompletion(global::Android.Views.Inputmethod.CompletionInfo text) /* MethodBuilder.Create */ ;
				...
				bool SendKeyEvent(global::Android.Views.KeyEvent @event) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Bind a new application environment in to the input method, so that it can later start and stop input processing. Typically this method is called when this input method is enabled in an application for the first time.</para> <para> <para>InputBinding </para> <para>unbindInput() </para></para>        
				/// </summary>
				/// <java-name>
				/// bindInput
				/// </java-name>
				[Dot42.DexImport("bindInput", "(Landroid/view/inputmethod/InputBinding;)V", AccessFlags = 1025)]
				void BindInput(global::Android.Views.Inputmethod.InputBinding binding) /* MethodBuilder.Create */ ;
    ...
    "V", AccessFlags = 1025)]
				void StartInput(global::Android.Views.Inputmethod.IInputConnection inputConnection, global::Android.Views.Inputmethod.EditorInfo info) /* MethodBuilder.Create */ ;
    ...
    "V", AccessFlags = 1025)]
				void RestartInput(global::Android.Views.Inputmethod.IInputConnection inputConnection, global::Android.Views.Inputmethod.EditorInfo attribute) /* MethodBuilder.Create */ ;
				...
				void CreateSession(global::Android.Views.Inputmethod.IInputMethod_ISessionCallback callback) /* MethodBuilder.Create */ ;
				...
				void SetSessionEnabled(global::Android.Views.Inputmethod.IInputMethodSession session, bool enabled) /* MethodBuilder.Create */ ;
				...
				void RevokeSession(global::Android.Views.Inputmethod.IInputMethodSession session) /* MethodBuilder.Create */ ;
				...
				void ChangeInputMethodSubtype(global::Android.Views.Inputmethod.InputMethodSubtype subtype) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				void SessionCreated(global::Android.Views.Inputmethod.IInputMethodSession session) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				void DisplayCompletions(global::Android.Views.Inputmethod.CompletionInfo[] completions) /* MethodBuilder.Create */ ;
				...
				void UpdateExtractedText(int token, global::Android.Views.Inputmethod.ExtractedText text) /* MethodBuilder.Create */ ;

				/// <summary>
				///  <para>This method is called when a key is pressed. When done with the event, the implementation must call back on  <b>callback</b> with its result.</para> <para>If the input method wants to handle this event, return true, otherwise return false and the caller (i.e. the application) will handle the event.</para> <para> <para>#dispatchKeyUp </para> <para>android.view.KeyEvent </para></para>        
				/// </summary>
				/// <returns>
    ...
    "ck;)V", AccessFlags = 1025)]
				void DispatchKeyEvent(int seq, global::Android.Views.KeyEvent @event, global::Android.Views.Inputmethod.IInputMethodSession_IEventCallback callback) /* MethodBuilder.Create */ ;
    ...
    "lback;)V", AccessFlags = 1025)]
				void DispatchTrackballEvent(int seq, global::Android.Views.MotionEvent @event, global::Android.Views.Inputmethod.IInputMethodSession_IEventCallback callback) /* MethodBuilder.Create */ ;
    ...
    "lback;)V", AccessFlags = 1025)]
				void DispatchGenericMotionEvent(int seq, global::Android.Views.MotionEvent @event, global::Android.Views.Inputmethod.IInputMethodSession_IEventCallback callback) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				public InputBinding(global::Android.Views.Inputmethod.IInputConnection conn, global::Android.OS.IBinder connToken, int uid, int pid) /* MethodBuilder.Create */ 
				{
				}
    ...
    ";)V", AccessFlags = 1)]
				public InputBinding(global::Android.Views.Inputmethod.IInputConnection conn, global::Android.Views.Inputmethod.InputBinding binding) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				public InputConnectionWrapper(global::Android.Views.Inputmethod.IInputConnection target, bool mutable) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void SetTarget(global::Android.Views.Inputmethod.IInputConnection target) /* MethodBuilder.Create */ 
				{
				}
    ...
    "ctedText;", AccessFlags = 1)]
		...
		/// <summary>
		///  <para>This class is used to specify meta information of an input method.</para> <para>It should be defined in an XML resource file with an <c>&amp;lt;input-method&gt; </c> element. For more information, see the guide to .</para> <para> <para>InputMethodSubtype</para>ref android.R.styleable::InputMethod_settingsActivity  ref android.R.styleable::InputMethod_isDefault  ref android.R.styleable::InputMethod_supportsSwitchingToNextInputMethod </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "", AccessFlags = 1)]
				...
				public global::Android.Views.Inputmethod.InputMethodSubtype GetSubtypeAt(int index) /* MethodBuilder.Create */ 
				{
 ...
 /* scope: __dot42__ */ 
    ...
    "ethod/InputMethodSubtype;>;")]
				public global::Java.Util.IList<global::Android.Views.Inputmethod.InputMethodSubtype> GetEnabledInputMethodSubtypeList(global::Android.Views.Inputmethod.InputMethodInfo imi, bool allowsImplicitlySelectedSubtypes) /* MethodBuilder.Create */ 
				{
				...
				public void DisplayCompletions(global::Android.Views.View view, global::Android.Views.Inputmethod.CompletionInfo[] completions) /* MethodBuilder.Create */ 
				{
				}
				...
				public void UpdateExtractedText(global::Android.Views.View view, int token, global::Android.Views.Inputmethod.ExtractedText text) /* MethodBuilder.Create */ 
				{
				}
				...
				public bool ShowSoftInput(global::Android.Views.View view, int flags) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public bool ShowSoftInput(global::Android.Views.View view, int flags, global::Android.OS.ResultReceiver resultReceiver) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public void UpdateSelection(global::Android.Views.View view, int selStart, int selEnd, int candidatesStart, int candidatesEnd) /* MethodBuilder.Create */ 
				{
				}
				...
				public void UpdateCursor(global::Android.Views.View view, int left, int top, int right, int bottom) /* MethodBuilder.Create */ 
				{
				}
				...
				public void SendAppPrivateCommand(global::Android.Views.View view, string action, global::Android.OS.Bundle data) /* MethodBuilder.Create */ 
				{
				}
    ...
    "pe;)V", AccessFlags = 1)]
				public void SetInputMethodAndSubtype(global::Android.OS.IBinder token, string id, global::Android.Views.Inputmethod.InputMethodSubtype subtype) /* MethodBuilder.Create */ 
				{
				}
				...
				public bool SetCurrentInputMethodSubtype(global::Android.Views.Inputmethod.InputMethodSubtype subtype) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// <summary>
				///  <para>Returns true if the current IME needs to offer the users ways to switch to a next input method (e.g. a globe key.). When an IME sets supportsSwitchingToNextInputMethod and this method returns true, the IME has to offer ways to to invoke switchToNextInputMethod accordingly. </para> <para>Note that the system determines the most appropriate next input method and subtype in order to provide the consistent user experience in switching between IMEs and subtypes. </para>        
				/// </summary>
				/// <java-name>
				/// shouldOfferSwitchingToNextInputMethod
				/// </java-name>
				[Dot42.DexImport("shouldOfferSwitchingToNextInputMethod", "(Landroid/os/IBinder;)Z", AccessFlags = 1)]
				public bool ShouldOfferSwitchingToNextInputMethod(global::Android.OS.IBinder imeToken) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public void SetAdditionalInputMethodSubtypes(string imiId, global::Android.Views.Inputmethod.InputMethodSubtype[] subtypes) /* MethodBuilder.Create */ 
				{
				}
    ...
    "id/view/inputmethod/InputMethodSubtype;>;>;")]
		...
		/// <summary>
		///  <para>This class is used to specify meta information of a subtype contained in an input method editor (IME). Subtype can describe locale (e.g. en_US, fr_FR...) and mode (e.g. voice, keyboard...), and is used for IME switch and settings. The input method subtype allows the system to bring up the specified subtype of the designated IME directly.</para> <para>It should be defined in an XML resource file of the input method with the  <code>&lt;subtype&gt;</code> element, which resides within an <c>&amp;lt;input-method&gt; </c> element. For more information, see the guide to .</para> <para> <para>InputMethodInfo</para>ref android.R.styleable::InputMethod_Subtype_label  ref android.R.styleable::InputMethod_Subtype_icon  ref android.R.styleable::InputMethod_Subtype_imeSubtypeLocale  ref android.R.styleable::InputMethod_Subtype_imeSubtypeMode  ref android.R.styleable::InputMethod_Subtype_imeSubtypeExtraValue  ref android.R.styleable::InputMethod_Subtype_isAuxiliary  ref android.R.styleable::InputMethod_Subtype_overridesImplicitlyEnabledSubtype  ref android.R.styleable::InputMethod_Subtype_subtypeId  ref android.R.styleable::InputMethod_Subtype_isAsciiCapable </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Constructor with no subtype ID specified.  <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>use InputMethodSubtypeBuilder instead. Arguments for this constructor have the same meanings as int, String, String, String, boolean, boolean, int) except "id". </para></xrefdescription></xrefsect></para>        
				/// </summary>
				...
				/// <summary>
				///  <para>Constructor.  <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>use InputMethodSubtypeBuilder instead. "isAsciiCapable" is "false" in this constructor. </para></xrefdescription></xrefsect></para>        
				/// </summary>
    ...
    "Ljava/lang/CharSequence;", AccessFlags = 1)]
				...
				/// </summary>
				/// <returns>
				///  <para>true if this subtype is Ascii capable, false otherwise. If the subtype is ASCII capable, it should guarantee that the user can input ASCII characters with this subtype. This is important because many password fields only allow ASCII-characters. </para>
				/// </returns>
				/// <java-name>
				/// isAsciiCapable
				/// </java-name>
				...
				/// <summary>
				///  <para>InputMethodSubtypeBuilder is a builder class of InputMethodSubtype. This class is designed to be used with android.view.inputmethod.InputMethodManager#setAdditionalInputMethodSubtypes. The developer needs to be aware of what each parameter means. </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						...
						public virtual InputMethodSubtypeBuilder SetIsAuxiliary(bool isAuxiliary) /* MethodBuilder.Create */ 
						{
						...
						public virtual InputMethodSubtypeBuilder SetOverridesImplicitlyEnabledSubtype(bool overridesImplicitlyEnabledSubtype) /* MethodBuilder.Create */ 
						{
								return default(InputMethodSubtypeBuilder);
						}
						...
						public virtual InputMethodSubtypeBuilder SetIsAsciiCapable(bool isAsciiCapable) /* MethodBuilder.Create */ 
						{
								return default(InputMethodSubtypeBuilder);
						}
						...
						public virtual InputMethodSubtypeBuilder SetSubtypeIconResId(int subtypeIconResId) /* MethodBuilder.Create */ 
						{
								return default(InputMethodSubtypeBuilder);
						}
						...
						public virtual InputMethodSubtypeBuilder SetSubtypeNameResId(int subtypeNameResId) /* MethodBuilder.Create */ 
						{
								return default(InputMethodSubtypeBuilder);
						}
						...
						public virtual InputMethodSubtypeBuilder SetSubtypeId(int subtypeId) /* MethodBuilder.Create */ 
						{
								return default(InputMethodSubtypeBuilder);
						}
    ...
    "peBuilder;", AccessFlags = 1)]
						public virtual InputMethodSubtypeBuilder SetSubtypeLocale(string subtypeLocale) /* MethodBuilder.Create */ 
						{
								return default(InputMethodSubtypeBuilder);
						}
    ...
    "peBuilder;", AccessFlags = 1)]
						public virtual InputMethodSubtypeBuilder SetSubtypeMode(string subtypeMode) /* MethodBuilder.Create */ 
						{
								return default(InputMethodSubtypeBuilder);
						}
    ...
    "peBuilder;", AccessFlags = 1)]
						public virtual InputMethodSubtypeBuilder SetSubtypeExtraValue(string subtypeExtraValue) /* MethodBuilder.Create */ 
						{
								return default(InputMethodSubtypeBuilder);
						}
						...
						/// </summary>
						/// <returns>
						///  <para>InputMethodSubtype using parameters in this InputMethodSubtypeBuilder. </para>
						/// </returns>
						/// <java-name>
						/// build
						/// </java-name>
						[Dot42.DexImport("build", "()Landroid/view/inputmethod/InputMethodSubtype;", AccessFlags = 1)]
						public virtual global::Android.Views.Inputmethod.InputMethodSubtype Build() /* MethodBuilder.Create */ 
						{
								return default(global::Android.Views.Inputmethod.InputMethodSubtype);
						}
