...
namespace Android.Locations
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </java-name>
				public virtual long ElapsedRealtimeNanos
				{
				...
				/// isFromMockProvider
				/// </java-name>
				public virtual bool IsFromMockProvider
				{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Broadcast intent action when the configured location providers change. For use with isProviderEnabled(String). If you're interacting with the android.provider.Settings.Secure#LOCATION_MODE API, use MODE_CHANGED_ACTION instead. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Broadcast intent action when android.provider.Settings.Secure#LOCATION_MODE changes. For use with the android.provider.Settings.Secure#LOCATION_MODE API. If you're interacting with isProviderEnabled(String), use PROVIDERS_CHANGED_ACTION instead.</para> <para>In the future, there may be mode changes that do not result in PROVIDERS_CHANGED_ACTION broadcasts. </para>        
				/// </summary>
				/// <java-name>
				/// MODE_CHANGED_ACTION
				/// </java-name>
    ...
    "er;)V", AccessFlags = 1)]
				...
				public virtual void RequestLocationUpdates(long request, float listener, global::Android.Locations.Criteria looper, global::Android.App.PendingIntent intent) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void RequestSingleUpdate(string criteria, global::Android.Locations.ILocationListener listener, global::Android.OS.Looper looper) /* MethodBuilder.Create */ 
				{
				}
    ...
    ";)V", AccessFlags = 1)]
				public virtual void RequestSingleUpdate(global::Android.Locations.Criteria criteria, global::Android.Locations.ILocationListener listener, global::Android.OS.Looper looper) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void RequestSingleUpdate(global::Android.Locations.Criteria criteria, global::Android.App.PendingIntent intent) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// hasMonetaryCost
				/// </java-name>
				public virtual bool HasMonetaryCost
				{
		...
		/// <summary>
		///  <para>Dynamically specifies the summary (subtitle) and enabled status of a preference injected into the list of app settings displayed by the system settings app </para> <para>For use only by apps that are included in the system image, for preferences that affect multiple apps. Location settings that apply only to one app should be shown within that app, rather than in the system settings. </para> <para>To add a preference to the list, a subclass of SettingInjectorService must be declared in the manifest as so:</para> <para> <pre>
		...
		///         &lt;/intent-filter&gt;</pre></para> <para> <pre>        &lt;meta-data
		///             android:name="android.location.SettingInjectorService"
		///             android:resource="@xml/my_injected_location_setting" /&gt;
		///     &lt;/service&gt;
		/// </pre> The resource file specifies the static data for the setting:  <pre>
		...
		///     /&gt;
		/// </pre> Here:  <ul> <li> <para>title: The android.preference.Preference#getTitle() value. The title should make it clear which apps are affected by the setting, typically by including the name of the developer. For example, "Acme Corp. ads preferences." </para> <para></para></li> <li> <para>icon: The android.preference.Preference#getIcon() value. Typically this will be a generic icon for the developer rather than the icon for an individual app.</para> <para></para></li> <li> <para>settingsActivity: the activity which is launched to allow the user to modify the setting value. The activity must be in the same package as the subclass of SettingInjectorService. The activity should use your own branding to help emphasize to the user that it is not part of the system settings. </para></li></ul></para> <para>To ensure a good user experience, your android.app.Application#onCreate(), onGetSummary(), and onGetEnabled() methods must all be fast. If any are slow, it can delay the display of settings values for other apps as well. Note further that all are called on your app's UI thread. </para> <para>For compactness, only one copy of a given setting should be injected. If each account has a distinct value for the setting, then the onGetSummary() value should represent a summary of the state across all of the accounts and <c>settingsActivity </c> should display the value for each account. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>Intent action that must be declared in the manifest for the subclass. Used to start the service to read the dynamic status for the setting. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Name of the meta-data tag used to specify the resource file that includes the settings attributes. </para>        
				/// </summary>
				/// <java-name>
				/// META_DATA_NAME
				/// </java-name>
				...
				/// <summary>
				///  <para>Name of the XML tag that includes the attributes for the setting. </para>        
				/// </summary>
				/// <java-name>
				/// ATTRIBUTES_NAME
				/// </java-name>
				...
				/// <summary>
				///  <para>Intent action a client should broadcast when the value of one of its injected settings has changed, so that the setting can be updated in the UI. </para>        
				/// </summary>
				/// <java-name>
				...
				/// </summary>
				[Dot42.DexImport("<init>", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public SettingInjectorService(string name) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				///  <para>Returns the android.preference.Preference#getSummary() value (allowed to be null or empty). Should not perform unpredictably-long operations such as network accesssee the running-time comments in the class-level javadoc.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>the android.preference.Preference#getSummary() value </para>
				/// </returns>
				/// <java-name>
				/// onGetSummary
				/// </java-name>
				...
				/// <summary>
				///  <para>Returns the android.preference.Preference#isEnabled() value. Should not perform unpredictably-long operations such as network accesssee the running-time comments in the class-level javadoc. </para> <para>Note that to prevent churn in the settings list, there is no support for dynamically choosing to hide a setting. Instead you should have this method return false, which will disable the setting and its link to your setting activity. One reason why you might choose to do this is if android.provider.Settings.Secure#LOCATION_MODE is android.provider.Settings.Secure#LOCATION_MODE_OFF. </para> <para>It is possible that the user may click on the setting before this method returns, so your settings activity must handle the case where it is invoked even though the setting is disabled. The simplest approach may be to simply call android.app.Activity#finish() when disabled.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>the android.preference.Preference#isEnabled() value </para>
				/// </returns>
				/// <java-name>
				/// onGetEnabled
				/// </java-name>
				...
				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				protected internal SettingInjectorService() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
