...
namespace Android.Media
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Invalid keypress sound  <para>playSoundEffect(int) </para></para>        
				/// </summary>
				/// <java-name>
				/// FX_KEYPRESS_INVALID
				/// </java-name>
				...
				/// <summary>
				///  <para>Used to indicate a temporary request of audio focus, anticipated to last a short amount of time, during which no other applications, or system components, should play anything. Examples of exclusive and transient audio focus requests are voice memo recording and speech recognition, during which the system shouldn't play any notifications, and media playback should have paused.  <para>requestAudioFocus(OnAudioFocusChangeListener, int, int) </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Sends a simulated key event for a media button. To simulate a key press, you must first send a KeyEvent built with a KeyEvent#ACTION_DOWN action, then another event with the KeyEvent#ACTION_UP action. </para> <para>The key event will be sent to the current media key event consumer which registered with AudioManager#registerMediaButtonEventReceiver(PendingIntent). </para>        
				/// </summary>
				/// <java-name>
				/// dispatchMediaKeyEvent
				/// </java-name>
				[Dot42.DexImport("dispatchMediaKeyEvent", "(Landroid/view/KeyEvent;)V", AccessFlags = 1)]
				public virtual void DispatchMediaKeyEvent(global::Android.Views.KeyEvent keyEvent) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				///  <para>Registers a RemoteController instance for it to receive media metadata updates and playback state information from applications using RemoteControlClient, and control their playback. </para> <para>Registration requires the OnClientUpdateListener listener to be one of the enabled notification listeners (see android.service.notification.NotificationListenerService). </para>        
				/// </summary>
				/// <returns>
				///  <para>true if the RemoteController was successfully registered, false if an error occurred, due to an internal system error, or insufficient permissions. </para>
				/// </returns>
				/// <java-name>
				/// registerRemoteController
				/// </java-name>
				[Dot42.DexImport("registerRemoteController", "(Landroid/media/RemoteController;)Z", AccessFlags = 1)]
				public virtual bool RegisterRemoteController(global::Android.Media.RemoteController rctlr) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				///  <para>Unregisters a RemoteController, causing it to no longer receive media metadata and playback state information, and no longer be capable of controlling playback. </para>        
				/// </summary>
				/// <java-name>
				/// unregisterRemoteController
				/// </java-name>
				[Dot42.DexImport("unregisterRemoteController", "(Landroid/media/RemoteController;)V", AccessFlags = 1)]
				public virtual void UnregisterRemoteController(global::Android.Media.RemoteController rctlr) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>Structure that groups a position in frame units relative to an assumed audio stream, together with the estimated time when that frame was presented or is committed to be presented. In the case of audio output, "present" means that audio produced on device is detectable by an external observer off device. The time is based on the implementation's best effort, using whatever knowledge is available to the system, but cannot account for any delay unknown to the implementation.</para> <para> <para>AudioTrack::getTimestamp </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>Position in frames relative to start of an assumed audio stream. The low-order 32 bits of position is in wrapping frame units similar to AudioTrack#getPlaybackHeadPosition. </para>        
				/// </summary>
				/// <java-name>
				/// framePosition
				/// </java-name>
				...
				/// <summary>
				///  <para>The estimated time when frame was presented or is committed to be presented, in the same units and timebase as java.lang.System#nanoTime. </para>        
				/// </summary>
				/// <java-name>
				/// nanoTime
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				protected internal DeniedByServerException() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>A single complete image buffer to use with a media source such as a MediaCodec.</para> <para>This class allows for efficient direct application access to the pixel data of the Image through one or more ByteBuffers. Each buffer is encapsulated in a Plane that describes the layout of the pixel data in that plane. Due to this direct access, and unlike the Bitmap class, Images are not directly usable as as UI resources.</para> <para>Since Images are often directly produced or consumed by hardware components, they are a limited resource shared across the system, and should be closed as soon as they are no longer needed.</para> <para>For example, when using the ImageReader class to read out Images from various media sources, not closing old Image objects will prevent the availability of new Images once the maximum outstanding image count is reached. When this happens, the function acquiring new Images will typically throw an IllegalStateException.</para> <para> <para>ImageReader </para></para>    
		/// </summary>
		/// <java-name>
		/// android/media/Image
		/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Free up this frame for reuse. </para> <para>After calling this method, calling any methods on this <c>Image </c> will result in an IllegalStateException, and attempting to read from ByteBuffers returned by an earlier Plane#getBuffer call will have undefined behavior. </para>        
				/// </summary>
				/// <java-name>
				/// close
				/// </java-name>
				...
				/// <summary>
				///  <para>Get the format for this image. This format determines the number of ByteBuffers needed to represent the image, and the general layout of the pixel data in each in ByteBuffer.</para> <para>The format is one of the values from ImageFormat. The mapping between the formats and the planes is as follows: </para> <para> <table> <row> <entry> <para>Format </para></entry> <entry> <para>Plane count </para></entry> <entry> <para>Layout details  </para></entry></row> <row> <entry> <para>JPEG </para></entry> <entry> <para>1 </para></entry> <entry> <para>Compressed data, so row and pixel strides are 0. To uncompress, use BitmapFactory#decodeByteArray.   </para></entry></row> <row> <entry> <para>YUV_420_888 </para></entry> <entry> <para>3 </para></entry> <entry> <para>A luminance plane followed by the Cb and Cr chroma planes. The chroma planes have half the width and height of the luminance plane (4:2:0 subsampling). Each pixel sample in each plane has 8 bits. Each plane has its own row stride and pixel stride.  </para></entry></row></table></para> <para> <para>android.graphics.ImageFormat </para></para>        
				/// </summary>
				/// <java-name>
				/// getFormat
				/// </java-name>
				...
				/// <summary>
				///  <para>The width of the image in pixels. For formats where some color channels are subsampled, this is the width of the largest-resolution plane. </para>        
				/// </summary>
				/// <java-name>
				/// getWidth
				/// </java-name>
				...
				/// <summary>
				///  <para>The height of the image in pixels. For formats where some color channels are subsampled, this is the height of the largest-resolution plane. </para>        
				/// </summary>
				/// <java-name>
				/// getHeight
				/// </java-name>
				...
				/// <summary>
				///  <para>Get the timestamp associated with this frame. </para> <para>The timestamp is measured in nanoseconds, and is monotonically increasing. However, the zero point and whether the timestamp can be compared against other sources of time or images depend on the source of this image. </para>        
				/// </summary>
				/// <java-name>
				/// getTimestamp
				/// </java-name>
				...
				/// <summary>
				///  <para>Get the array of pixel planes for this Image. The number of planes is determined by the format of the Image. </para>        
				/// </summary>
				/// <java-name>
				/// getPlanes
				/// </java-name>
				public abstract global::Android.Media.Image.Plane[] Planes
				{
				...
				/// <summary>
				///  <para>A single color plane of image data.</para> <para>The number and meaning of the planes in an Image are determined by the format of the Image.</para> <para>Once the Image has been closed, any access to the the plane's ByteBuffer will fail.</para> <para> <para>getFormat </para></para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>The row stride for this color plane, in bytes.</para> <para>This is the distance between the start of two consecutive rows of pixels in the image. The row stride is always greater than 0.</para>        
						/// </summary>
						/// <java-name>
						/// getRowStride
						/// </java-name>
						...
						/// <summary>
						///  <para>The distance between adjacent pixel samples, in bytes.</para> <para>This is the distance between two consecutive pixel values in a row of pixels. It may be larger than the size of a single pixel to account for interleaved image data or padded formats. The pixel stride is always greater than 0.</para>        
						/// </summary>
						/// <java-name>
						/// getPixelStride
						/// </java-name>
						public abstract int PixelStride
						{
						...
						/// <summary>
						///  <para>Get a direct ByteBuffer containing the frame data.</para> <para>In particular, the buffer returned will always have isDirect return <c>true </c> , so the underlying data could be mapped as a pointer in JNI without doing any copies with <c>GetDirectBufferAddress </c> .</para> <para></para>        
						/// </summary>
						/// <returns>
						///  <para>the byte buffer containing the image data for this plane. </para>
						/// </returns>
						/// <java-name>
						/// getBuffer
						/// </java-name>
						public abstract global::Java.Nio.ByteBuffer Buffer
						{
		...
		/// <summary>
		///  <para>The ImageReader class allows direct application access to image data rendered into a android.view.Surface</para> <para>Several Android media API classes accept Surface objects as targets to render to, including MediaPlayer, MediaCodec, and RenderScript Allocations. The image sizes and formats that can be used with each source vary, and should be checked in the documentation for the specific API.</para> <para>The image data is encapsulated in Image objects, and multiple such objects can be accessed at the same time, up to the number specified by the  <c>maxImages </c> constructor parameter. New images sent to an ImageReader through its Surface are queued until accessed through the acquireLatestImage or acquireNextImage call. Due to memory limits, an image source will eventually stall or drop Images in trying to render to the Surface if the ImageReader does not obtain and release Images at a rate equal to the production rate.</para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Create a new reader for images of the desired size and format.</para> <para>The <c>maxImages </c> parameter determines the maximum number of Image objects that can be be acquired from the <c>ImageReader </c> simultaneously. Requesting more buffers will use up more memory, so it is important to use only the minimum number necessary for the use case.</para> <para>The valid sizes and formats depend on the source of the image data.</para> <para> <para>Image </para></para>        
				/// </summary>
				/// <java-name>
				/// newInstance
				/// </java-name>
				[Dot42.DexImport("newInstance", "(IIII)Landroid/media/ImageReader;", AccessFlags = 9)]
				public static global::Android.Media.ImageReader NewInstance(int width, int height, int format, int maxImages) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Media.ImageReader);
				}

				/// <summary>
				///  <para>Acquire the latest Image from the ImageReader's queue, dropping older images. Returns <c>null </c> if no new image is available. </para> <para>This operation will acquire all the images possible from the ImageReader, but close all images that aren't the latest. This function is recommended to use over acquireNextImage for most use-cases, as it's more suited for real-time processing. </para> <para>Note that maxImages should be at least 2 for acquireLatestImage to be any different than acquireNextImage - discarding all-but-the-newest Image requires temporarily acquiring two Images at once. Or more generally, calling acquireLatestImage with less than two images of margin, that is  <c>(maxImages - currentAcquiredImages &lt; 2) </c> will not discard as expected. </para> <para>This operation will fail by throwing an IllegalStateException if  <c>maxImages </c> have been acquired with acquireLatestImage or acquireNextImage. In particular a sequence of acquireLatestImage calls greater than getMaxImages without calling Image#close in-between will exhaust the underlying queue. At such a time, IllegalStateException will be thrown until more images are released with Image#close. </para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>latest frame of image data, or <c>null </c> if no image data is available. </para>
				/// </returns>
				/// <java-name>
				/// acquireLatestImage
				/// </java-name>
				...
				/// <summary>
				///  <para>Acquire the next Image from the ImageReader's queue. Returns <c>null </c> if no new image is available. </para> <para> <b>Warning:</b> Consider using acquireLatestImage() instead, as it will automatically release older images, and allow slower-running processing routines to catch up to the newest frame. Usage of acquireNextImage is recommended for batch/background processing. Incorrectly using this function can cause images to appear with an ever-increasing delay, followed by a complete stall where no new images seem to appear. </para> <para>This operation will fail by throwing an IllegalStateException if  <c>maxImages </c> have been acquired with acquireNextImage or acquireLatestImage. In particular a sequence of acquireNextImage or acquireLatestImage calls greater than maxImages without calling Image#close in-between will exhaust the underlying queue. At such a time, IllegalStateException will be thrown until more images are released with Image#close. </para> <para> <para>acquireLatestImage </para></para>        
				/// </summary>
				/// <returns>
				///  <para>a new frame of image data, or <c>null </c> if no image data is available. </para>
				/// </returns>
				/// <java-name>
				/// acquireNextImage
				/// </java-name>
				...
				/// <summary>
				///  <para>Register a listener to be invoked when a new image becomes available from the ImageReader.</para> <para></para>        
				/// </summary>
				/// <java-name>
				...
				public virtual void SetOnImageAvailableListener(global::Android.Media.ImageReader.IOnImageAvailableListener listener, global::Android.OS.Handler handler) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Free up all the resources associated with this ImageReader.</para> <para>After calling this method, this ImageReader can not be used. Calling any methods on this ImageReader and Images previously provided by acquireNextImage or acquireLatestImage will result in an IllegalStateException, and attempting to read from ByteBuffers returned by an earlier Plane#getBuffer call will have undefined behavior. </para>        
				/// </summary>
				/// <java-name>
				/// close
				/// </java-name>
				...
				/// <summary>
				///  <para>The width of each Image, in pixels.</para> <para>ImageReader guarantees that all Images acquired from ImageReader (for example, with acquireNextImage) will have the same dimensions as specified in newInstance.</para> <para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>The height of each Image, in pixels.</para> <para>ImageReader guarantees that all Images acquired from ImageReader (for example, with acquireNextImage) will have the same dimensions as specified in newInstance.</para> <para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>The image format of each Image.</para> <para>ImageReader guarantees that all Images acquired from ImageReader (for example, with acquireNextImage) will have the same format as specified in newInstance.</para> <para> <para>ImageFormat </para></para>        
				/// </summary>
				/// <returns>
				///  <para>the format of an Image</para>
				/// </returns>
				/// <java-name>
				/// getImageFormat
				/// </java-name>
				public virtual int ImageFormat
				{
				...
				/// <summary>
				///  <para>Maximum number of images that can be acquired from the ImageReader by any time (for example, with acquireNextImage).</para> <para>An image is considered acquired after it's returned by a function from ImageReader, and until the Image is closed to release the image back to the ImageReader. </para> <para>Attempting to acquire more than <c>maxImages </c> concurrently will result in the acquire function throwing a IllegalStateException. Furthermore, while the max number of images have been acquired by the ImageReader user, the producer enqueueing additional images may stall until at least one image has been released. </para> <para> <para>Image::close </para></para>        
				/// </summary>
				/// <returns>
				///  <para>Maximum number of images for this ImageReader.</para>
				/// </returns>
				/// <java-name>
				/// getMaxImages
				/// </java-name>
				public virtual int MaxImages
				{
				...
				/// <summary>
				///  <para>Get a Surface that can be used to produce Images for this  <c>ImageReader </c> .</para> <para>Until valid image data is rendered into this Surface, the acquireNextImage method will return <c>null </c> . Only one source can be producing data into this Surface at the same time, although the same Surface can be reused with a different API once the first source is disconnected from the Surface.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>A Surface to use for a drawing target for various APIs. </para>
				/// </returns>
				/// <java-name>
				/// getSurface
				/// </java-name>
				...
				/// <summary>
				///  <para>Callback interface for being notified that a new image is available.</para> <para>The onImageAvailable is called per image basis, that is, callback fires for every new frame available from ImageReader. </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						/// <summary>
						///  <para>Callback that is called when a new image is available from ImageReader.</para> <para> <para>ImageReader </para> <para>Image </para></para>        
						/// </summary>
						/// <java-name>
						/// onImageAvailable
						/// </java-name>
						[Dot42.DexImport("onImageAvailable", "(Landroid/media/ImageReader;)V", AccessFlags = 1025)]
						void OnImageAvailable(global::Android.Media.ImageReader reader) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Preload a predefined platform sound to minimize latency when the sound is played later by play.  <para>play </para> <para>SHUTTER_CLICK </para> <para>FOCUS_COMPLETE </para> <para>START_VIDEO_RECORDING </para> <para>STOP_VIDEO_RECORDING </para></para>        
				/// </summary>
				/// <java-name>
				/// load
				/// </java-name>
				...
				/// <summary>
				///  <para>Play one of the predefined platform sounds for media actions.</para> <para>Use this method to play a platform-specific sound for various media actions. The sound playback is done asynchronously, with the same behavior and content as the sounds played by Camera.takePicture, MediaRecorder.start, and MediaRecorder.stop.</para> <para>Using this method makes it easy to match the default device sounds when recording or capturing data through the preview callbacks, or when implementing custom camera-like features in your application.</para> <para>If the sound has not been loaded by load before calling play, play will load the sound at the cost of some additional latency before sound playback begins. </para> <para> <para>android.hardware.Camera::takePicture </para> <para>android.media.MediaRecorder </para> <para>SHUTTER_CLICK </para> <para>FOCUS_COMPLETE </para> <para>START_VIDEO_RECORDING </para> <para>STOP_VIDEO_RECORDING </para></para>        
				/// </summary>
				/// <java-name>
				/// play
				/// </java-name>
		...
		///   }</pre></para> <para> <pre>  int outputBufferIndex = codec.dequeueOutputBuffer(timeoutUs);
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Change a video encoder's target bitrate on the fly. The value is an Integer object containing the new bitrate in bps. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Request that the encoder produce a sync frame "soon". Provide an Integer with the value 0. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Instantiate a decoder supporting input data of the given mime type.</para> <para>The following is a partial list of defined mime types and their semantics:  <ul> <li> <para>"video/x-vnd.on2.vp8" - VP8 video (i.e. video in .webm) </para></li> <li> <para>"video/x-vnd.on2.vp9" - VP9 video (i.e. video in .webm) </para></li> <li> <para>"video/avc" - H.264/AVC video </para></li> <li> <para>"video/mp4v-es" - MPEG4 video </para></li> <li> <para>"video/3gpp" - H.263 video </para></li> <li> <para>"audio/3gpp" - AMR narrowband audio </para></li> <li> <para>"audio/amr-wb" - AMR wideband audio </para></li> <li> <para>"audio/mpeg" - MPEG1/2 audio layer III </para></li> <li> <para>"audio/mp4a-latm" - AAC audio (note, this is raw AAC packets, not packaged in LATM!) </para></li> <li> <para>"audio/vorbis" - vorbis audio </para></li> <li> <para>"audio/g711-alaw" - G.711 alaw audio </para></li> <li> <para>"audio/g711-mlaw" - G.711 ulaw audio </para></li></ul></para> <para></para>        
				/// </summary>
				/// <java-name>
				/// createDecoderByType
				/// </java-name>
				...
				public void Configure(global::Android.Media.MediaFormat format, global::Android.Views.Surface surface, global::Android.Media.MediaCrypto crypto, int flags) /* MethodBuilder.Create */ 
				{
				}
				...
				public global::Android.Views.Surface CreateInputSurface() /* MethodBuilder.Create */ 
				{
						return default(global::Android.Views.Surface);
				}
				...
				/// <summary>
				///  <para>Communicate additional parameter changes to the component instance. </para>        
				/// </summary>
				/// <java-name>
				/// setParameters
				/// </java-name>
				[Dot42.DexImport("setParameters", "(Landroid/os/Bundle;)V", AccessFlags = 17)]
				public void SetParameters(global::Android.OS.Bundle @params) /* MethodBuilder.Create */ 
				{
				}
				...
				public global::Android.Media.MediaFormat OutputFormat
				{
						...
						get{ return default(global::Android.Media.MediaFormat); }
				}
				...
				public global::Android.Media.MediaCodecInfo CodecInfo
				{
						...
						get{ return default(global::Android.Media.MediaCodecInfo); }
				}
 ...
 /* scope: __dot42__ */ 
				...
				/// <summary>
				///  <para>Thrown when a crypto error occurs while queueing a secure input buffer. </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						/// <summary>
						///  <para>This indicates that no key has been set to perform the requested decrypt operation. </para>        
						/// </summary>
						/// <java-name>
						/// ERROR_NO_KEY
						/// </java-name>
						...
						/// <summary>
						///  <para>This indicates that the key used for decryption is no longer valid due to license term expiration. </para>        
						/// </summary>
						/// <java-name>
						/// ERROR_KEY_EXPIRED
						/// </java-name>
						...
						/// <summary>
						///  <para>This indicates that a required crypto resource was not able to be allocated while attempting the requested operation. </para>        
						/// </summary>
						/// <java-name>
						/// ERROR_RESOURCE_BUSY
						/// </java-name>
						...
						[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
						protected internal CryptoException() /* TypeBuilder.AddDefaultConstructor */ 
						{
						}

						/// <summary>
						///  <para>Retrieve the error code associated with a CryptoException </para>        
						/// </summary>
						/// <java-name>
						/// getErrorCode
						/// </java-name>
 ...
 /* scope: __dot42__ */ 
		...
		///         MediaCodecInfo codecInfo = MediaCodecList.getCodecInfoAt(i);</pre></para> <para> <pre>        if (!codecInfo.isEncoder()) {
		///             continue;
		///         }</pre></para> <para> <pre>        String[] types = codecInfo.getSupportedTypes();
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para> <b>video decoder only</b>: codec supports seamless resolution changes. </para>        
						/// </summary>
						/// <java-name>
						...
						/// <summary>
						///  <para>Query codec feature capabilities. </para>        
						/// </summary>
						/// <java-name>
						/// isFeatureSupported
						/// </java-name>
						[Dot42.DexImport("isFeatureSupported", "(Ljava/lang/String;)Z", AccessFlags = 17)]
						public bool IsFeatureSupported(string name) /* MethodBuilder.Create */ 
						{
								return default(bool);
						}
 ...
 /* scope: __dot42__ */ 
		{
				...
				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				protected internal MediaCrypto() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				protected internal MediaCryptoException() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Query if the given scheme identified by its UUID is supported on this device, and whether the drm plugin is able to handle the media container format specified by mimeType. </para>        
				/// </summary>
				/// <java-name>
				/// isCryptoSchemeSupported
				/// </java-name>
				[Dot42.DexImport("isCryptoSchemeSupported", "(Ljava/util/UUID;Ljava/lang/String;)Z", AccessFlags = 25)]
				public static bool IsCryptoSchemeSupported(global::Java.Util.UUID uuid, string mimeType) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
    ...
    ")Landroid/media/MediaDrm$KeyRequest;")]
				...
				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				protected internal MediaDrm() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
				...
				public global::Java.Util.IList<sbyte[]> SecureStops
				{
						...
						get{ return default(global::Java.Util.IList<sbyte[]>); }
				}
 ...
 /* scope: __dot42__ */ 
				{
						...
						[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
						protected internal CryptoSession() /* TypeBuilder.AddDefaultConstructor */ 
						{
						}
 ...
 /* scope: __dot42__ */ 
				{
						...
						void OnEvent(global::Android.Media.MediaDrm md, byte[] sessionId, int @event, int extra, byte[] data) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
		{
				...
				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				protected internal MediaDrmException() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
		...
		///   ...
		///   extractor.advance();
		/// }</pre></para> <para> <pre>extractor.release();
		/// extractor = null;
		/// </pre> </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "/lang/String;>;)V")]
				public void SetDataSource(global::Android.Content.Context context, global::Android.Net.Uri uri, global::Java.Util.IMap<string, string> headers) /* MethodBuilder.Create */ 
				{
				}
				...
				public void SetDataSource(global::Java.IO.FileDescriptor context, long uri, long headers) /* MethodBuilder.Create */ 
				{
				}
				...
				public global::Java.Util.IMap<global::Java.Util.UUID, sbyte[]> PsshInfo
				{
						...
						get{ return default(global::Java.Util.IMap<global::Java.Util.UUID, sbyte[]>); }
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>A key describing the language of the content, using either ISO 639-1 or 639-2/T codes. The associated value is a string. </para>        
				/// </summary>
				/// <java-name>
				/// KEY_LANGUAGE
				/// </java-name>
				...
				/// <summary>
				///  <para>A key describing the maximum expected width of the content in a video decoder format, in case there are resolution changes in the video content. The associated value is an integer </para>        
				/// </summary>
				/// <java-name>
				/// KEY_MAX_WIDTH
				/// </java-name>
				...
				/// <summary>
				///  <para>A key describing the maximum expected height of the content in a video decoder format, in case there are resolution changes in the video content. The associated value is an integer </para>        
				/// </summary>
				/// <java-name>
				/// KEY_MAX_HEIGHT
				/// </java-name>
				...
				/// <summary>
				///  <para>Applies only when configuring a video encoder in "surface-input" mode. The associated value is a long and gives the time in microseconds after which the frame previously submitted to the encoder will be repeated (once) if no new frame became available since. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>If specified when configuring a video decoder rendering to a surface, causes the decoder to output "blank", i.e. black frames to the surface when stopped to clear out any previously displayed contents. The associated value is an integer of value 1. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>A key mapping to a value of 1 if the content is AAC audio and audio frames are prefixed with an ADTS header. The associated value is an integer (0 or 1). This key is only supported when _decoding_ content, it cannot be used to configure an encoder to emit ADTS output. </para>        
				/// </summary>
				/// <java-name>
				/// KEY_IS_ADTS
				/// </java-name>
				...
				/// <summary>
				///  <para>A key describing the AAC profile to be used (AAC audio formats only). Constants are declared in android.media.MediaCodecInfo.CodecProfileLevel. </para>        
				/// </summary>
				/// <java-name>
				/// KEY_AAC_PROFILE
				/// </java-name>
				...
				/// <summary>
				///  <para>A key for boolean AUTOSELECT behavior for the track. Tracks with AUTOSELECT=true are considered when automatically selecting a track without specific user choice, based on the current locale. This is currently only used for subtitle tracks, when the user selected 'Default' for the captioning locale. The associated value is an integer, where non-0 means TRUE. This is an optional field; if not specified, AUTOSELECT defaults to TRUE. </para>        
				/// </summary>
				/// <java-name>
				/// KEY_IS_AUTOSELECT
				/// </java-name>
				...
				/// <summary>
				///  <para>A key for the FORCED field for subtitle tracks. True if it is a forced subtitle track. Forced subtitle tracks are essential for the content and are shown even when the user turns off Captions. They are used for example to translate foreign/alien dialogs or signs. The associated value is an integer, where non-0 means TRUE. This is an optional field; if not specified, FORCED defaults to FALSE. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Creates a minimal subtitle format. </para>        
				/// </summary>
				/// <java-name>
				...
				public static global::Android.Media.MediaFormat CreateSubtitleFormat(string mime, string language) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Media.MediaFormat);
				}
		...
		/// <summary>
		///  <para>An abstract class for editing and storing metadata that can be published by RemoteControlClient. See the RemoteControlClient#editMetadata(boolean) method to instantiate a RemoteControlClient.MetadataEditor object. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>The metadata key for the content's average rating, not the user's rating. The value associated with this key is a Rating instance.  <para>RATING_KEY_BY_USER </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>The metadata key for the content's user rating. The value associated with this key is a Rating instance. This key can be flagged as "editable" (with addEditableKey(int)) to enable receiving user rating values through the android.media.RemoteControlClient.OnMetadataUpdateListener interface. </para>        
				/// </summary>
				/// <java-name>
				/// RATING_KEY_BY_USER
				/// </java-name>
				...
				/// <summary>
				///  <para>Applies all of the metadata changes that have been set since the MediaMetadataEditor instance was created or since clear() was called. </para>        
				/// </summary>
				/// <java-name>
				/// apply
				/// </java-name>
				...
				/// <summary>
				///  <para>Clears all the pending metadata changes set since the MediaMetadataEditor instance was created or since this method was last called. Note that clearing the metadata doesn't reset the editable keys (use removeEditableKeys() instead). </para>        
				/// </summary>
				/// <java-name>
				/// clear
				/// </java-name>
				...
				/// <summary>
				///  <para>Flags the given key as being editable. This should only be used by metadata publishers, such as RemoteControlClient, which will declare the metadata field as eligible to be updated, with new values received through the RemoteControlClient.OnMetadataUpdateListener interface. </para>        
				/// </summary>
				/// <java-name>
				/// addEditableKey
				/// </java-name>
				[Dot42.DexImport("addEditableKey", "(I)V", AccessFlags = 33)]
				public virtual void AddEditableKey(int key) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Causes all metadata fields to be read-only. </para>        
				/// </summary>
				/// <java-name>
				/// removeEditableKeys
				/// </java-name>
				...
				/// <summary>
				///  <para>Adds textual information. Note that none of the information added after apply() has been called, will be available to consumers of metadata stored by the MediaMetadataEditor. </para>        
				/// </summary>
				/// <returns>
				///  <para>Returns a reference to the same MediaMetadataEditor object, so you can chain put calls together. </para>
				/// </returns>
				/// <java-name>
				/// putString
				/// </java-name>
				[Dot42.DexImport("putString", "(ILjava/lang/String;)Landroid/media/MediaMetadataEditor;", AccessFlags = 33)]
				public virtual global::Android.Media.MediaMetadataEditor PutString(int key, string value) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Media.MediaMetadataEditor);
				}

				/// <summary>
				///  <para>Adds numerical information. Note that none of the information added after apply() has been called will be available to consumers of metadata stored by the MediaMetadataEditor. </para>        
				/// </summary>
				/// <returns>
				///  <para>Returns a reference to the same MediaMetadataEditor object, so you can chain put calls together. </para>
				/// </returns>
				...
				public virtual global::Android.Media.MediaMetadataEditor PutLong(int key, long value) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Media.MediaMetadataEditor);
				}

				/// <summary>
				///  <para>Adds image.  <para>android.graphics.Bitmap </para></para>        
				/// </summary>
				/// <returns>
				///  <para>Returns a reference to the same MediaMetadataEditor object, so you can chain put calls together. </para>
				/// </returns>
				...
				public virtual global::Android.Media.MediaMetadataEditor PutBitmap(int key, global::Android.Graphics.Bitmap bitmap) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Media.MediaMetadataEditor);
				}

				/// <summary>
				///  <para>Adds information stored as an instance. Note that none of the information added after apply() has been called will be available to consumers of metadata stored by the MediaMetadataEditor. </para>        
				/// </summary>
				/// <returns>
				///  <para>Returns a reference to the same MediaMetadataEditor object, so you can chain put calls together. </para>
				/// </returns>
				...
				public virtual global::Android.Media.MediaMetadataEditor PutObject(int key, object value) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Media.MediaMetadataEditor);
				}

				/// <summary>
				///  <para>Returns the long value for the key. </para>        
				/// </summary>
				/// <returns>
				///  <para>the long value for the key, or the supplied default value if the key is not present </para>
				/// </returns>
				/// <java-name>
				/// getLong
				/// </java-name>
				[Dot42.DexImport("getLong", "(IJ)J", AccessFlags = 33)]
				public virtual long GetLong(int key, long defaultValue) /* MethodBuilder.Create */ 
				{
						return default(long);
				}

				/// <summary>
				///  <para>Returns the String value for the key. </para>        
				/// </summary>
				/// <returns>
				///  <para>the String value for the key, or the supplied default value if the key is not present </para>
				/// </returns>
				/// <java-name>
				/// getString
				/// </java-name>
				[Dot42.DexImport("getString", "(ILjava/lang/String;)Ljava/lang/String;", AccessFlags = 33)]
				public virtual string GetString(int key, string defaultValue) /* MethodBuilder.Create */ 
				{
						return default(string);
				}

				/// <summary>
				///  <para>Returns the Bitmap value for the key. </para>        
				/// </summary>
				/// <returns>
				///  <para>the Bitmap value for the key, or the supplied default value if the key is not present </para>
				/// </returns>
				/// <java-name>
				/// getBitmap
				/// </java-name>
				[Dot42.DexImport("getBitmap", "(ILandroid/graphics/Bitmap;)Landroid/graphics/Bitmap;", AccessFlags = 33)]
				public virtual global::Android.Graphics.Bitmap GetBitmap(int key, global::Android.Graphics.Bitmap defaultValue) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Graphics.Bitmap);
				}

				/// <summary>
				///  <para>Returns an object representation of the value for the key </para>        
				/// </summary>
				/// <returns>
				///  <para>the object for the key, as a Long, Bitmap, String, or Rating depending on the key value, or the supplied default value if the key is not present </para>
				/// </returns>
				/// <java-name>
				/// getObject
				/// </java-name>
				[Dot42.DexImport("getObject", "(ILjava/lang/Object;)Ljava/lang/Object;", AccessFlags = 33)]
				public virtual object GetObject(int key, object defaultValue) /* MethodBuilder.Create */ 
				{
						return default(object);
				}

				/// <summary>
				///  <para>Retrieves the keys flagged as editable. </para>        
				/// </summary>
				/// <returns>
				///  <para>null if there are no editable keys, or an array containing the keys. </para>
				/// </returns>
				/// <java-name>
				/// getEditableKeys
				/// </java-name>
				public virtual int[] EditableKeys
				{
 ...
 /* scope: __dot42__ */ 
		...
		/// BufferInfo bufferInfo = new BufferInfo();</pre></para> <para> <pre>muxer.start();
		/// while(!finished) {
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Set and store the geodata (latitude and longitude) in the output file. This method should be called before start. The geodata is stored in udta box if the output format is OutputFormat#MUXER_OUTPUT_MPEG_4, and is ignored for other output formats. The geodata is stored according to ISO-6709 standard.</para> <para></para>        
				/// </summary>
				/// <java-name>
				/// setLocation
				/// </java-name>
				[Dot42.DexImport("setLocation", "(FF)V", AccessFlags = 1)]
				public void SetLocation(float latitude, float longitude) /* MethodBuilder.Create */ 
				{
				}
				...
				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				protected internal MediaMuxer() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Subtitle track was not supported by the media framework.  <para>android.media.MediaPlayer.OnInfoListener </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Reading the subtitle track takes too long.  <para>android.media.MediaPlayer.OnInfoListener </para></para>        
				/// </summary>
				/// <java-name>
    ...
    "/lang/String;>;)V")]
				public virtual void SetDataSource(global::Android.Content.Context context, global::Android.Net.Uri uri, global::Java.Util.IMap<string, string> headers) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>Gets the MediaFormat of the track. If the format is unknown or could not be determined, null is returned. </para>        
						/// </summary>
						/// <java-name>
						/// getFormat
						/// </java-name>
						public virtual global::Android.Media.MediaFormat Format
						{
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>Audio source for a submix of audio streams to be presented remotely. </para> <para>An application can use this audio source to capture a mix of audio streams that should be transmitted to a remote receiver such as a Wifi display. While recording is active, these audio streams are redirected to the remote submix instead of being played on the device speaker or headset. </para> <para>Certain streams are excluded from the remote submix, including AudioManager#STREAM_RING, AudioManager#STREAM_ALARM, and AudioManager#STREAM_NOTIFICATION. These streams will continue to be presented locally as usual. </para> <para>Capturing the remote submix audio requires the android.Manifest.permission#CAPTURE_AUDIO_OUTPUT permission. This permission is reserved for use by system components and is not available to third-party applications. </para>        
						/// </summary>
						/// <java-name>
						/// REMOTE_SUBMIX
						/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Flag for addCallback: Do not filter route events. </para> <para>When this flag is specified, the callback will be invoked for event that affect any route even if they do not match the callback's filter. </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Add an app-specified route for media to the MediaRouter. App-specified route definitions are created using createUserRoute(RouteCategory)</para> <para> <para>createUserRoute(RouteCategory) </para> <para>removeUserRoute(UserRouteInfo) </para></para>        
				/// </summary>
				/// <java-name>
				/// addUserRoute
				/// </java-name>
				...
				/// <summary>
				///  <para>Create a new user route that may be modified and registered for use by the application.</para> <para> <para>addUserRoute(UserRouteInfo) </para> <para>removeUserRoute(UserRouteInfo) </para> <para>createRouteCategory(CharSequence, boolean) </para></para>        
				/// </summary>
				/// <returns>
    ...
    "fo;", AccessFlags = 1)]
				...
				/// getDefaultRoute
				/// </java-name>
				public virtual global::Android.Media.MediaRouter.RouteInfo DefaultRoute
				{
						[Dot42.DexImport("getDefaultRoute", "()Landroid/media/MediaRouter$RouteInfo;", AccessFlags = 1)]
						get{ return default(global::Android.Media.MediaRouter.RouteInfo); }
				}
 ...
 /* scope: __dot42__ */ 
    ...
    "ediaRouter$RouteGroup;)V", AccessFlags = 1)]
				...
				/// <summary>
				///  <para>Interface for receiving events about media routing changes. All methods of this interface will be called from the application's main thread. </para> <para>A Callback will only receive events relevant to routes that the callback was registered for unless the MediaRouter#CALLBACK_FLAG_UNFILTERED_EVENTS flag was specified in MediaRouter#addCallback(int, Callback, int). </para> <para> <para>MediaRouter::addCallback(int, Callback, int) </para> <para>MediaRouter::removeCallback(Callback) </para></para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "/media/MediaRouter$RouteInfo;>;")]
						...
						/// getName
						/// </java-name>
						public virtual global::Java.Lang.ICharSequence Name
						{
						...
						/// getSupportedTypes
						/// </java-name>
						public virtual int SupportedTypes
						{
 ...
 /* scope: __dot42__ */ 
				{
						...
						public virtual void SetIconDrawable(global::Android.Graphics.Drawables.Drawable icon) /* MethodBuilder.Create */ 
						{
						}
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// </java-name>
						public virtual global::Android.Media.RemoteControlClient RemoteControlClient
						{
								[Dot42.DexImport("getRemoteControlClient", "()Landroid/media/RemoteControlClient;", AccessFlags = 1)]
								get{ return default(global::Android.Media.RemoteControlClient); }
 ...
 /* scope: __dot42__ */ 
				{
						/// <summary>
						///  <para>The default playback type, "local", indicating the presentation of the media is happening on the same device (e.g. a phone, a tablet) as where it is controlled from.  <para>getPlaybackType() </para></para>        
						/// </summary>
						/// <java-name>
						/// PLAYBACK_TYPE_LOCAL
						/// </java-name>
						...
						/// <summary>
						///  <para>A playback type indicating the presentation of the media is happening on a different device (i.e. the remote device) than where it is controlled from.  <para>getPlaybackType() </para></para>        
						/// </summary>
						/// <java-name>
						...
						/// <summary>
						///  <para>Playback information indicating the playback volume is fixed, i.e. it cannot be controlled from this object. An example of fixed playback volume is a remote player, playing over HDMI where the user prefers to control the volume on the HDMI sink, rather than attenuate at the source.  <para>getVolumeHandling() </para></para>        
						/// </summary>
						/// <java-name>
						...
						/// <summary>
						///  <para>Playback information indicating the playback volume is variable and can be controlled from this object.  <para>getVolumeHandling() </para></para>        
						/// </summary>
						/// <java-name>
						...
						/// getDescription
						/// </java-name>
						public virtual global::Java.Lang.ICharSequence Description
						{
						...
						/// getStatus
						/// </java-name>
						public virtual global::Java.Lang.ICharSequence Status
						{
						...
						/// getGroup
						/// </java-name>
						public virtual global::Android.Media.MediaRouter.RouteGroup Group
						{
								[Dot42.DexImport("getGroup", "()Landroid/media/MediaRouter$RouteGroup;", AccessFlags = 1)]
								get{ return default(global::Android.Media.MediaRouter.RouteGroup); }
						}
						...
						/// getCategory
						/// </java-name>
						public virtual global::Android.Media.MediaRouter.RouteCategory Category
						{
								[Dot42.DexImport("getCategory", "()Landroid/media/MediaRouter$RouteCategory;", AccessFlags = 1)]
								get{ return default(global::Android.Media.MediaRouter.RouteCategory); }
						}
						...
						/// getIconDrawable
						/// </java-name>
						public virtual global::Android.Graphics.Drawables.Drawable IconDrawable
						{
						...
						/// getPlaybackStream
						/// </java-name>
						public virtual int PlaybackStream
						{
						...
						/// getVolumeHandling
						/// </java-name>
						public virtual int VolumeHandling
						{
						...
						/// </java-name>
						public virtual global::Android.Views.Display PresentationDisplay
						{
 ...
 /* scope: __dot42__ */ 
		{
				...
				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				protected internal NotProvisionedException() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>A rating style with a single degree of rating, "heart" vs "no heart". Can be used to indicate the content referred to is a favorite (or not). </para>        
				/// </summary>
				/// <java-name>
				/// RATING_HEART
				/// </java-name>
				...
				/// <summary>
				///  <para>A rating style for "thumb up" vs "thumb down". </para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>A rating style with 0 to 3 stars. </para>        
				/// </summary>
				/// <java-name>
				/// RATING_3_STARS
				/// </java-name>
				...
				/// <summary>
				///  <para>A rating style with 0 to 4 stars. </para>        
				/// </summary>
				/// <java-name>
				/// RATING_4_STARS
				/// </java-name>
				...
				/// <summary>
				///  <para>A rating style with 0 to 5 stars. </para>        
				/// </summary>
				/// <java-name>
				/// RATING_5_STARS
				/// </java-name>
				...
				/// <summary>
				///  <para>A rating style expressed as a percentage. </para>        
				/// </summary>
				/// <java-name>
				/// RATING_PERCENTAGE
				/// </java-name>
				...
				/// <summary>
				///  <para>Return a Rating instance with no rating. Create and return a new Rating instance with no rating known for the given rating style. </para>        
				/// </summary>
				/// <returns>
				///  <para>null if an invalid rating style is passed, a new Rating instance otherwise. </para>
				/// </returns>
				/// <java-name>
				/// newUnratedRating
				/// </java-name>
				[Dot42.DexImport("newUnratedRating", "(I)Landroid/media/Rating;", AccessFlags = 9)]
				public static global::Android.Media.Rating NewUnratedRating(int ratingStyle) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Media.Rating);
				}

				/// <summary>
				///  <para>Return a Rating instance with a heart-based rating. Create and return a new Rating instance with a rating style of RATING_HEART, and a heart-based rating. </para>        
				/// </summary>
				/// <returns>
				///  <para>a new Rating instance. </para>
				/// </returns>
				/// <java-name>
				/// newHeartRating
				/// </java-name>
				[Dot42.DexImport("newHeartRating", "(Z)Landroid/media/Rating;", AccessFlags = 9)]
				public static global::Android.Media.Rating NewHeartRating(bool hasHeart) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Media.Rating);
				}

				/// <summary>
				///  <para>Return a Rating instance with a thumb-based rating. Create and return a new Rating instance with a RATING_THUMB_UP_DOWN rating style, and a "thumb up" or "thumb down" rating. </para>        
				/// </summary>
				/// <returns>
				///  <para>a new Rating instance. </para>
				/// </returns>
				...
				public static global::Android.Media.Rating NewThumbRating(bool thumbIsUp) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Media.Rating);
				}

				/// <summary>
				///  <para>Return a Rating instance with a star-based rating. Create and return a new Rating instance with one of the star-base rating styles and the given integer or fractional number of stars. Non integer values can for instance be used to represent an average rating value, which might not be an integer number of stars. </para>        
				/// </summary>
				/// <returns>
				///  <para>null if the rating style is invalid, or the rating is out of range, a new Rating instance otherwise. </para>
				/// </returns>
				/// <java-name>
				/// newStarRating
				/// </java-name>
				[Dot42.DexImport("newStarRating", "(IF)Landroid/media/Rating;", AccessFlags = 9)]
				public static global::Android.Media.Rating NewStarRating(int starRatingStyle, float starRating) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Media.Rating);
				}

				/// <summary>
				///  <para>Return a Rating instance with a percentage-based rating. Create and return a new Rating instance with a RATING_PERCENTAGE rating style, and a rating of the given percentage. </para>        
				/// </summary>
				/// <returns>
				///  <para>null if the rating is out of range, a new Rating instance otherwise. </para>
				/// </returns>
				/// <java-name>
				/// newPercentageRating
				/// </java-name>
				[Dot42.DexImport("newPercentageRating", "(F)Landroid/media/Rating;", AccessFlags = 9)]
				public static global::Android.Media.Rating NewPercentageRating(float percent) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Media.Rating);
				}

				/// <summary>
				///  <para>Return whether there is a rating value available. </para>        
				/// </summary>
				/// <returns>
				///  <para>true if the instance was not created with newUnratedRating(int). </para>
				/// </returns>
				/// <java-name>
				/// isRated
				/// </java-name>
				...
				/// <summary>
				///  <para>Return the rating style. </para>        
				/// </summary>
				/// <returns>
				///  <para>one of RATING_HEART, RATING_THUMB_UP_DOWN, RATING_3_STARS, RATING_4_STARS, RATING_5_STARS, or RATING_PERCENTAGE. </para>
				/// </returns>
				/// <java-name>
				/// getRatingStyle
				/// </java-name>
				...
				/// <summary>
				///  <para>Return whether the rating is "heart selected". </para>        
				/// </summary>
				/// <returns>
				///  <para>true if the rating is "heart selected", false if the rating is "heart unselected", if the rating style is not RATING_HEART or if it is unrated. </para>
				/// </returns>
				/// <java-name>
				/// hasHeart
				/// </java-name>
				...
				/// <summary>
				///  <para>Return whether the rating is "thumb up". </para>        
				/// </summary>
				/// <returns>
				///  <para>true if the rating is "thumb up", false if the rating is "thumb down", if the rating style is not RATING_THUMB_UP_DOWN or if it is unrated. </para>
				/// </returns>
				/// <java-name>
				/// isThumbUp
				/// </java-name>
				...
				/// <summary>
				///  <para>Return the star-based rating value. </para>        
				/// </summary>
				/// <returns>
				///  <para>a rating value greater or equal to 0.0f, or a negative value if the rating style is not star-based, or if it is unrated. </para>
				/// </returns>
				/// <java-name>
				/// getStarRating
				/// </java-name>
				...
				/// <summary>
				///  <para>Return the percentage-based rating value. </para>        
				/// </summary>
				/// <returns>
				///  <para>a rating value greater or equal to 0.0f, or a negative value if the rating style is not percentage-based, or if it is unrated. </para>
				/// </returns>
				/// <java-name>
				/// getPercentRating
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Flag indicating a RemoteControlClient makes use of the "previous" media key.</para> <para> <para>setTransportControlFlags(int) </para> <para>android.view.KeyEvent::KEYCODE_MEDIA_PREVIOUS </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Flag indicating a RemoteControlClient makes use of the "rewind" media key.</para> <para> <para>setTransportControlFlags(int) </para> <para>android.view.KeyEvent::KEYCODE_MEDIA_REWIND </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Flag indicating a RemoteControlClient makes use of the "play" media key.</para> <para> <para>setTransportControlFlags(int) </para> <para>android.view.KeyEvent::KEYCODE_MEDIA_PLAY </para></para>        
				/// </summary>
				/// <java-name>
				/// FLAG_KEY_MEDIA_PLAY
				/// </java-name>
				...
				/// <summary>
				///  <para>Flag indicating a RemoteControlClient makes use of the "play/pause" media key.</para> <para> <para>setTransportControlFlags(int) </para> <para>android.view.KeyEvent::KEYCODE_MEDIA_PLAY_PAUSE </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Flag indicating a RemoteControlClient makes use of the "pause" media key.</para> <para> <para>setTransportControlFlags(int) </para> <para>android.view.KeyEvent::KEYCODE_MEDIA_PAUSE </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Flag indicating a RemoteControlClient makes use of the "stop" media key.</para> <para> <para>setTransportControlFlags(int) </para> <para>android.view.KeyEvent::KEYCODE_MEDIA_STOP </para></para>        
				/// </summary>
				/// <java-name>
				/// FLAG_KEY_MEDIA_STOP
				/// </java-name>
				...
				/// <summary>
				///  <para>Flag indicating a RemoteControlClient makes use of the "fast forward" media key.</para> <para> <para>setTransportControlFlags(int) </para> <para>android.view.KeyEvent::KEYCODE_MEDIA_FAST_FORWARD </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Flag indicating a RemoteControlClient makes use of the "next" media key.</para> <para> <para>setTransportControlFlags(int) </para> <para>android.view.KeyEvent::KEYCODE_MEDIA_NEXT </para></para>        
				/// </summary>
				/// <java-name>
				/// FLAG_KEY_MEDIA_NEXT
				/// </java-name>
				...
				/// <summary>
				///  <para>Flag indicating a RemoteControlClient can receive changes in the media playback position through the OnPlaybackPositionUpdateListener interface. This flag must be set in order for components that display the RemoteControlClient information, to display and let the user control media playback position.  <para>setTransportControlFlags(int) </para> <para>setOnGetPlaybackPositionListener(OnGetPlaybackPositionListener) </para> <para>setPlaybackPositionUpdateListener(OnPlaybackPositionUpdateListener) </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Flag indicating a RemoteControlClient supports ratings. This flag must be set in order for components that display the RemoteControlClient information, to display ratings information, and, if ratings are declared editable (by calling MediaMetadataEditor#addEditableKey(int) with the MediaMetadataEditor#RATING_KEY_BY_USER key), it will enable the user to rate the media, with values being received through the interface set with setMetadataUpdateListener(OnMetadataUpdateListener).  <para>setTransportControlFlags(int) </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Class constructor.  <para>AudioManager::registerMediaButtonEventReceiver(ComponentName) </para> <para>AudioManager::registerRemoteControlClient(RemoteControlClient) </para></para>        
				/// </summary>
				...
				/// <summary>
				///  <para>Class constructor for a remote control client whose internal event handling happens on a user-provided Looper.  <para>AudioManager::registerMediaButtonEventReceiver(ComponentName) </para> <para>AudioManager::registerRemoteControlClient(RemoteControlClient) </para></para>        
				/// </summary>
				...
				/// <summary>
				///  <para>Sets the listener to be called whenever the metadata is updated. New metadata values will be received in the same thread as the one in which RemoteControlClient was created. </para>        
				/// </summary>
				/// <java-name>
				...
				public virtual void SetMetadataUpdateListener(global::Android.Media.RemoteControlClient.IOnMetadataUpdateListener l) /* MethodBuilder.Create */ 
				{
				}
				...
				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				protected internal RemoteControlClient() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
				...
				/// <summary>
				///  <para>Interface definition for a callback to be invoked when one of the metadata values has been updated. Implement this interface to receive metadata updates after registering your listener through RemoteControlClient#setMetadataUpdateListener(OnMetadataUpdateListener). </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						/// <summary>
						///  <para>Called on the implementer to notify that the metadata field for the given key has been updated to the new value. </para>        
						/// </summary>
						/// <java-name>
						/// onMetadataUpdate
						/// </java-name>
						[Dot42.DexImport("onMetadataUpdate", "(ILjava/lang/Object;)V", AccessFlags = 1025)]
						void OnMetadataUpdate(int key, object newValue) /* MethodBuilder.Create */ ;
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>Clears all the metadata that has been set since the MetadataEditor instance was created (with RemoteControlClient#editMetadata(boolean)). Note that clearing the metadata doesn't reset the editable keys (use MediaMetadataEditor#removeEditableKeys() instead). </para>        
						/// </summary>
						/// <java-name>
						/// clear
						/// </java-name>
						...
						[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
						protected internal MetadataEditor() /* TypeBuilder.AddDefaultConstructor */ 
						{
						}
		...
		/// <summary>
		///  <para>The RemoteController class is used to control media playback, display and update media metadata and playback status, published by applications using the RemoteControlClient class. </para> <para>A RemoteController shall be registered through AudioManager#registerRemoteController(RemoteController) in order for the system to send media event updates to the OnClientUpdateListener listener set in the class constructor. Implement the methods of the interface to receive the information published by the active RemoteControlClient instances.  <br></br>By default an OnClientUpdateListener implementation will not receive bitmaps for album art. Use setArtworkConfiguration(int, int) to receive images as well. </para> <para>Registration requires the OnClientUpdateListener listener to be one of the enabled notification listeners (see android.service.notification.NotificationListenerService). </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>Default playback position synchronization mode where the RemoteControlClient is not asked regularly for its playback position to see if it has drifted from the estimated position. </para>        
				/// </summary>
				/// <java-name>
    ...
    ")V", AccessFlags = 1)]
				public RemoteController(global::Android.Content.Context context, global::Android.Media.RemoteController.IOnClientUpdateListener updateListener) /* MethodBuilder.Create */ 
				{
				}
    ...
    "Landroid/os/Looper;)V", AccessFlags = 1)]
				public RemoteController(global::Android.Content.Context context, global::Android.Media.RemoteController.IOnClientUpdateListener updateListener, global::Android.OS.Looper looper) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Send a simulated key event for a media button to be received by the current client. To simulate a key press, you must first send a KeyEvent built with a KeyEvent#ACTION_DOWN action, then another event with the KeyEvent#ACTION_UP action. </para> <para>The key event will be sent to the registered receiver (see AudioManager#registerMediaButtonEventReceiver(PendingIntent)) whose associated RemoteControlClient's metadata and playback state is published (there may be none under some circumstances). </para>        
				/// </summary>
				/// <returns>
				///  <para>true if the event was successfully sent, false otherwise. </para>
				/// </returns>
				/// <java-name>
				/// sendMediaKeyEvent
				/// </java-name>
				[Dot42.DexImport("sendMediaKeyEvent", "(Landroid/view/KeyEvent;)Z", AccessFlags = 1)]
				public bool SendMediaKeyEvent(global::Android.Views.KeyEvent keyEvent) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				///  <para>Sets the new playback position. This method can only be called on a registered RemoteController. </para>        
				/// </summary>
				/// <returns>
				///  <para>true if the command to set the playback position was successfully sent. </para>
				/// </returns>
				/// <java-name>
				/// seekTo
				/// </java-name>
				[Dot42.DexImport("seekTo", "(J)Z", AccessFlags = 1)]
				public bool SeekTo(long timeMs) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				///  <para>Set the maximum artwork image dimensions to be received in the metadata. No bitmaps will be received unless this has been specified. </para>        
				/// </summary>
				/// <returns>
				///  <para>true if the artwork dimension was successfully set. </para>
				/// </returns>
				/// <java-name>
				/// setArtworkConfiguration
				/// </java-name>
				[Dot42.DexImport("setArtworkConfiguration", "(II)Z", AccessFlags = 1)]
				public bool SetArtworkConfiguration(int width, int height) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				///  <para>Prevents this RemoteController from receiving artwork images. </para>        
				/// </summary>
				/// <returns>
				///  <para>true if receiving artwork images was successfully disabled. </para>
				/// </returns>
				/// <java-name>
				...
				/// <summary>
				///  <para>Set the playback position synchronization mode. Must be called on a registered RemoteController. </para>        
				/// </summary>
				/// <returns>
				///  <para>true if the synchronization mode was successfully set. </para>
				/// </returns>
				/// <java-name>
				/// setSynchronizationMode
				/// </java-name>
				[Dot42.DexImport("setSynchronizationMode", "(I)Z", AccessFlags = 1)]
				public bool SetSynchronizationMode(int sync) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}

				/// <summary>
				///  <para>Creates a MetadataEditor for updating metadata values of the editable keys of the current RemoteControlClient. This method can only be called on a registered RemoteController. </para>        
				/// </summary>
				/// <returns>
				///  <para>a new MetadataEditor instance. </para>
				/// </returns>
				...
				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				protected internal RemoteController() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}

				/// <summary>
				///  <para>Return the estimated playback position of the current media track or a negative value if not available.</para> <para>The value returned is estimated by the current process and may not be perfect. The time returned by this method is calculated from the last state change time based on the current play position at that time and the last known playback speed. An application may call setSynchronizationMode(int) to apply a synchronization policy that will periodically re-sync the estimated position with the RemoteControlClient.</para> <para> <para>OnClientUpdateListener::onClientPlaybackStateUpdate(int, long, long, float) </para></para>        
				/// </summary>
				/// <returns>
				///  <para>the current estimated playback position in milliseconds or a negative value if not available</para>
				/// </returns>
				/// <java-name>
				...
				/// <summary>
				///  <para>A class to read the metadata published by a RemoteControlClient, or send a RemoteControlClient new values for keys that can be edited. </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>Applies all of the metadata changes that have been set since the MediaMetadataEditor instance was created with RemoteController#editMetadata() or since clear() was called. </para>        
						/// </summary>
						/// <java-name>
						/// apply
						/// </java-name>
				...
				/// <summary>
				///  <para>Interface definition for the callbacks to be invoked whenever media events, metadata and playback status are available. </para>    
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						/// <summary>
						///  <para>Called whenever all information, previously received through the other methods of the listener, is no longer valid and is about to be refreshed. This is typically called whenever a new RemoteControlClient has been selected by the system to have its media information published. </para>        
						/// </summary>
						/// <java-name>
						/// onClientChange
						/// </java-name>
						[Dot42.DexImport("onClientChange", "(Z)V", AccessFlags = 1025)]
						void OnClientChange(bool clearing) /* MethodBuilder.Create */ ;

						/// <summary>
						///  <para>Called whenever the playback state has changed. It is called when no information is known about the playback progress in the media and the playback speed. </para>        
						/// </summary>
						/// <java-name>
						/// onClientPlaybackStateUpdate
						/// </java-name>
						[Dot42.DexImport("onClientPlaybackStateUpdate", "(I)V", AccessFlags = 1025)]
						void OnClientPlaybackStateUpdate(int state) /* MethodBuilder.Create */ ;

						/// <summary>
						///  <para>Called whenever the playback state has changed, and playback position and speed are known. </para>        
						/// </summary>
						/// <java-name>
						/// onClientPlaybackStateUpdate
						/// </java-name>
						[Dot42.DexImport("onClientPlaybackStateUpdate", "(IJJF)V", AccessFlags = 1025)]
						void OnClientPlaybackStateUpdate(int state, long stateChangeTimeMs, long currentPosMs, float speed) /* MethodBuilder.Create */ ;

						/// <summary>
						///  <para>Called whenever the transport control flags have changed. </para>        
						/// </summary>
						/// <java-name>
						/// onClientTransportControlUpdate
						/// </java-name>
						[Dot42.DexImport("onClientTransportControlUpdate", "(I)V", AccessFlags = 1025)]
						void OnClientTransportControlUpdate(int transportControlFlags) /* MethodBuilder.Create */ ;

						/// <summary>
						///  <para>Called whenever new metadata is available. See the MediaMetadataEditor#putLong(int, long), MediaMetadataEditor#putString(int, String), MediaMetadataEditor#putBitmap(int, Bitmap), and MediaMetadataEditor#putObject(int, Object) methods for the various keys that can be queried. </para>        
						/// </summary>
						/// <java-name>
		...
		/// <summary>
		///  <para>Exception thrown when an operation on a MediaDrm object is attempted and hardware resources are not available, due to being in use. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				[Dot42.DexImport("<init>", "(Ljava/lang/String;)V", AccessFlags = 1)]
				public ResourceBusyException(string detailMessage) /* MethodBuilder.Create */ 
				{
				}

				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				protected internal ResourceBusyException() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
				protected internal UnsupportedSchemeException() /* TypeBuilder.AddDefaultConstructor */ 
				{
				}
