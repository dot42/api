...
namespace Android.Speech.Tts
{
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>Contains data required by engines to synthesize speech. This data is :  <ul> <li> <para>The text to synthesize </para></li> <li> <para>The synthesis locale, represented as a language, country and a variant. The language is an ISO 639-3 letter language code, and the country is an ISO 3166 alpha 3 code. The variant is not specified. </para></li> <li> <para>The synthesis speech rate, with 100 being the normal, and higher values representing higher speech rates. </para></li> <li> <para>The voice pitch, with 100 being the default pitch. </para></li></ul></para> <para>Any additional parameters sent to the text to speech service are passed in uninterpreted, see the <c>params </c> argument in TextToSpeech#speak and TextToSpeech#synthesizeToFile. </para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				public SynthesisRequest(string text, global::Android.OS.Bundle @params) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				///  <para>Gets the text which should be synthesized. </para>        
				/// </summary>
				/// <java-name>
				/// getText
				/// </java-name>
				...
				/// <summary>
				///  <para>Gets the ISO 3-letter language code for the language to use. </para>        
				/// </summary>
				/// <java-name>
				/// getLanguage
				/// </java-name>
				...
				/// <summary>
				///  <para>Gets the ISO 3-letter country code for the language to use. </para>        
				/// </summary>
				/// <java-name>
				/// getCountry
				/// </java-name>
				...
				/// <summary>
				///  <para>Gets the language variant to use. </para>        
				/// </summary>
				/// <java-name>
				/// getVariant
				/// </java-name>
				...
				/// <summary>
				///  <para>Gets the speech rate to use. The normal rate is 100. </para>        
				/// </summary>
				/// <java-name>
				/// getSpeechRate
				/// </java-name>
				...
				/// <summary>
				///  <para>Gets the pitch to use. The normal pitch is 100. </para>        
				/// </summary>
				/// <java-name>
				/// getPitch
				/// </java-name>
				...
				/// <summary>
				///  <para>Gets the additional params, if any. </para>        
				/// </summary>
				/// <java-name>
				/// getParams
				/// </java-name>
				...
				/// <summary>
				///  <para>Gets the request caller Uid. </para>        
				/// </summary>
				/// <java-name>
				/// getCallerUid
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "/lang/String;)I")]
				...
				/// getDefaultLanguage
				/// </java-name>
				public virtual global::Java.Util.Locale DefaultLanguage
				{
				...
				/// <summary>
				///  <para>Limit of length of input string passed to speak and synthesizeToFile.</para> <para> <para>speak </para> <para>synthesizeToFile </para></para>        
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>Parameter key to specify the speech volume relative to the current stream type volume used when speaking text. Volume is specified as a float ranging from 0 to 1 where 0 is silence, and 1 is the maximum volume (the default behavior).</para> <para> <para>TextToSpeech::speak(String, int, HashMap) </para> <para>TextToSpeech::playEarcon(String, int, HashMap) </para></para>        
						/// </summary>
						/// <java-name>
						/// KEY_PARAM_VOLUME
						/// </java-name>
						...
						/// <summary>
						///  <para>Parameter key to specify how the speech is panned from left to right when speaking text. Pan is specified as a float ranging from -1 to +1 where -1 maps to a hard-left pan, 0 to center (the default behavior), and +1 to hard-right.</para> <para> <para>TextToSpeech::speak(String, int, HashMap) </para> <para>TextToSpeech::playEarcon(String, int, HashMap) </para></para>        
						/// </summary>
						/// <java-name>
						/// KEY_PARAM_PAN
						/// </java-name>
						...
						/// <summary>
						///  <para>Feature key for embedded synthesis. See TextToSpeech#getFeatures(Locale) for a description of how feature keys work. If set and supported by the engine as per TextToSpeech#getFeatures(Locale), the engine must synthesize text on-device (without making network requests).</para> <para> <para>TextToSpeech::speak(String, int, java.util.HashMap) </para> <para>TextToSpeech::synthesizeToFile(String, java.util.HashMap, String) </para> <para>TextToSpeech::getFeatures(java.util.Locale) </para></para>        
						/// </summary>
						/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns the language, country and variant currently being used by the TTS engine.</para> <para>Can be called on multiple threads.</para> <para> <para>Locale::getISO3Language() </para> <para>Locale::getISO3Country() </para> <para>Locale::getVariant() </para></para>        
				/// </summary>
				/// <returns>
