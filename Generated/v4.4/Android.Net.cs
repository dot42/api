 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </java-name>
				public virtual bool IsActiveNetworkMetered
				{
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Sequential packet socket type </para>        
				/// </summary>
				/// <java-name>
				/// SOCKET_SEQPACKET
				/// </java-name>
				...
				/// <summary>
				///  <para>Creates a AF_LOCAL/UNIX domain stream socket with given socket type</para> <para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "(I)V", AccessFlags = 1)]
				public LocalSocket(int sockType) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Tag the given Socket with any statistics parameters active for the current thread. Subsequent calls always replace any existing parameters. When finished, call untagSocket(Socket) to remove statistics parameters.</para> <para> <para>setThreadStatsTag(int) </para> <para>setThreadStatsUid(int) </para></para>        
				/// </summary>
				/// <java-name>
				/// tagSocket
				/// </java-name>
				...
				/// <summary>
				///  <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Starting in android.os.Build.VERSION_CODES#JELLY_BEAN_MR2, transport layer statistics are no longer available, and will always return UNSUPPORTED.  <para>getUidTxBytes(int) </para></para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// getUidTcpTxBytes
				/// </java-name>
				...
				/// <summary>
				///  <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Starting in android.os.Build.VERSION_CODES#JELLY_BEAN_MR2, transport layer statistics are no longer available, and will always return UNSUPPORTED.  <para>getUidRxBytes(int) </para></para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// getUidTcpRxBytes
				/// </java-name>
				...
				/// <summary>
				///  <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Starting in android.os.Build.VERSION_CODES#JELLY_BEAN_MR2, transport layer statistics are no longer available, and will always return UNSUPPORTED.  <para>getUidTxPackets(int) </para></para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// getUidTcpTxSegments
				/// </java-name>
				...
				/// <summary>
				///  <para> <xrefsect> <xreftitle>Deprecated</xreftitle> <xrefdescription> <para>Starting in android.os.Build.VERSION_CODES#JELLY_BEAN_MR2, transport layer statistics are no longer available, and will always return UNSUPPORTED.  <para>getUidRxPackets(int) </para></para></xrefdescription></xrefsect></para>        
				/// </summary>
				/// <java-name>
				/// getUidTcpRxSegments
				/// </java-name>
