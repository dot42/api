...
{
		/// <summary>
		///  <para>A class for storing Bonjour service information that is advertised over a Wi-Fi peer-to-peer setup.</para> <para>{ <para>android.net.wifi.p2p.WifiP2pManager::addLocalService} {</para> <para>android.net.wifi.p2p.WifiP2pManager::removeLocalService} {</para> <para>WifiP2pServiceInfo} {</para> <para>WifiP2pUpnpServiceInfo} </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "String;>;)Landroid/net/wifi/p2p/nsd/WifiP2pDnsSdServiceInfo;")]
		...
		/// <summary>
		///  <para>A class for creating a Bonjour service discovery request for use with WifiP2pManager#addServiceRequest and WifiP2pManager#removeServiceRequest</para> <para>{ <para>WifiP2pManager} {</para> <para>WifiP2pServiceRequest} {</para> <para>WifiP2pUpnpServiceRequest} </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "ceRequest;", AccessFlags = 9)]
		...
		/// <summary>
		///  <para>A class for storing service information that is advertised over a Wi-Fi peer-to-peer setup</para> <para> <para>WifiP2pUpnpServiceInfo </para> <para>WifiP2pDnsSdServiceInfo </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>A class for storing Upnp service information that is advertised over a Wi-Fi peer-to-peer setup.</para> <para>{ <para>android.net.wifi.p2p.WifiP2pManager::addLocalService} {</para> <para>android.net.wifi.p2p.WifiP2pManager::removeLocalService} {</para> <para>WifiP2pServiceInfo} {</para> <para>WifiP2pDnsSdServiceInfo} </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "d/net/wifi/p2p/nsd/WifiP2pUpnpServiceInfo;")]
		...
		/// <summary>
		///  <para>A class for creating a Upnp service discovery request for use with WifiP2pManager#addServiceRequest and WifiP2pManager#removeServiceRequest</para> <para>{ <para>WifiP2pManager} {</para> <para>WifiP2pServiceRequest} {</para> <para>WifiP2pDnsSdServiceRequest} </para></para>    
		/// </summary>
		/// <java-name>
