 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns a string describing this buffer. </para>        
				/// </summary>
				/// <java-name>
				/// toString
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns a duplicated buffer that shares its content with this buffer. </para> <para>The duplicated buffer's position, limit, capacity and mark are the same as this buffer's. The duplicated buffer's read-only property is the same as this buffer's.</para> <para>Note that  <b>in contrast to all non- <c>byte </c> buffers</b>, byte order is not preserved in the duplicate, and is instead set to big-endian.</para> <para>The new buffer shares its content with this buffer, which means either buffer's change of content will be visible to the other. The two buffers' position, limit and mark are independent. </para>        
				/// </summary>
				/// <java-name>
				/// duplicate
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Flushes changes made to the in-memory buffer back to the mapped file. Unless you call this, changes may not be written back until the finalizer runs. This method waits for the write to complete before returning.</para> <para></para>        
				/// </summary>
				/// <returns>
				///  <para>this buffer. </para>
				/// </returns>
