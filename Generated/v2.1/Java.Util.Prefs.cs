...
namespace Java.Util.Prefs
{
 ...
 /* scope: __dot42__ */ 
		{
				...
				public override global::Java.Util.Prefs.Preferences Node(string name) /* MethodBuilder.Create */ 
				{
				...
				public override bool NodeExists(string name) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>This interface is used to handle preference node change events. The implementation of this interface can be installed by the <c>Preferences </c> instance.</para> <para> <para>Preferences </para> <para>NodeChangeEvent</para> <para>1.4 </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>This interface is used to handle preferences change events. The implementation of this interface can be installed by the <c>Preferences </c> instance.</para> <para> <para>Preferences </para> <para>PreferenceChangeEvent</para> <para>1.4 </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>This is the event class to indicate that a preference has been added, deleted or updated. </para> <para>Please note that although the class is marked as <c>Serializable </c> by inheritance from <c>EventObject </c> , this type is not intended to be serialized so the serialization methods do nothing but throw a <c>NotSerializableException </c> .</para> <para> <para>java.util.prefs.Preferences </para> <para>java.util.prefs.PreferenceChangeListener</para> <para>1.4 </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns a string representation of this node. The format is "User/SystemPreference Node: " followed by this node's absolute path.</para> <para></para>        
				/// </summary>
				/// <returns>
