...
{
		/// <summary>
		///  <para>Utility class to contain basic XML values as constants.</para> <para> <para> </para> <para></para> <title>Revision</title> <para>584477 </para>,  <title>Date</title> <para>2007-10-13 19:44:03 -0700 (Sat, 13 Oct 2007) </para> <para> </para> <para> </para> <para> </para> <para> </para> <para> </para> <para> </para> <para> </para> <para>1.5 </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>The official XML attribute used for specifying XML Namespace declarations, XMLConstants.XMLNS_ATTRIBUTE, Namespace name URI.</para> <para>Defined by the XML specification to be "&lt;code&gt;http://www.w3.org/2000/xmlns/&lt;/code&gt;".</para> <para> <para> </para> <para> </para></para>        
				/// </summary>
				/// <java-name>
