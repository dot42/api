 ...
 /* scope: __dot42__ */ 
				{
						...
						/// <summary>
						///  <para>The resource name of the label describing the source of the status update, e.g. "GoogleTalk". This resource should be scoped by the RES_PACKAGE. As this can only reference strings, the "@string/" prefix must be omitted. </para> <para>Type: TEXT</para>        
						/// </summary>
						/// <java-name>
						/// RES_LABEL
						/// </java-name>
