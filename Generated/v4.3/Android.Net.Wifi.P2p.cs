 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>The lookup key for an int that indicates whether p2p discovery has started or stopped. Retrieve it with android.content.Intent#getIntExtra(String,int).</para> <para> <para>WIFI_P2P_DISCOVERY_STARTED </para> <para>WIFI_P2P_DISCOVERY_STOPPED </para></para>        
				/// </summary>
				/// <java-name>
