...
namespace Android.Service.Dreams
{
		...
		///     android:label="@string/my_dream_label" &gt;</pre></para> <para> <pre>    &lt;intent-filter&gt;
		///         &lt;action android:name="android.service.dreams.DreamService" /&gt;
		///         &lt;category android:name="android.intent.category.DEFAULT" /&gt;
		///     &lt;/intent-filter&gt;</pre></para> <para> <pre>    &lt;!-- Point to additional information for this dream (optional) --&gt;
		///     &lt;meta-data
		...
		/// public class MyDream extends DreamService {</pre></para> <para> <pre>    &amp;#64;Override
		///     public void onAttachedToWindow() {
		///         super.onAttachedToWindow();</pre></para> <para> <pre>        // Exit dream upon user touch
		...
		public partial class DreamService : global::Android.App.Service, global::Android.Views.Window.ICallback
 /* scope: __dot42__ */ 
		{
				/// <summary>
				...
				public virtual bool DispatchGenericMotionEvent(global::Android.Views.MotionEvent @event) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public virtual void OnWindowAttributesChanged(global::Android.Views.IWindowManager_LayoutParams attrs) /* MethodBuilder.Create */ 
				{
				}
				...
				protected internal override void Dump(global::Java.IO.FileDescriptor fd, global::Java.IO.PrintWriter pw, string[] args) /* MethodBuilder.Create */ 
				{
				}
				...
				/// isScreenBright
				/// </java-name>
				public virtual bool IsScreenBright
				{
