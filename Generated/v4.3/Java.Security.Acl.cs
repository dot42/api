...
namespace Java.Security.Acl
{
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>The interface to manage owners of objects that require ownership.</para> <para> <para>Acl </para> <para>Principal </para></para>    
		/// </summary>
		/// <java-name>
 ...
 /* scope: __dot42__ */ 
		...
		/// <summary>
		///  <para>The exception that is thrown when an action that requires ownership is attempted by a principal that is not an owner of the object for which ownership is required.</para> <para> <para>Acl </para> <para>Owner </para></para>    
		/// </summary>
		/// <java-name>
