 ...
 /* scope: __dot42__ */ 
		{
				...
				protected internal virtual bool OnKeyEvent(global::Android.Views.KeyEvent @event) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns the bit mask of capabilities this accessibility service has such as being able to retrieve the active window content, etc.</para> <para> <para>CAPABILITY_CAN_RETRIEVE_WINDOW_CONTENT </para> <para>CAPABILITY_CAN_REQUEST_TOUCH_EXPLORATION </para> <para>CAPABILITY_CAN_REQUEST_ENHANCED_WEB_ACCESSIBILITY </para> <para>#CAPABILITY_FILTER_KEY_EVENTS </para></para>        
				/// </summary>
				/// <returns>
