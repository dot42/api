...
namespace Org.Xml.Sax.Ext
{
 ...
 /* scope: __dot42__ */ 
    ...
    "ng/String;)V", AccessFlags = 1)]
				...
				/// <summary>
				///  <para>Report a parsed external entity declaration.</para> <para>Only the effective (first) declaration for each entity will be reported.</para> <para>If the system identifier is a URL, the parser must resolve it fully before passing it to the application.</para> <para> <para>internalEntityDecl </para> <para>org.xml.sax.DTDHandler::unparsedEntityDecl </para></para>        
				/// </summary>
				/// <java-name>
				/// externalEntityDecl
				/// </java-name>
				...
				/// <summary>
				///  <para>Report an internal entity declaration.</para> <para>Only the effective (first) declaration for each entity will be reported. All parameter entities in the value will be expanded, but general entities will not.</para> <para> <para>externalEntityDecl </para> <para>org.xml.sax.DTDHandler::unparsedEntityDecl </para></para>        
				/// </summary>
				/// <java-name>
				/// internalEntityDecl
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// </summary>
				/// <returns>
				///  <para>Name of the character encoding being used to interpret * the entity's text, or null if this was not provided for a * character stream passed through an InputSource or is otherwise not yet available in the current parsing state. </para>
				/// </returns>
				/// <java-name>
				/// getEncoding
				/// </java-name>
