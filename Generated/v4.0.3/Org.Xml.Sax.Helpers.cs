...
namespace Org.Xml.Sax.Helpers
{
		...
		/// private AttributeList myatts;</pre></para> <para> <pre>public void startElement (String name, AttributeList atts)
		/// {
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>Create an empty attribute list.</para> <para>This constructor is most useful for parser writers, who will use it to create a single, reusable attribute list that can be reset with the clear method between elements.</para> <para> <para>addAttribute </para> <para>clear </para></para>        
				/// </summary>
				...
				/// <summary>
				///  <para>Add an attribute to an attribute list.</para> <para>This method is provided for SAX parser writers, to allow them to build up an attribute list incrementally before delivering it to the application.</para> <para> <para>removeAttribute </para> <para>org.xml.sax.DocumentHandler::startElement </para></para>        
				/// </summary>
				/// <java-name>
				/// addAttribute
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
    ...
    "", AccessFlags = 1)]
		...
		///   Locator locator;
		///   Locator startloc;</pre></para> <para> <pre>  public void setLocator (Locator locator)
		///   {
		///           // note the locator
		///     this.locator = locator;
		///   }</pre></para> <para> <pre>  public void startDocument ()
		///   {
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Return the saved public identifier.</para> <para> <para>org.xml.sax.Locator::getPublicId </para> <para>setPublicId </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Return the saved system identifier.</para> <para> <para>org.xml.sax.Locator::getSystemId </para> <para>setSystemId </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Return the saved line number (1-based).</para> <para> <para>org.xml.sax.Locator::getLineNumber </para> <para>setLineNumber </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Return the saved column number (1-based).</para> <para> <para>org.xml.sax.Locator::getColumnNumber </para> <para>setColumnNumber </para></para>        
				/// </summary>
				/// <returns>
		...
		/// NamespaceSupport support = new NamespaceSupport();</pre></para> <para> <pre>support.pushContext();
		/// support.declarePrefix("", "http://www.w3.org/1999/xhtml");
		/// support.declarePrefix("dc", "http://www.purl.org/dc#");</pre></para> <para> <pre>parts = support.processName("p", parts, false);
		/// System.out.println("Namespace URI: " + parts[0]);
		/// System.out.println("Local name: " + parts[1]);
		/// System.out.println("Raw name: " + parts[2]);</pre></para> <para> <pre>parts = support.processName("dc:title", parts, false);
		/// System.out.println("Namespace URI: " + parts[0]);
		/// System.out.println("Local name: " + parts[1]);
		/// System.out.println("Raw name: " + parts[2]);</pre></para> <para> <pre>support.popContext();
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Look up a prefix and get the currently-mapped Namespace URI.</para> <para>This method looks up the prefix in the current context. Use the empty string ("") for the default Namespace.</para> <para> <para>getPrefix </para> <para>getPrefixes </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Return an enumeration of all prefixes for a given URI whose declarations are active in the current context. This includes declarations from parent contexts that have not been overridden.</para> <para>This method returns prefixes mapped to a specific Namespace URI. The xml: prefix will be included. If you want only one prefix that's mapped to the Namespace URI, and you don't care which one you get, use the getPrefix method instead.</para> <para> <b>Note:</b> the empty (default) prefix is  <b>never</b> included in this enumeration; to check for the presence of a default Namespace, use the getURI method with an argument of "".</para> <para> <para>getPrefix </para> <para>getDeclaredPrefixes </para> <para>getURI </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Return an enumeration of all prefixes declared in this context.</para> <para>The empty (default) prefix will be included in this enumeration; note that this behaviour differs from that of getPrefix and getPrefixes.</para> <para> <para>getPrefixes </para> <para>getURI </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Parse an XML document.</para> <para> <para>parse(java.lang.String) </para> <para>org.xml.sax.Parser::parse(org.xml.sax.InputSource) </para></para>        
				/// </summary>
				/// <java-name>
				/// parse
				/// </java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Create a new SAX parser using the `org.xml.sax.parser' system property.</para> <para>The named class must exist and must implement the Parser interface.</para> <para> <para>makeParser(java.lang.String) </para> <para>org.xml.sax.Parser </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Create a new SAX parser object using the class name provided.</para> <para>The named class must exist and must implement the Parser interface.</para> <para> <para>makeParser() </para> <para>org.xml.sax.Parser </para></para>        
				/// </summary>
				/// <returns>
				///  <para>the newly created parser.</para>
				/// </returns>
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>Construct an empty XML filter, with no parent.</para> <para>This filter will have no parent: you must assign a parent before you start a parse or do any configuration with setFeature or setProperty, unless you use this as a pure event consumer rather than as an XMLReader.</para> <para> <para>org.xml.sax.XMLReader::setFeature </para> <para>org.xml.sax.XMLReader::setProperty </para> <para>setParent </para></para>        
				/// </summary>
				[Dot42.DexImport("<init>", "()V", AccessFlags = 1)]
				...
				/// <summary>
				///  <para>Construct an XML filter with the specified parent.</para> <para> <para>setParent </para> <para>getParent </para></para>        
				/// </summary>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Parse the document.</para> <para>This method will throw an exception if the embedded XMLReader does not support the  property.</para> <para> <para>parse(java.lang.String) </para> <para>org.xml.sax.Parser::parse(org.xml.sax.InputSource) </para></para>        
				/// </summary>
				/// <java-name>
				/// parse
				/// </java-name>
