 ...
 /* scope: __dot42__ */ 
		{
				...
				protected internal override void ApplyTransformation(float interpolatedTime, global::Android.Views.Animations.Transformation t) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Cancel the animation. Cancelling an animation invokes the animation listener, if set, to notify the end of the animation.</para> <para>If you cancel an animation manually, you must call reset() before starting the animation again.</para> <para> <para>reset() </para> <para>start() </para> <para>startNow() </para></para>        
				/// </summary>
				/// <java-name>
				/// cancel
				/// </java-name>
				...
				public virtual void SetAnimationListener(global::Android.Views.Animations.Animation.IAnimationListener listener) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual bool GetTransformation(long currentTime, global::Android.Views.Animations.Transformation outTransformation) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				public virtual bool GetTransformation(long currentTime, global::Android.Views.Animations.Transformation outTransformation, float scale) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
				...
				/// </java-name>
				[Dot42.DexImport("applyTransformation", "(FLandroid/view/animation/Transformation;)V", AccessFlags = 4)]
				protected internal virtual void ApplyTransformation(float interpolatedTime, global::Android.Views.Animations.Transformation t) /* MethodBuilder.Create */ 
				{
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				public virtual void AddAnimation(global::Android.Views.Animations.Animation a) /* MethodBuilder.Create */ 
				{
				}
				...
				/// </java-name>
				[Dot42.DexImport("getTransformation", "(JLandroid/view/animation/Transformation;)Z", AccessFlags = 1)]
				public override bool GetTransformation(long currentTime, global::Android.Views.Animations.Transformation t) /* MethodBuilder.Create */ 
				{
						return default(bool);
				}
 ...
 /* scope: __dot42__ */ 
		{
				...
				public static global::Android.Views.Animations.Animation LoadAnimation(global::Android.Content.Context context, int id) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Views.Animations.Animation);
				}
				...
				public static global::Android.Views.Animations.LayoutAnimationController LoadLayoutAnimation(global::Android.Content.Context context, int id) /* MethodBuilder.Create */ 
				{
				...
				public static global::Android.Views.Animations.Animation MakeInAnimation(global::Android.Content.Context c, bool fromLeft) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Views.Animations.Animation);
				}
				...
				public static global::Android.Views.Animations.Animation MakeOutAnimation(global::Android.Content.Context c, bool toRight) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Views.Animations.Animation);
				}
				...
				public static global::Android.Views.Animations.Animation MakeInChildBottomAnimation(global::Android.Content.Context c) /* MethodBuilder.Create */ 
				{
						return default(global::Android.Views.Animations.Animation);
				}
				...
				public static global::Android.Views.Animations.IInterpolator LoadInterpolator(global::Android.Content.Context context, int id) /* MethodBuilder.Create */ 
				{
 ...
 /* scope: __dot42__ */ 
		{
				...
				public GridLayoutAnimationController(global::Android.Views.Animations.Animation animation, float columnDelay, float rowDelay) /* MethodBuilder.Create */ 
				{
				}
				...
				/// <summary>
				///  <para>Returns the delay by which the children's animation are offset from one column to the other. The delay is expressed as a fraction of the animation duration.</para> <para> <para>setColumnDelay(float) </para> <para>getRowDelay() </para> <para>setRowDelay(float) </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns the delay by which the children's animation are offset from one row to the other. The delay is expressed as a fraction of the animation duration.</para> <para> <para>setRowDelay(float) </para> <para>getColumnDelay() </para> <para>setColumnDelay(float) </para></para>        
				/// </summary>
				/// <returns>
				///  <para>a fraction of the animation duration</para>
				/// </returns>
				...
				/// <summary>
				///  <para>Returns the direction of the animation. DIRECTION_HORIZONTAL_MASK and DIRECTION_VERTICAL_MASK can be used to retrieve the horizontal and vertical components of the direction.</para> <para> <para>setDirection(int) </para> <para>DIRECTION_BOTTOM_TO_TOP </para> <para>DIRECTION_TOP_TO_BOTTOM </para> <para>DIRECTION_LEFT_TO_RIGHT </para> <para>DIRECTION_RIGHT_TO_LEFT </para> <para>DIRECTION_HORIZONTAL_MASK </para> <para>DIRECTION_VERTICAL_MASK </para></para>        
				/// </summary>
				/// <returns>
				...
				/// <summary>
				///  <para>Returns the direction priority for the animation. The priority can be either PRIORITY_NONE, PRIORITY_COLUMN or PRIORITY_ROW.</para> <para> <para>setDirectionPriority(int) </para> <para>PRIORITY_COLUMN </para> <para>PRIORITY_NONE </para> <para>PRIORITY_ROW </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				public LayoutAnimationController(global::Android.Views.Animations.Animation context, float attrs) /* MethodBuilder.Create */ 
				{
				}

				/// <summary>
				///  <para>Sets the animation to be run on each child of the view group on which this layout animation controller is .</para> <para> <para>setAnimation(Animation) </para> <para>getAnimation()</para>ref android.R.styleable::LayoutAnimation_animation </para>        
				/// </summary>
				/// <java-name>
				/// setAnimation
				/// </java-name>
				...
				/// <summary>
				///  <para>Sets the interpolator used to interpolate the delays between the children.</para> <para> <para>getInterpolator() </para> <para>setInterpolator(Interpolator)</para>ref android.R.styleable::LayoutAnimation_interpolator </para>        
				/// </summary>
				/// <java-name>
				/// setInterpolator
				/// </java-name>
				...
				protected internal virtual int GetTransformedIndex(global::Android.Views.Animations.LayoutAnimationController.AnimationParameters @params) /* MethodBuilder.Create */ 
				{
						return default(int);
				}
				...
				/// <summary>
				///  <para>Returns the animation applied to each child of the view group on which this controller is set.</para> <para> <para>setAnimation(android.content.Context, int) </para> <para>setAnimation(Animation) </para></para>        
				/// </summary>
				/// <returns>
 ...
 /* scope: __dot42__ */ 
		{
				...
				public virtual void Set(global::Android.Views.Animations.Transformation t) /* MethodBuilder.Create */ 
				{
				}
				...
				public virtual void Compose(global::Android.Views.Animations.Transformation t) /* MethodBuilder.Create */ 
				{
				}
