...
namespace Android.Hardware.Usb
{
 ...
 /* scope: __dot42__ */ 
		{
				/// <summary>
				///  <para>Bitmask used for extracting the UsbEndpoint direction from its address field.  <para>UsbEndpoint::getAddress </para> <para>UsbEndpoint::getDirection </para> <para>USB_DIR_OUT </para> <para>USB_DIR_IN </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Bitmask used for extracting the UsbEndpoint number its address field.  <para>UsbEndpoint::getAddress </para> <para>UsbEndpoint::getEndpointNumber </para></para>        
				/// </summary>
				/// <java-name>
				...
				/// <summary>
				///  <para>Bitmask used for extracting the UsbEndpoint type from its address field.  <para>UsbEndpoint::getAddress </para> <para>UsbEndpoint::getType </para> <para>USB_ENDPOINT_XFER_CONTROL </para> <para>USB_ENDPOINT_XFER_ISOC </para> <para>USB_ENDPOINT_XFER_BULK </para> <para>USB_ENDPOINT_XFER_INT </para></para>        
				/// </summary>
				/// <java-name>
 ...
 /* scope: __dot42__ */ 
		{
				...
				/// <summary>
				///  <para>Returns the endpoint's direction. Returns UsbConstants#USB_DIR_OUT if the direction is host to device, and UsbConstants#USB_DIR_IN if the direction is device to host.  <para>UsbConstants#USB_DIR_IN </para> <para>UsbConstants#USB_DIR_OUT</para></para>        
				/// </summary>
				/// <returns>
