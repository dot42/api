 ...
 /* scope: __dot42__ */ 
		{
				...
				public UrlEncodedFormEntity(global::Java.Util.IList<global::Org.Apache.Http.INameValuePair> list, string @string) /* MethodBuilder.Create */ 
				{
				}

				[Dot42.DexImport("<init>", "(Ljava/util/List;)V", AccessFlags = 1, Signature = "(Ljava/util/List<+Lorg/apache/http/NameValuePair;>;)V")]
				public UrlEncodedFormEntity(global::Java.Util.IList<global::Org.Apache.Http.INameValuePair> list) /* MethodBuilder.Create */ 
				{
				}
