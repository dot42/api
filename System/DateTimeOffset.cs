...
namespace System {
...
#endif
    {
        ...
        private readonly Int16 m_offsetMinutes;
        ...
        public DateTimeOffset(DateTime dateTime, TimeSpan offset) {
            if (dateTime.Kind == DateTimeKind.Local) {
                if (offset != TimeZoneInfo.GetLocalUtcOffset(dateTime/*, TimeZoneInfoOptions.NoThrowOnInvalidTime*/)) {
                    throw new ArgumentException("Argument_OffsetLocalMismatch", "offset");
                }
            }
            else if (dateTime.Kind == DateTimeKind.Utc) {
                if (offset != TimeSpan.Zero) {
                    throw new ArgumentException("Argument_OffsetUtcMismatch", "offset");
                }
            }
            m_offsetMinutes = ValidateOffset(offset);
            m_dateTime = ValidateDate(dateTime, offset);
...
#if !DOT42 // Parsing not yet implemented.
        ...
        private static Int16 ValidateOffset(TimeSpan offset) {
            ...
            if (ticks % TimeSpan.TicksPerMinute != 0) {
                throw new ArgumentException("Argument_OffsetPrecision", "offset");
            }
            if (ticks < MinOffset || ticks > MaxOffset) {
                throw new ArgumentOutOfRangeException("offset", "Argument_OffsetOutOfRange");
            }
        ...
        private static DateTime ValidateDate(DateTime dateTime, TimeSpan offset) {
            ...
            if (utcTicks < DateTime.MinTicks || utcTicks > DateTime.MaxTicks) {                
                throw new ArgumentOutOfRangeException("offset", "Argument_UTCOutOfRange");                
            }
        ...
        private static DateTimeStyles ValidateStyles(DateTimeStyles style, String parameterName) {
            ...
            if (((style & (DateTimeStyles.AssumeLocal)) != 0) && ((style & (DateTimeStyles.AssumeUniversal)) != 0)) {
                throw new ArgumentException("Argument_ConflictingDateTimeStyles", parameterName);
            }
            if ((style & DateTimeStyles.NoCurrentDateDefault) != 0) {
                throw new ArgumentException("Argument_DateTimeOffsetInvalidDateTimeStyles", parameterName);
            }
