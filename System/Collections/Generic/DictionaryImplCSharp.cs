...
namespace System.Collections.Generic
{
        ...
        /*, IReadOnlyDictionary<TKey, TValue>, ISerializable, IDeserializationCallback*/
    {
        ...
        public DictionaryImplCSharp() : this(0, null) { }

        public DictionaryImplCSharp(int capacity) : this(capacity, null) { }

        public DictionaryImplCSharp(IEqualityComparer<TKey> comparer) : this(0, comparer) { }

        public DictionaryImplCSharp(int capacity, IEqualityComparer<TKey> comparer)
        {
            if (capacity < 0) new ArgumentOutOfRangeException();
            if (capacity > 0) Initialize(capacity);
            this.comparer = comparer ?? EqualityComparer<TKey>.Default;
        }

        public DictionaryImplCSharp(IDictionary<TKey, TValue> dictionary) : this(dictionary, null) { }

        public DictionaryImplCSharp(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) :
...
//        }
        ...
        {
            private DictionaryImplCSharp<TKey, TValue> dictionary;
            private int version;
            private int index;
            ...
            internal Enumerator(DictionaryImplCSharp<TKey, TValue> dictionary, int getEnumeratorRetType)
            {
        ...
        public sealed class KeyCollection : ICollection<TKey>, ICollection
        {
            ...
            public KeyCollection(DictionaryImplCSharp<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                {
            ...
            public struct Enumerator : IEnumerator<TKey>, System.Collections.IEnumerator
            {
                ...
                internal Enumerator(DictionaryImplCSharp<TKey, TValue> dictionary)
                {
                    this.dictionary = dictionary;
                    version = dictionary.version;
                    index = 0;
        ...
        public sealed class ValueCollection : ICollection<TValue>, ICollection
        {
            ...
            public ValueCollection(DictionaryImplCSharp<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                {
                    ThrowHelper.ThrowArgumentNullException(ExceptionArgument.dictionary);
